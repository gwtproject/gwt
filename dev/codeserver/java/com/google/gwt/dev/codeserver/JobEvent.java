...
public final class JobEvent {
  ...
  private final ImmutableSortedMap<String, Long> performanceCounts;
  ...
  private JobEvent(Builder builder) {
    ...
    this.performanceCounts = ImmutableSortedMap.copyOf(builder.performanceCounts);
  ...
  /**
   * Returns the values of performance-related counters. (Not null but may be empty.)
   * The key names are identifiers beginning with a capital letter but are otherwise
   * subject to change.
   */
  public SortedMap<String, Long> getPerformanceCounts() {
  ...
  public static class Builder {
    ...
    private Map<String, Long> performanceCounts = ImmutableMap.of();
    ...
    /**
     * Counts used for understanding compiler performance.
     ...
     */
    public void setPerformanceCounts(Map<String, Long> counts) {
      for (String key : counts.keySet()) {
        Preconditions.checkArgument(PerformanceCounter.isValidKey(key),
            "invalid counter key: %s", key);
      }
      this.performanceCounts = counts;
    }
