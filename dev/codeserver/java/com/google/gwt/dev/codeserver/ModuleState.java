...
class ModuleState {
   ...
   */
  void maybePrecompile(boolean noPrecompile) throws UnableToCompleteException {
    if (noPrecompile) {
      current.set(recompiler.initWithoutPrecompile());
    } else {
      current.set(recompiler.precompile());
    }
  }
