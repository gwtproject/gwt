...
import com.google.gwt.dev.util.arg.ArgHandlerGenerateExports;
...
import com.google.gwt.dev.util.arg.OptionGenerateExports;
...
public class Options {
  ...
  private class ArgProcessor extends ArgProcessorBase {
    ...
    public ArgProcessor() {
      ...
      registerHandler(new ArgHandlerGenerateExports(new OptionGenerateExports() {
        @Override
