...
public class Options {
  ...
  private DisplayNameMode displayNameMode = DisplayNameMode.CLASS;
  ...
  private class DisplayNameLevel extends ArgHandlerString {
    ...
    public boolean setString(String str) {
      ...
      if ("NONE".equals(value)) {
        ...
        displayNameMode = DisplayNameMode.METHOD;
      } else if ("CLASS".equals(value)) {
        displayNameMode = DisplayNameMode.CLASS;
    ...
    @Override
    public String[] getTagArgs() {
      return new String[] {"NONE | METHOD | CLASS | FULL"};
    }
  }
