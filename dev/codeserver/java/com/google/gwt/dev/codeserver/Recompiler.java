...
import com.google.gwt.dev.cfg.PropertyPermutationSets.PermutationDescription;
...
public class Recompiler {
  ...
  private boolean doCompile(TreeLogger compileLogger, CompileDir compileDir, Job job)
    ...
    List<PropertyPermutationSets> permutationPropertySets = propertyPermutationSets.collapseProperties();
    ...
    PropertyPermutationSets permutationPropertySet = permutationPropertySets.get(0);
