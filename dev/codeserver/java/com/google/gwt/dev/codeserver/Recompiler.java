...
public class Recompiler {
  ...
  Recompiler(OutboxDir outboxDir, LauncherDir launcherDir, File baseCacheDir,
      String inputModuleName, Options options, UnitCache unitCache) {
  ...
  private void setMinimalRebuildCache(Map<String, String> bindingProperties,
    ...
    MinimalRebuildCacheManager.setCache(inputModuleName, baseCacheDir, bindingProperties,
        minimalRebuildCache);
  }
  ...
  private MinimalRebuildCache getMinimalRebuildCache(Map<String, String> bindingProperties) {
    ...
    return MinimalRebuildCacheManager.getCache(inputModuleName, baseCacheDir, bindingProperties);
  }
