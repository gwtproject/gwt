...
class Recompiler {
  ...
  private static String generateModuleRecompileJs(ModuleDef module, TreeLogger compileLogger)
    ...
    String outputModuleName = module.getName();
    try {
      String templateJs = PageUtil.loadResource(Recompiler.class, "recompile_template.js");
      String propertyProviders = PropertiesUtil.generatePropertiesSnippet(module, compileLogger);
      String libJs = PageUtil.loadResource(Recompiler.class, "recompile_lib.js");
      String recompileJs = PageUtil.loadResource(Recompiler.class, "recompile_main.js");
