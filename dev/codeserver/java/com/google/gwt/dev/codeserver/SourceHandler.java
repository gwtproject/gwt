...
class SourceHandler {
   ...
   * source map).
   */
  private void sendSourceFileAsHtml(String moduleName, String fileName, BufferedReader lines,
      HttpServletResponse response) throws IOException {
    ...
    out.startTag("title").text(file.getName() + " (GWT Code Server)").endTag("title").nl();
