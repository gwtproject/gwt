...
function Recompiler(moduleName, permutationProperties) {
  $namespace.__gwt_sdm.lib.recompiler = $namespace.__gwt_sdm.lib.recompiler || {};
  $namespace.__gwt_sdm.lib.recompiler.counter = $namespace.__gwt_sdm.lib.recompiler.counter || 0;
  $namespace.__gwt_sdm.lib.recompiler.callbacks = $namespace.__gwt_sdm.lib.recompiler.callback || {};
  this.__globals = $namespace.__gwt_sdm.lib.recompiler;
