...
// closure so we do not accidentally leak to global scope
(function($wnd, $doc, $namespace) {
  ...
  function Recompiler(moduleName, permutationProperties) {
    $wnd.__gwt_sdm.lib.recompiler = $wnd.__gwt_sdm.lib.recompiler || {};
    $wnd.__gwt_sdm.lib.recompiler.counter = $wnd.__gwt_sdm.lib.recompiler.counter || 0;
    $wnd.__gwt_sdm.lib.recompiler.callbacks = $wnd.__gwt_sdm.lib.recompiler.callback || {};
    this.__globals = $wnd.__gwt_sdm.lib.recompiler;
