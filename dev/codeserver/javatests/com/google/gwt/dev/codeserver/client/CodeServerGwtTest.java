...
public class CodeServerGwtTest extends GWTTestCase {
  ...
  public native void testPropertyHelper_withProperInput() /*-{
    ...
    var propertyHelper = new PropertyHelper('testModule', propertyProvidersHolder, {});
  ...
  public native void testPropertyHelper_environment() /*-{
    ...
    // Actual test
    var PropertyHelper = $wnd.namespace.lib.PropertyHelper;
    var propertyHelper = new PropertyHelper('testModule', propertyProvidersHolder, metaTagParserMock);
    var result = propertyHelper.computeBindingProperties();
