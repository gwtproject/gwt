...
public interface GeneratorContext {
  ...
  /**
   * Return whether the current compile and generator passes are executing in the global phase of a
   * compile, as opposed to further down in the dependency tree.
   */
