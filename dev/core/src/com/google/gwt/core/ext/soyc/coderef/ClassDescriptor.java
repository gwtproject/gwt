...
/**
 * A simple code representation for classes.
 *
...
public class ClassDescriptor extends EntityDescriptor{
  ...
  protected Map<String, MethodDescriptor> methodDic = Maps.newTreeMap();
  protected Map<String, FieldDescriptor> fieldDic = Maps.newTreeMap();
  protected JDeclaredType reference;
