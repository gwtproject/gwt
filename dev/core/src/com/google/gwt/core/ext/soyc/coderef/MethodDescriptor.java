...
public class MethodDescriptor extends MemberDescriptor {
  ...
  public static MethodDescriptor from(ClassDescriptor owner, JMethod method, String signature) {
    ...
    methodDescriptor.references.add(method);
    return methodDescriptor;
  }

  private Set<MethodDescriptor> dependants = Sets.newIdentityHashSet();
  private int uniqueId;
  private String paramTypes;
  private Set<JMethod> references = Sets.newIdentityHashSet();
  private Set<String> otherJsNames = Sets.newHashSet();
  ...
  public Set<JMethod> getReferences() {
    return references;
  }
