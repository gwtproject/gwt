...
/**
  ...
  public static void recordMap(TreeLogger logger, OutputStream out, SizeBreakdown[] sizeBreakdowns,
      JavaToJavaScriptMap jjsmap, Map<JsName, JsLiteral> obfuscateMap) throws IOException {
  ...
  private static TypedProgramReference typedProgramReference(JsName name,
      JavaToJavaScriptMap jjsmap, Map<JsName, JsLiteral> obfuscateMap) {
    ...
    JsLiteral literal = obfuscateMap.get(name);
