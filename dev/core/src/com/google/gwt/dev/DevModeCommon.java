...
/**
 * The common class for hosted mode (dev and superdev). NOTE: the public API for
 * this class is to be determined. Consider this class as having <b>no</b>
 * public API other than {@link #main(String[])}.
 */
public abstract class DevModeCommon extends DevModeBase implements RestartServerCallback {
   ...
   */
  public static class ArgProcessor extends DevModeBase.ArgProcessor {
    ...
    protected String getName() {
      return DevModeCommon.class.getName();
    }
  }
