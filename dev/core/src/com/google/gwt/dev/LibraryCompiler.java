...
import com.google.gwt.dev.CompilerContext.TinyCompileSummary;
...
import com.google.gwt.dev.url.CloseableJarUrlStreamHandlerFactory;
...
public class LibraryCompiler {
   ...
   */
  private static CloseableJarUrlStreamHandlerFactory closeableJarUrlStreamHandlerFactory;

  private static void ensureUrlStreamHandlerOverride() {
    if (closeableJarUrlStreamHandlerFactory == null) {
      closeableJarUrlStreamHandlerFactory = new CloseableJarUrlStreamHandlerFactory();
      URL.setURLStreamHandlerFactory(closeableJarUrlStreamHandlerFactory);
    }
  }
  ...
  public LibraryCompiler(CompilerOptions compilerOptions) {
    ...
    ensureUrlStreamHandlerOverride();
  }
  ...
  private void loadLibraries(TreeLogger logger) throws UnableToCompleteException {
    ...
    try {
      closeableJarUrlStreamHandlerFactory.closeJarInputStreams(
