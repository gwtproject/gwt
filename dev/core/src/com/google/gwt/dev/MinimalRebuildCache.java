...
public class MinimalRebuildCache implements Serializable {
  ...
  public boolean equals(Object object) {
    if (object instanceof MinimalRebuildCache) {
      MinimalRebuildCache that = (MinimalRebuildCache) object;

      // Ignoring processedStaleTypeNames since it is transient.
      return
          Objects.equal(this.immediateTypeRelations, that.immediateTypeRelations) && Objects.equal(
              this.compilationUnitTypeNameByNestedTypeName,
          ...
          && Objects.equal(this.intTypeMapper, that.intTypeMapper)
          ...
          && Objects.equal(this.persistentPrettyNamerState, that.persistentPrettyNamerState)
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(immediateTypeRelations, compilationUnitTypeNameByNestedTypeName,
        contentHashByGeneratedTypeName, deletedCompilationUnitNames, deletedDiskSourcePaths,
        deletedResourcePaths, dualJsoImplInterfaceNames, generatedArtifacts,
        generatedCompilationUnitNamesByReboundTypeNames, intTypeMapper, jsByTypeName,
        jsoStatusChangedTypeNames, jsoTypeNames, lastLinkedJsBytes, lastModifiedByDiskSourcePath,
        lastModifiedByResourcePath, lastReachableTypeNames, modifiedCompilationUnitNames,
        modifiedDiskSourcePaths, modifiedResourcePaths, nestedTypeNamesByUnitTypeName,
        persistentPrettyNamerState, preambleTypeNames, processedStaleTypeNames,
        rebinderTypeNamesByReboundTypeName, reboundTypeNamesByGeneratedCompilationUnitNames,
        reboundTypeNamesByInputResource, referencedTypeNamesByTypeName, rootTypeNames,
        singleJsoImplInterfaceNames, sourceCompilationUnitNames, sourceMapsByTypeName,
        staleTypeNames, statementRangesByTypeName, typeNamesByReferencingTypeName);
  }
