...
public class MinimalRebuildCache implements Serializable {
  ...
  private final Multimap<String, String> exportedMemberNamesByTypeName = HashMultimap.create();
  ...
  public boolean addExportedMemberName(String exportedMemberName, String inTypeName) {
    return exportedMemberNamesByTypeName.put(inTypeName, exportedMemberName);
  }
  ...
  public void copyFrom(MinimalRebuildCache that) {
    ...
    copyMultimap(that.exportedMemberNamesByTypeName, this.exportedMemberNamesByTypeName);
  ...
  public void removeExportedNames(String inTypeName) {
    exportedMemberNamesByTypeName.removeAll(inTypeName);
  ...
  boolean hasSameContent(MinimalRebuildCache that) {
    ...
    return this.immediateTypeRelations.hasSameContent(that.immediateTypeRelations) && Objects.equal(
        ...
        && Objects.equal(this.exportedMemberNamesByTypeName, that.exportedMemberNamesByTypeName)
