...
public final class Permutation implements Serializable {
  ...
  private List<SoftProps> orderedProps = Lists.newArrayList();
  ...
  public Permutation(int id, SoftProps props) {
    this.id = id;
   ...
   */
  public HardProps getProps() {
    return new HardProps(orderedProps);
  }
