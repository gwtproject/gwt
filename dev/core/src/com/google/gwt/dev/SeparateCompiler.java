 ...
 * GWT application.<br />
 *
 * Is an alternative to Compiler.java which does a full world compile that neither reads nor writes
 * libraries.<br />
 *
    ...
    if (argProcessor.processArgs(args)) {
      CompileTask compileTask = new CompileTask() {
        ...
        public boolean run(TreeLogger logger) throws UnableToCompleteException {
          return new SeparateCompiler(compilerOptions).run(logger);
        }
      };
