...
public abstract class CompoundCondition extends Condition {
  ...
  private static final ImmutableList<String> LIST_OF_EMPTY_STRING = ImmutableList.of("");
  ...
  public String toSource() {
    ...
    for (Condition condition : getConditions()) {
      conditionSources.add(condition.toSource());
    }

    // Remove any translated condition that evaluated to a NOP.
    conditionSources.removeAll(LIST_OF_EMPTY_STRING);
