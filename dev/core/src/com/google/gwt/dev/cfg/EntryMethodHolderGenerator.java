...
public class EntryMethodHolderGenerator extends Generator {
  ...
  private static final String ENTRY_METHOD_HOLDER_TYPE_NAME = "EntryMethodHolder";

  @Override
  public String generate(TreeLogger logger, GeneratorContext context, String moduleName)
      throws UnableToCompleteException {
    String typeName =
        moduleName.replace(".", "_").replace("-", "_") + "_" + ENTRY_METHOD_HOLDER_TYPE_NAME;
    PrintWriter out = context.tryCreate(logger, "com.google.gwt.lang", typeName);

    if (out != null) {
      out.println("package com.google.gwt.lang;");
    ...
    return "com.google.gwt.lang." + typeName;
  }
}
