...
class Libraries {
  ...
  /**
   * Computes a consistent full path at which to store a given build resource path.
   */
  public static String computeBuildResourceEntryName(String buildResourcePath) {
    return DIRECTORY_BUILD_RESOURCES + buildResourcePath;
  }
  ...
  /**
   * Computes a consistent full path at which to store a given public resource path.
   */
  public static String computePublicResourceEntryName(String publicResourcePath) {
    return DIRECTORY_PUBLIC_RESOURCES + publicResourcePath;
  }
}
