...
public class LibraryGroup {
  ...
  private Map<String, Set<String>> processedReboundTypeSourceNamesByGenerator = Maps.newHashMap();
  private Set<String> requestedReboundTypeSourceNames;
  ...
  public Set<String> getProcessedReboundTypeSourceNamesForGenerator(String generatorName) {
    if (!processedReboundTypeSourceNamesByGenerator.containsKey(generatorName)) {
      ...
      processedReboundTypeSourceNamesByGenerator.put(generatorName,
  ...
  public Set<String> getRequestedReboundTypeSourceNames() {
    if (requestedReboundTypeSourceNames == null) {
      requestedReboundTypeSourceNames = Sets.newLinkedHashSet();
      for (Library library : libraries) {
        requestedReboundTypeSourceNames.addAll(library.getRequestedReboundTypeSourceNames());
      }
      requestedReboundTypeSourceNames =
          Collections.unmodifiableSet(requestedReboundTypeSourceNames);
    }
