...
public class ModuleDefLoader {
  ...
  public static ModuleDef loadFromResources(TreeLogger logger, CompilerContext compilerContext,
    ...
    try {
      ...
      LibraryBuilder libraryBuilder = compilerContext.getLibraryBuilder();
      libraryBuilder.setLibraryName(module.getName());
      libraryBuilder.addDependencyLibraryNames(module.getExternalLibraryModuleNames());
      return module;
    } finally {
  ...
  void nestedLoad(TreeLogger parentLogger, String moduleName, ModuleDef moduleDef)
    ...
    try {
      ...
      if (moduleDef.getTargetLibraryModuleNames().contains(moduleName)) {
        ...
        libraryBuilder.addBuildResource(new UrlResource(moduleURL, resName, lastModified));
      }
    } catch (Throwable e) {
