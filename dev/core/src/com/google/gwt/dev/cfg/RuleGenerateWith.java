...
public class RuleGenerateWith extends Rule {
  ...
  public void generate(
      TreeLogger logger, ModuleDef module, GeneratorContext context, String typeName) {
    Map<Map<String, String>, String> resultTypeNamesByProperties =
        computeResultTypeNamesByProperties(
            logger, module, (StandardGeneratorContext) context, typeName);
   ...
   */
  private Map<Map<String, String>, String> computeResultTypeNamesByProperties(
      TreeLogger logger, ModuleDef module, StandardGeneratorContext context, String typeName) {
    try {
      Map<Map<String, String>, String> resultTypeNamesByProperties = Maps.newHashMap();
      DynamicPropertyOracle dynamicPropertyOracle =
          new DynamicPropertyOracle(module.getProperties());
