...
/**
 * The compiler's representation of the properties for one soft permutation.
 *
 * <p>If soft permutations aren't turned on, these are also the properties
 * for the enclosing hard permutation.
 */
public class SoftProps implements Serializable {
   ...
   */
  public SoftProps(BindingProperty[] orderedProps, String[] orderedPropValues,
