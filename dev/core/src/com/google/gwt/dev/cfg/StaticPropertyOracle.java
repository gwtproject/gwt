...
/**
 * An implementation of {@link LimitablePropertyOracle} that contains property
 * values, rather than computing them.
 */
public class StaticPropertyOracle implements LimitablePropertyOracle, Serializable {
