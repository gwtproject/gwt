...
public class ZipLibrary implements Library {
  ...
  private class ZipLibraryReader {
    ...
    private Set<String> readRequestedReboundTypeSourceNames() {
      return readStringSet(Libraries.REQUESTED_REBOUND_TYPE_SOURCE_NAMES_ENTRY_NAME);
    }
  ...
  public Set<String> getRequestedReboundTypeSourceNames() {
    if (requestedReboundTypeSourceNames == null) {
      requestedReboundTypeSourceNames =
          Collections.unmodifiableSet(zipLibraryReader.readRequestedReboundTypeSourceNames());
    }
