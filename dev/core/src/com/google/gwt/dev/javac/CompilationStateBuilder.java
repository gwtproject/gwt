    ...
    private final class UnitProcessorImpl implements UnitProcessor {
      ...
      public void process(CompilationUnitBuilder builder, CompilationUnitDeclaration cud,
        ...
        try {
          ...
          // TODO(rluble): Make sure this pass does not fail when JDT produces incomplete ASTs
          // for compilation units with errors.
          ...
          // Even when compilation units have erros, return a consistent builder.
          builder
              .setTypes(types)
