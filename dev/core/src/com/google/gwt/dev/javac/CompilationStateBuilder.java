...
public class CompilationStateBuilder {
  ...
  public class CompileMoreLater {
     ...
     * reports errors.
     *
     * <p>If all the dependencies of a compilation unit can be found in allValidClasses
     * (recursively) then it's considered valid, Valid compilation units will be added to
     * cachedUnits and the unit cache, and their types will be added to allValidClasses.
