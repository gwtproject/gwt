  ...
  public class CompileMoreLater {
    ...
    private final class UnitProcessorImpl implements UnitProcessor {
      ...
      public void process(CompilationUnitBuilder builder, CompilationUnitDeclaration cud,
        ...
        try {
          ...
          // CompilationStateBuilder#invalidateCachedUnitsAndRescheduleCorrespondingBuilders}.
    ...
    Collection<CompilationUnit> compile(TreeLogger logger, CompilerContext compilerContext,
      ...
      do {
        ...
        invalidateCachedUnitsAndRescheduleCorrespondingBuilders(logger, builders, cachedUnits);
    ...
    /**
     * Invalidates cached units that fail validation with the current set of valid classes; also
     * add the builder of the invalidated unit back for retry later.
     */
    private void invalidateCachedUnitsAndRescheduleCorrespondingBuilders(TreeLogger logger,
        Collection<CompilationUnitBuilder> builders,
