      ...
      public void process(CompilationUnitBuilder builder, CompilationUnitDeclaration cud,
        ...
        try {
          ...
          if (!cud.compilationResult().hasErrors()) {
            ...
            if (!cud.compilationResult().hasErrors()) {
              // Even though the compilation unit did not have errors straight out of JDT, the
              // checks performed just above record their errors in the compilation result.
              // So only construct the AST if no JDT errors and all our restrictions/checks
              // pass.
