  ...
  public class CompileMoreLater {
    ...
    private final class UnitProcessorImpl implements UnitProcessor {
      ...
      public void process(CompilationUnitBuilder builder, CompilationUnitDeclaration cud,
        ...
        try {
          ...
          // Dependencies need to be included even when the {@code cud} has errors in order to
          // as the unit might be saved as a cached units and its dependencies might be used
          // to further invalidate other units.
          // See {link CompilationStateBuilder#invalidateCachedUnits}.
    ...
    Collection<CompilationUnit> compile(TreeLogger logger, CompilerContext compilerContext,
      ...
      do {
        ...
        invalidateCachedUnits(logger, builders, cachedUnits);
    ...
    private void invalidateCachedUnits(TreeLogger logger,
        Collection<CompilationUnitBuilder> builders,
