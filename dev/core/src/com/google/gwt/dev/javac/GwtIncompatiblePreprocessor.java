...
public class GwtIncompatiblePreprocessor {
  ...
  public static void preproccess(CompilationUnitDeclaration cud) {
    // Remove @GwtIncompatible classes, members and recursible remove @GwtIncompatible
    // inner classes.
    // A dummy empty stub is retained for @GwtIncompatible classes.
    GwtIncompatiblePreprocessor.processTypes(cud.types);
    // Anonymous inner classes are represented inside expressions.
    // Traverse the JDT AST removing anonymous inner classes in one go.
