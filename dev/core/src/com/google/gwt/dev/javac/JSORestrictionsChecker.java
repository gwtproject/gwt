...
public class JSORestrictionsChecker {
  ...
  public static final String ERR_JSEXPORT_USED_ON_JSTYPE_INTERFACE =
      "@JsExport used on @JsType interface, instead of implementing class";
  ...
  public static final String ERR_FORGOT_TO_MAKE_PROTOTYPE_IMPL_JSTYPE =
      "@JsType subtype extends magic _Prototype class, but _Prototype class doesn't implement JsType";
  public static final String ERR_SUBCLASSING_NATIVE_NOT_ALLOWED =
      "Subclassing prototypes of native browser prototypes not allowed.";
  public static final String ERR_JS_TYPE_WITH_PROTOTYPE_SET_NOT_ALLOWED_ON_CLASS_TYPES =
      "@JsType with prototype set not allowed on class types";
      ...
      for (MethodBinding mb : binding.methods()) {
        ...
        if (methodNamesAndSigs.containsKey(methodName)) {
          if (!methodNamesAndSigs.get(methodName).areParameterErasuresEqual(mb)) {
            // errorOn(mb.sourceMethod(), ERR_JSTYPE_OVERLOADS_NOT_ALLOWED);
          }
        } else {
