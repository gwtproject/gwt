...
public class JSORestrictionsChecker {
  ...
  public static class CheckerState {
    ...
    // TODO(rluble): (Separate compilation) Implement! A JSO must be defined in the same module
    // that the interface(s) it implements.
    private boolean sameModule(TypeDeclaration jsoType, ReferenceBinding interf) {
      return true;
    }
