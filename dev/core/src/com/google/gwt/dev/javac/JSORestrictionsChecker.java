...
public class JSORestrictionsChecker {
  ...
  private class JSORestrictionsVisitor extends SafeASTVisitor implements
    ...
    private boolean checkClassImplementingJsInterface(TypeDeclaration type) {
      ...
      AnnotationBinding jsinterfaceAnn = GwtAstBuilder.getAnnotation(jsInterface,
          GwtAstBuilder.JSINTERFACE_CLASS);
      String jsPrototype = GwtAstBuilder.getAnnotationParameterString(jsinterfaceAnn, "prototype");
      boolean isNative = GwtAstBuilder.getAnnotationParameterBoolean(jsinterfaceAnn, "isNative");
    ...
    private boolean isMagicPrototypeStub(ReferenceBinding binding) {
      return GwtAstBuilder.getAnnotation(binding, GwtAstBuilder.JSINTERFACEPROTOTYPE_CLASS) != null;
    }
