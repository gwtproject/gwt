...
public class JdtCompiler {
  ...
  private class ParserImpl extends Parser {
    ...
    /**
     * Filters out types that have an annotation of class {@code *.GwtIncompatible}; recursibly
     * also filters out inner classes and their methods and fields that are annotated with
    ...
    /**
     * Filters out methods that have an annotation of class {@code *.GwtIncompatible}.
     */
    ...
    /**
     * Filters out fields that have an annotation of class {@code *.GwtIncompatible}.
     */
    ...
    /**
     * Filters out classes, inner classes, methods and fields that have an annontation of
     * class {@code GwtIncompatible}
     *
