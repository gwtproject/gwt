...
public class JdtCompiler {
  ...
  public static List<CompilationUnit> compile(TreeLogger logger, CompilerContext compilerContext,
    ...
    return compile(logger, compilerContext, builders, SourceLevel.DEFAULT_SOURCE_LEVEL);
  }
  ...
  public static List<CompilationUnit> compile(TreeLogger logger, CompilerContext compilerContext,
    ...
    try {
      ...
      JdtCompiler compiler = new JdtCompiler(compilerContext, processor, sourceLevel);
  ...
  public JdtCompiler(
      CompilerContext compilerContext, UnitProcessor processor, SourceLevel sourceLevel) {
