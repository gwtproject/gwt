...
public final class JdtUtil {
  ...
  public static AnnotationBinding getAnnotationByName(Annotation[] annotations, String name) {
    ...
    return getAnnotationByName(
        FluentIterable.from(Arrays.asList(annotations))
            .transform(
                new Function<Annotation, AnnotationBinding>() {
                  @Override
                  public AnnotationBinding apply(Annotation annotation) {
  ...
  public static AnnotationBinding getAnnotationByName(
    ...
    return getAnnotationByName(Arrays.asList(annotationsBindings), name);
  }

  public static AnnotationBinding getAnnotationByName(
    Iterable<AnnotationBinding> annotationsBindings, String name) {
