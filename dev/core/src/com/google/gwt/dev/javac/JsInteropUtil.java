...
public final class JsInteropUtil {
  ...
  public static void maybeSetJsInteropProperties(JMethod method, Annotation... annotations) {
    ...
    method.setJsOpaque(isJsOpaque(annotations));
  }
  ...
  public static void maybeSetJsInteropProperties(JField field, Annotation... annotations) {
    ...
    field.setJsOpaque(isJsOpaque(annotations));
  }
  ...
  public static void maybeSetJsInteropProperties(JParameter parameter, Annotation... annotations) {
    parameter.setJsOpaque(isJsOpaque(annotations));
  }
  ...
  private static boolean isJsOpaque(Annotation[] annotations) {
