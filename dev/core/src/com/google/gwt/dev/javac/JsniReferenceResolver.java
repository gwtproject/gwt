...
/**
 * Resolves JSNI references to fields and methods and gives an informative errors if the references
 * cannot be resolved.<p>
 *
 * JSNI references consist of two parts @ClassDescriptor::memberDescriptor. Class descriptors
 * are source names and memberDescriptors are either a field name or a method name and a signature
 * specification.<p>
 *
 ...
 * jsni references to JDT binding.<p>
 *
...
public class JsniReferenceResolver {
  ...
  private static void resolveJsniRef(JsniRef jsniRef, MethodBinding methodBinding) {
    ...
    if (selector.equals("<init>")) {
      ...
      if (JdtUtil.isNested(declaringClassBinding)) {
