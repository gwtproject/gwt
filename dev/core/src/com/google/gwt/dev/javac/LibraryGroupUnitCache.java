...
public class LibraryGroupUnitCache implements UnitCache {
  ...
  public static String typeNameToResourcePath(String typeName) {
    Preconditions.checkState(!typeName.endsWith(".java"));
    ...
    return typeName.replace(".", "/") + ".java";
  }

  private static String resourcePathToTypeName(String resourcePath) {
    Preconditions.checkState(resourcePath.endsWith(".java"));

    resourcePath = resourcePath.substring(0, resourcePath.length() - ".java".length());
