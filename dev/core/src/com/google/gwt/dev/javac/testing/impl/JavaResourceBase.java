...
public class JavaResourceBase {
  ...
  public static final MockJavaResource JSINTERFACEPROTOTYPE =
      createMockJavaResource("com.google.gwt.core.client.js.impl.JsInterfacePrototype",
          "package com.google.gwt.core.client.js.impl;",
          "public @interface JsInterfacePrototype {\n",
          "}");
  ...
  public static MockJavaResource[] getStandardResources() {
    return new MockJavaResource[]{
        ...
        OBJECT, RUNTIME_EXCEPTION, SERIALIZABLE, SHORT, STRING, STRING_BUILDER, SUPPRESS_WARNINGS, THROWABLE, JSINTERFACE,
        JSEXPORT, JSPROPERTY, JSINTERFACEPROTOTYPE};
  }
