...
class Members extends AbstractMembers {
  ...
  private final List<JConstructor> constructors = Lists.newArrayList();
  private final Map<String, JField> fieldMap = Maps.newHashMap();
  private final List<JField> fields = Lists.newArrayList();
  private final Map<String, Object> methodMap = Maps.newHashMap();
  private final List<String> methodOrder = Lists.newArrayList();
  private final Map<String, JClassType> nestedTypes = Maps.newHashMap();
