...
public final class CompilerPoperties {
  ...
  public static boolean isTrueInAnyPermutation(
      SoftPermutation[] softPermutations, String propertyName, boolean valueIfNoPermutations) {

    if (softPermutations == null || softPermutations.length == 0) {
      return valueIfNoPermutations;
    }
