...
public class JavaToJavaScriptCompiler {
   ...
   * @param unifiedAst the result of a {@link #precompile(TreeLogger, CompilerContext,
   *          ModuleDef, RebindPermutationOracle, String[], String[], JJSOptions,
   *          boolean, PrecompilationMetricsArtifact)}
   ...
   */
  private static void generateJavaScriptCode(CompilerContext compilerContext,
