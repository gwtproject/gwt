...
import com.google.gwt.dev.jjs.impl.ResolveRuntimeTypeIds;
  ...
  protected abstract class PermutationCompiler {
    ...
    public PermutationResult compilePermutation(UnifiedAst unifiedAst)
      ...
      try {
        ...
        Map<JType, JLiteral> typeIdsByType = ResolveRuntimeTypeIds.exec(jprogram);
        ...
        Pair<? extends JavaToJavaScriptMap, Set<JsNode>> jjsMapAndInlineableFunctions =
            GenerateJavaScriptAST.exec(jprogram, jsProgram, options.getOutput(),
                typeIdsByType,  symbolTable, propertyOracles);
