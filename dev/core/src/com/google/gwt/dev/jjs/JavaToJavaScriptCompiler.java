...
import com.google.gwt.dev.js.JsFreshNameGenerator;
    ...
    try {
      ...
      switch (options.getOutput()) {
        case OBFUSCATED:
          ...
          JsFreshNameGenerator nameGenerator = JsObfuscateNamer.exec(jsProgram, propertyOracles);
          if (options.shouldRemoveDuplicateFunctions() &&
              JsStackEmulator.getStackMode(propertyOracles) == JsStackEmulator.StackMode.STRIP) {
            JsDuplicateFunctionRemover.exec(jsProgram, nameGenerator);
          }
          break;
        case PRETTY:
