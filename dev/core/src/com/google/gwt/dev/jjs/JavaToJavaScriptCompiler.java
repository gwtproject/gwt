...
public abstract class JavaToJavaScriptCompiler {
  ...
  protected abstract class Precompiler {
    ...
    private void synthesizeEntryMethodHolderInit(UnifyAst unifyAst,
      ...
      JMethod initMethod = entryMethodHolderType.findMethod("init");
      JMethod gwtCreateMethod = gwtType.findMethod("create");
      JMethod onModuleLoadMethod = entryPointType.findMethod("onModuleLoad");
