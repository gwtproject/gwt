...
import com.google.gwt.dev.cfg.HardProps;
  ...
  protected abstract class PermutationCompiler {
    ...
    public PermutationResult compilePermutation(UnifiedAst unifiedAst)
      ...
      try {
        ...
        HardProps props = permutation.getProps();
    ...
    protected abstract Pair<SyntheticArtifact, MultipleDependencyGraphRecorder> splitJsIntoFragments(
        HardProps props, int permutationId, JavaToJavaScriptMap jjsmap);
    ...
    private Map<JsName, JsLiteral> renameJsSymbols(HardProps props) {
    ...
    private Map<JsName, JsLiteral> runObfuscateNamer(HardProps props) {
      Map<JsName, JsLiteral> internedLiteralByVariableName =
