...
public abstract class JavaToJavaScriptCompiler {
  ...
  protected abstract class Precompiler {
    ...
    private void synthesizeEntryMethodHolderInit(UnifyAst unifyAst,
      ...
      JMethod initMethod = entryMethodHolderType.findMethod("init()V");
      JMethod gwtCreateMethod = gwtType.findMethod("create(Ljava/lang/Class;)Ljava/lang/Object;");
      JMethod onModuleLoadMethod = entryPointType.findMethod("onModuleLoad()V");

      // Synthesize GWT.create(FooEntryPoint.class).onModuleLoad(); calls.
      ...
      for (String entryPointTypeName : entryPointTypeNames) {
        JClassLiteral entryPointTypeClassLiteral = new JClassLiteral(origin,
        ...
        initMethodBlock.addStmt(
            new JMethodCall(origin, createInstanceCall, onModuleLoadMethod).makeStatement());
      }
    }
