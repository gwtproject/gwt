...
public final class JavaToJavaScriptCompiler {
   ...
   * in the wrong order. They have been noted for future cleanup.
   */
  private final UnifiedAst precompile(RebindPermutationOracle rpo, String[] entryPointTypeNames,
  ...
  private final void optimizeJavaToFixedPoint() throws InterruptedException {
