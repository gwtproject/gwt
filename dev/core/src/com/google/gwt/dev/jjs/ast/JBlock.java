...
public class JBlock extends JStatement {
  ...
  private List<JStatement> statements = new ArrayList<JStatement>();
  ...
  public void traverse(JVisitor visitor, Context ctx) {
    if (visitor.visit(this, ctx)) {
      List<JStatement> result =
          visitor.acceptWithInsertRemoveImmutable(statements);
      statements = new ArrayList(result);
    }
