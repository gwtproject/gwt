...
public class JCastMap extends JExpression {
  ...
  public JCastMap(SourceInfo sourceInfo, JClassType stringType, Collection<JType> canCastToTypes) {
    super(sourceInfo);
    for (JType type : canCastToTypes) {
      this.canCastToTypes.add(new JTypeIdOf(sourceInfo, stringType, type));
    }
  }
