 ...
 * initializer method (named $clinit) and the instance initializer method (named $init).
 *
 ...
 *
 * Optimizations may eliminate class initializers ($clinit) if no static variables need
 * initialization, and use the private variable to keep track which initializer in the superclass
 * chain needs to be called.
 *
 */
