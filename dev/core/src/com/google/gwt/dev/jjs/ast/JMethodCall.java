...
public class JMethodCall extends JExpression {
  ...
  private JType overridenReturnType;
  ...
  public JMethodCall(JMethodCall other, JExpression instance) {
    ...
    this.overridenReturnType = other.overridenReturnType;
  ...
  public JType getType() {
    return overridenReturnType != null ? overridenReturnType : method.getType();
  }
  ...
  public void overrideReturnType(JType overridenReturnType) {
    assert this.overridenReturnType == null;
    this.overridenReturnType = overridenReturnType;
  }
  /**
