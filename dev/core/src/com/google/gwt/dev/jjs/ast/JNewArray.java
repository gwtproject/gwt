...
public class JNewArray extends JExpression {
   ...
   */
  private JClassLiteral baseClassLiteral;

  private JArrayType type;

  public JNewArray(SourceInfo info, JArrayType type, List<JExpression> dims,
      List<JExpression> initializers, JClassLiteral baseClassLiteral) {
    super(info);
    this.type = type;
    this.dims = dims;
    this.initializers = initializers;
    this.baseClassLiteral = baseClassLiteral;
    assert !(baseClassLiteral.getRefType() instanceof JArrayType);
  }
  ...
  /**
   * Return a class literal for the base type of the array.
   */
  public JClassLiteral getBaseClassLiteral() {
  ...
  public void traverse(JVisitor visitor, Context ctx) {
    if (visitor.visit(this, ctx)) {
      ...
      baseClassLiteral = (JClassLiteral) visitor.accept(baseClassLiteral);
    }
