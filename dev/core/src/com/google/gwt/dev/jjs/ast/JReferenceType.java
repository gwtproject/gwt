...
public abstract class JReferenceType extends JType implements CanBeAbstract {
  ...
  private static class JAnalysisDecoratedType extends JReferenceType {
    ...
    private Object readResolve() {
      ...
      // per type.
      return ref.getAnalysisDecoratedTypePool().getAnalysisDecoratedType(ref, analysisResult);
    }
    ...
    public JReferenceType getAnalysisDecoratedType(JReferenceType type, AnalysisResult request) {
      ...
      if (result == null) {
        result = decoratedAnalysisTypePool[poolIndex] =
            new JAnalysisDecoratedType(type.getUnderlyingType(), request);
      }
      return result;
    }
  }
  ...
  JReferenceType(SourceInfo info, String name,
      AnalysisDecoratedTypePool analysisDecoratedTypePool) {
    super(info, name);
    this.analysisDecoratedTypePool = analysisDecoratedTypePool;
  }
  @Override
  ...
  private AnalysisDecoratedTypePool getAnalysisDecoratedTypePool() {
