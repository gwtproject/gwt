...
public class JTypeOracle implements Serializable {
   ...
   */
  private Map<JMethod, Multimap<JClassType, JMethod>> virtualUpRefMap =
  ...
  private void computeExtendedTypeRelations() {
    ...
    computePotentialImplementMaps();
    computeSingleJSO();
    computeDualJSO();
    System.out.printf("ComputeExtendedTypeRelations - %.3fs", (System.nanoTime() - time) / 1000000000.0);
  }
  ...
  private void computePotentialImplementMaps() {
  ...
  private void computeImplementsMaps() {
    ...
    Multimap<String, String> superTypesByTypeClosure =
        transitiveClosure(superTypesByType);
