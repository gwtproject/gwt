...
public class JTypeOracle implements Serializable {
  ...
  /**
   * Get all implemented interfaces of <code>type</code>.
   */
  ...
  /**
   * Get all implemented JsFunction interfaces of <code>type</code>.
  ...
  public boolean isOrExtendsJsFunction(JDeclaredType type) {
    if (isJsInteropEnabled()) {
      return getImplementedJsFunctions(type).size() > 0;
    } else {
      return false;
    }
  }
