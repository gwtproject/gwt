...
public class ArrayNormalizer {
  ...
  private class ArrayVisitor extends JModVisitor {
    ...
    private JExpression initializeUnidimensionalArray(JNewArray x, JArrayType arrayType) {
      ...
      JMethodCall call =
          new JMethodCall(sourceInfo, null, initializeUnidimensionalArray, arrayType);
    ...
    private JExpression initializeMultidimensionalArray(JNewArray x, JArrayType arrayType) {
      ...
      SourceInfo sourceInfo = x.getSourceInfo();
      JMethodCall call =
          new JMethodCall(sourceInfo, null, initializeMultidimensionalArray, arrayType);
    ...
    private JExpression createArrayFromInitializers(JNewArray x, JArrayType arrayType) {
      // override the type of the called method with the array's type
      SourceInfo sourceInfo = x.getSourceInfo();
      JMethodCall call = new JMethodCall(sourceInfo, null, stampJavaTypeInfo, arrayType);
  ...
  private final JMethod initializeUnidimensionalArray;
  private final JMethod initializeMultidimensionalArray;
  private final JMethod stampJavaTypeInfo;
  ...
  private ArrayNormalizer(JProgram program) {
    ...
    initializeUnidimensionalArray = program.getIndexedMethod(
        RuntimeConstants.ARRAY_INITIALIZE_UNIDIMENSIONAL_ARRAY);
    initializeMultidimensionalArray = program.getIndexedMethod(
        RuntimeConstants.ARRAY_INITIALIZE_MULTIDIMENSIONAL_ARRAY);
    stampJavaTypeInfo = program.getIndexedMethod(RuntimeConstants.ARRAY_STAMP_JAVA_TYPE_INFO);
  }
