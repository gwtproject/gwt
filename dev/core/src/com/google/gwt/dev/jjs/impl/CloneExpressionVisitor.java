...
public class CloneExpressionVisitor extends JVisitor {
  ...
  public boolean visit(JNewArray x, Context ctx) {
    expression =
        new JNewArray(x.getSourceInfo(), x.getArrayType(), cloneExpressions(
            x.getDimensionExpressions()),
            cloneExpressions(x.getInitializers()), cloneExpression(x.getLeafTypeClassLiteral()));
    return false;
  }
