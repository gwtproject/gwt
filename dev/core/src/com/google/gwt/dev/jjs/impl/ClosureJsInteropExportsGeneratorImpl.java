...
public class ClosureJsInteropExportsGeneratorImpl extends JsInteropExportsGenerator {
   ...
   * doesn't have any exported members, since the ctor.prototype fields will need to exist for
   *
   * @JsDoc declarations that refer to the virtual methods of the class.
   */
  @Override
