...
public class CompilerState implements Serializable {
  ...
  private transient Map<StandardSymbolData, JsName> symbolTable;
  private final transient Permutation permutation;

  {
    symbolTable = new TreeMap<StandardSymbolData, JsName>(new SymbolData.ClassIdentComparator());
  }

  public CompilerState(UnifiedAst.AST ast, Permutation permutation) {
