...
public class ComputeOverridesAndImplementDefaultMethods {
    ...
    for (String signature : interfaceMethodsBySignature.keySet()) {
      ...
      if (baseImplementingMethod == null) {
        ...
        baseImplementingMethod = polymorphicMethodsByExtendedSignature.get(
            getPackagePrivateSignature(type.getPackageName(), signature));
      }
  ...
  private String getPackagePrivateSignature(JMethod method) {
    ...
    return getPackagePrivateSignature(packageName, method.getSignature());
  }

  private String getPackagePrivateSignature(String packageName, String publicSignature) {
