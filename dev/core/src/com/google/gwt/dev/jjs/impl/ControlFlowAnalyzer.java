...
public class ControlFlowAnalyzer {
  ...
  private class RescueVisitor extends JVisitor {
    ...
    private boolean canBeInstatiatedInJavaScript(JType type) {
      ...
      return elementType instanceof JPrimitiveType || canBeInstatiatedInJavaScript(elementType);
    }
    ...
    private void maybeRescueJavaScriptObjectPassingIntoJava(JType type) {
      if (!canBeInstatiatedInJavaScript(type)) {
        return;
      }
