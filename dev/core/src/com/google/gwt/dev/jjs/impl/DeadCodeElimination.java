  ...
  public class DeadCodeVisitor extends JModVisitor {
    ...
    public void endVisit(JMultiExpression x, Context ctx) {
      ...
      for (int i = 0; i < numRemovableExpressions(x); ++i) {
        ...
        // TODO(rluble): Add test cases to verify this optimization is actually performed.
        // Test infrastructure to create JMultiExpressions needs to be added.
        ...
        if (expr instanceof JMethodCall && JProgram.isClinit(((JMethodCall) expr).getTarget())) {
          ...
          if (JProgram.containsSubtype(enclosingType, clinitsCalled)) {
            x.exprs.remove(i);
            --i;
            madeChanges();
            continue;
