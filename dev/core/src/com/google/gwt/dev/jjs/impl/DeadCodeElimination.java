...
public class DeadCodeElimination {
  ...
  public static OptimizerStats exec(JProgram program) {
    return new DeadCodeElimination(program, new OptimizerContext(program)).execImpl(program);
  }

  // TODO(leafwang): remove this entry point when it is no longer needed.
  public static OptimizerStats exec(JProgram program, JNode node) {
    return new DeadCodeElimination(program, new OptimizerContext(program)).execImpl(node);
  }
