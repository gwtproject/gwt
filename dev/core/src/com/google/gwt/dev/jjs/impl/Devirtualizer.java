...
public class Devirtualizer {
  ...
  /**
   * True if the methods is an overlay method. Overlay methods include the ones that are marked
   * JsOverlay and also (synthetic) private instance methods on interfaces
   * <p>
   * Synthetic private methods on interfaces are the result of lambdas that capture the enclosing
   * instance defined on default methods.
   */
  private boolean isOverlayMethod(JMethod method) {
    // Lambdas that are synthesized as private instance methods in interfaces need to be
    // devirtualized in the same manner as JsOverlay methods.
