...
public class Devirtualizer {
  ...
  private class RewriteVirtualDispatches extends JModVisitor {
    ...
    private boolean isSuperOfUnboxedType(JType targetType) {
      return program.typeOracle.castSucceedsTrivially(program.getTypeJavaLangDouble(), targetType)
          || program.typeOracle.castSucceedsTrivially(program.getTypeJavaLangBoolean(), targetType);
    }
  }
