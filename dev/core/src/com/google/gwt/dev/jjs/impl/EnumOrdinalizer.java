...
public class EnumOrdinalizer {
  ...
  private class ReplaceEnumTypesWithInteger extends TypeRemapper {
    ...
    public void endVisit(JDeclarationStatement x, Context ctx) {
      ...
      // Also replace the declaration statement so that there enum instances are not constructed;
      // eventually the field will be pruned but the declaration statement will only completely
      // disappear if there are no side effects (which our current analysis will not prove for
      // instantiations).
