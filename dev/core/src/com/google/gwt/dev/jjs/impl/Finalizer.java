...
public class Finalizer {
  ...
  private class FinalizeVisitor extends OptimizerVisitor {
    ...
    public FinalizeVisitor() {
      super(Finalizer.this.optimizerCtx);
    }
  ...
  public static OptimizerStats exec(JProgram program) {
    ...
    OptimizerStats stats = new Finalizer(new OptimizerContext()).execImpl(program);
  ...
  public static OptimizerStats exec(JProgram program, OptimizerContext optimizerCtx) {
    Event optimizeEvent = SpeedTracerLogger.start(CompilerEventType.OPTIMIZE, "optimizer", NAME);
    OptimizerStats stats = new Finalizer(optimizerCtx).execImpl(program);
  ...
  private Finalizer(OptimizerContext optimizerCtx) {
