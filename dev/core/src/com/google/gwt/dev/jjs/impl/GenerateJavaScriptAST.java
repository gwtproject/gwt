...
public class GenerateJavaScriptAST {
  ...
  private class GenerateJavaScriptTransformer extends JTransformer<JsNode> {
    ...
    public JsNode transformCastMap(JCastMap castMap) {
      ...
      return buildJsCastMapLiteral(transform(castMap.getCanCastToTypes()), sourceInfo);
    }
    ...
    private Set<JDeclaredType> generatePreamble(JProgram program) {
      ...
      addTypeDefinitionStatement(program.getIndexedType(JCHSU),
          constructInvocation(
              program.getSourceInfo(), JCHSU_MODERNIZE_BROWSER).makeStmt());
    ...
    private void generatePrototypeAssignment(JMethod method, JsName name, JsExpression rhs) {
      generatePrototypeAssignment(method.getJsPropertyAccessorType(), method, name, rhs);
    }
      ...
      */
    private void generatePrototypeAssignment(
    ...
    private void generatePrototypeDefinitionAlias(JMethod method, JsName alias) {
      ...
      generatePrototypeAssignment(JsPropertyAccessorType.NONE, method, alias, bridge);
    }
