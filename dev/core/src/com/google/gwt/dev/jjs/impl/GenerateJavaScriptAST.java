...
public class GenerateJavaScriptAST {
  ...
  String mangleJavaLangObjectInstanceField(JField field) {
    assert (JsProtectedNames.getJavaLangObjectObfuscatedNameBySignature(field.getName()) != null)
      : "java.lang.Object field \"" + field.getName() + "\" is not in JsProtectedNames";
    switch (output) {
      case OBFUSCATED:
        return JsProtectedNames.getJavaLangObjectObfuscatedNameBySignature(field.getName());
      case PRETTY:
  ...
  String mangleJavaLangObjectInstanceMethod(JMethod method) {
    assert
        (JsProtectedNames.getJavaLangObjectObfuscatedNameBySignature(method.getSignature()) != null)
        : "java.lang.Object method \"" + method.getSignature() + "\" is not in JsProtectedNames";
    switch (output) {
      case OBFUSCATED:
        return JsProtectedNames.getJavaLangObjectObfuscatedNameBySignature(method.getSignature());
      case PRETTY:
        return method.getName() + "$";
      case DETAILED:
  ...
  private boolean isJavaLangObjectPolymorphicMethodSignature(String signature) {
    return JsProtectedNames.getJavaLangObjectObfuscatedNameBySignature(signature) != null;
  }
