    ...
    private void embedBindingProperties() {
      ...
      for (ImmutableMap<String, String> propMap : props.findEmbeddedProperties(TreeLogger.NULL)) {
        ...
        for (Entry<String, String> entry : propMap.entrySet()) {
          ...
          pair.getExpressions().add(new JsStringLiteral(sourceInfo, entry.getKey()));
          pair.getExpressions().add(new JsStringLiteral(sourceInfo, entry.getValue()));
      ...
      jsProgram.getGlobalBlock().getStatements().add(
        constructInvocation(sourceInfo, "ModuleUtils.setPermProps", permProps).makeStmt());
    }
