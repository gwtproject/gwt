...
public class GenerateJavaScriptAST {
  ...
  private class CreateNamesAndScopesVisitor extends JVisitor {
    ...
    public boolean visit(JClassType x, Context ctx) {
      ...
      if (x.getSuperClass() == null || x.getSuperClass().isJsNative()) {
        myScope = objectScope;
      } else {
  ...
  private class GenerateJavaScriptVisitor extends JVisitor {
    ...
    public void endVisit(JMethodCall x, Context ctx) {
      ...
      if (JProgram.isClinit(method)) {
        ...
        // TODO is this needed? perhaps should be done somewhere else earlier
        if (clinitTarget == null || clinitTarget.isJsNative()) {
          if (x.getInstance() != null) {
            pop(); // instance
          }
