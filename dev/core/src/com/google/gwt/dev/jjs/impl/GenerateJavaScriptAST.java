  ...
  private class GenerateJavaScriptVisitor extends JVisitor {
    ...
    public void endVisit(JMethodCall x, Context ctx) {
      ...
      if (method.isStatic()) {
        ...
        JsNameRef qualifier = polymorphicNames.get(method).makeRef(x.getSourceInfo());
        qualifier.setQualifier((JsExpression) pop()); // instance
        result = new JsInvocation(x.getSourceInfo(), qualifier, args);
      }
    ...
    private JsExpression dispatchToStatic(JMethodCall x, JMethod method, List<JsExpression> args) {
      ...
      JsExpression result = new JsInvocation(x.getSourceInfo(), methodRef, args);
      if (x.getInstance() != null) {
    ...
    private JsExpression dispatchToSuperPrototype(JMethodCall x, JMethod method,
      ...
      if (!(method instanceof JConstructor) && method.isOrOverridesJsMethod()) {
        ...
        JsNameRef methodRef = new JsNameRef(x.getSourceInfo(), method.getName());
