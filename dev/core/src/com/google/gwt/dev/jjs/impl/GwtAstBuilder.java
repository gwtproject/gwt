...
public class GwtAstBuilder {
  ...
  public static final String JSINTERFACEPROTYPE_CLASS = "com.google.gwt.core.client.js.impl.JsInterfacePrototype";
  ...
  private void createTypes(TypeDeclaration x) {
    ...
    try {
      ...
      if (binding.isClass()) {
        ...
        if (getAnnotation(x.binding,JSINTERFACEPROTYPE_CLASS) != null) {
