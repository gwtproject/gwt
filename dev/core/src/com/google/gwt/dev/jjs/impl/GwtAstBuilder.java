...
public class GwtAstBuilder {
  ...
  class AstVisitor extends SafeASTVisitor {
    ...
    private void createFunctionalExpressionBridges(JClassType functionalExpressionImplementationClass,
        FunctionalExpression functionalExpression, JMethod functionalInterfaceAbstractMethod) {
    ...
    private void createBridgeMethod(JDeclaredType enclosingType, MethodBinding sourceMethodBinding, JMethod targetMethod) {
      JType returnType = typeMap.get(sourceMethodBinding.returnType);
      Iterable<JType> parameterTypes = FluentIterable.from(Arrays.asList(sourceMethodBinding.parameters)).transform(
      ...
      JMethod bridgeMethod =
          createBridgeMethod(enclosingType, targetMethod, parameterTypes, returnType, thrownExceptionTypes);
