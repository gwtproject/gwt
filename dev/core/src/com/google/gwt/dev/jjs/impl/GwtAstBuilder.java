...
public class GwtAstBuilder {
  ...
  class AstVisitor extends SafeASTVisitor {
    ...
    private JExpression box(
      ...
      JMethod boxingMethod = typeMap.get(JdtUtil.getUnboxingMethodBinding(scope, primitiveType));
    ...
    private JExpression maybeBoxOrUnbox(
      ...
      if (requiresBoxing(implicitConversion)) {
        return box(original, JdtUtil.getBoxingPrimitiveType(curClass.scope, implicitConversion), doNotAutobox);
      }
