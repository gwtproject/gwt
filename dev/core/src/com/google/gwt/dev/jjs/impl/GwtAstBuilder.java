    ...
    private void replaceLambdaWithInnerClassAllocation(LambdaExpression x, final SourceInfo info,
      ...
      for (final SyntheticArgumentBinding sa : synthArgs) {
        ...
        LocalVariableBinding localVariable =
            FluentIterable.from(method.locals.keySet()).firstMatch(
                new Predicate<LocalVariableBinding>() {
                  ...
                  public boolean apply(LocalVariableBinding enclosingLocal) {
                    ...
                    return enclosingLocal == sa.actualOuterLocalVariable
                        ...
                        && ((SyntheticArgumentBinding) enclosingLocal).actualOuterLocalVariable == sa.actualOuterLocalVariable;
                  }
                }).orNull();
        if (localVariable != null) {
          ...
          Entry<SyntheticArgumentBinding, JField> capturedLocalInOuterClass =
              FluentIterable.from(curClass.syntheticFields.entrySet()).firstMatch(
          ...
          if (capturedLocalInOuterClass != null) {
            ...
            capturedLocalReference =
                makeInstanceFieldRef(info, capturedLocalInOuterClass.getValue());
          }
        }
