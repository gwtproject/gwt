...
public class GwtAstBuilder {
    ...
    public void endVisit(ForeachStatement x, BlockScope scope) {
       ...
       * </pre>
        ...
        if (elementVar.getType() != javaLangObject) {
          TypeBinding collectionElementType = getCollectionElementTypeBinding(x, scope);
  ...
  private TypeBinding getCollectionElementTypeBinding(ForeachStatement x, BlockScope blockScope) {
    return (TypeBinding) accessPrivateField(
        JdtPrivateHacks.collectionElementTypeField, x);
  }
