...
public class GwtAstBuilder {
  ...
  private static final String CREATE_VALUE_OF_MAP = "createValueOfMap";
  private static final String LENGTH = "length";
  private static final String VALUE_SUFFIX = "Value";

  private static final char[] CREATE_VALUE_OF_MAP_ = CREATE_VALUE_OF_MAP.toCharArray();
  private static final char[] VALUE_SUFFIX_ = VALUE_SUFFIX.toCharArray();
  private static final char[] VALUE_OF_ = VALUE_OF.toCharArray();
  private static final char[] VALUES_ = VALUES.toCharArray();
  private static final char[] ORDINAL_ = ORDINAL.toCharArray();
  private static final char[] NEXT_ = NEXT.toCharArray();
  private static final char[] ITERATOR_ = ITERATOR.toCharArray();
  private static final char[] HAS_NEXT_ = HAS_NEXT.toCharArray();
  ...
  class AstVisitor extends SafeASTVisitor {
    ...
    public void endVisit(FieldReference x, BlockScope scope) {
      try {
        ...
        if (fieldBinding.declaringClass == null) {
          if (!LENGTH.equals(String.valueOf(fieldBinding.name))) {
    ...
    private JClassType createInnerClass(String name, FunctionalExpression x, SourceInfo info,
      ...
      createSyntheticMethod(info, GwtAstBuilder.GET_CLASS, innerLambdaClass, javaLangClass,
    ...
    private void implementGetClass(JDeclaredType type) {
      ...
      assert (GwtAstBuilder.GET_CLASS.equals(method.getName()));
    ...
    private void processEnumType(JEnumType type) {
      ...
      {
        assert VALUE_OF.equals(valueOfMethod.getName());
    ...
    try {
      ...
      if (type instanceof JClassType) {
        ...
        if (isSyntheticGetClassNeeded(x, type)) {
          ...
          createSyntheticMethod(info, GET_CLASS, type, javaLangClass, type.isAbstract(), false,
