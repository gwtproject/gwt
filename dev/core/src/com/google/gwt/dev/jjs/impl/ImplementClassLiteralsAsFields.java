...
public class ImplementClassLiteralsAsFields {
   ...
   *
   * <pre>
   * Class.createForClass("java.lang.", "Object", /JTypeIdOf/"java.lang.Object", null)
   * Class.createForClass("java.lang.", "Exception", /JTypeIdOf/"java.lang.Exception", Throwable.class)
   * </pre>
   *
   * Interface:
   *
   ...
   *
   * <pre>
   * Class.createForArray("", "[I", /JTypeIdOf/"com.google.gwt.lang.Array", int.class)
   * Class.createForArray("[Lcom.example.", "Foo;", /JTypeIdOf/"com.google.gwt.lang.Array", Foo.class)
   * </pre>
   *
   * Enum:
   *
   * <pre>
   * Class.createForEnum("com.example.", "MyEnum", /JTypeIdOf/"com.example.MyEnum", Enum.class,
   ...
   *
   * <pre>
   * Class.createForEnum("com.example.", "MyEnum$1", /JTypeIdOf/"com.example.MyEnum$1", MyEnum.class,
   *     null, null))
   * </pre>
   */
  private JMethodCall computeClassObjectAllocation(SourceInfo info, JType type) {
    ...
    if (type instanceof JArrayType || type instanceof JClassType) {
      ...
      call.addArg(new JTypeIdOf(info, program.getTypeJavaLangString(), type));
