...
public class ImplementClassLiteralsAsFields {
  ...
  private void execImpl() {
    ...
    // TODO(rluble): This is kind of hacky. Class literals should be implemented as fields
    // always in a normalizer pass and rely on compiler optimizations to remove unused ones, instead
    // of trying ot be smart on their placement.
