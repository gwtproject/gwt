...
public class JavaToJavaScriptMapImpl implements JavaToJavaScriptMap {
  ...
  private final HashMap<JsName, JField> fieldForName;
  private final Map<JsName, JMethod> methodForName;
  private final HashMap<JsName, JClassType> typeForConstructorName;
  ...
  public JavaToJavaScriptMapImpl(List<JDeclaredType> types,
    ...
    Map<JsName, JMethod> nameToMethodMap = new HashMap<JsName, JMethod>();
    HashMap<JsName, JField> nameToFieldMap = new HashMap<JsName, JField>();
    HashMap<JsName, JClassType> constructorNameToTypeMap = new HashMap<JsName, JClassType>();
