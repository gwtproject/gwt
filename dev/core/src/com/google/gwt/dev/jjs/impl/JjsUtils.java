...
public class JjsUtils {
  ...
  private static Map<Class<? extends JLiteral>, LITERAL_TRANSLATOR> translatorByLiteralClass =
      new ImmutableMap.Builder()
          .put(JBooleanLiteral.class, LITERAL_TRANSLATOR.BOOLEAN_LITERAL_TRANSLATOR)
          .put(JCharLiteral.class, LITERAL_TRANSLATOR.CHAR_LITERAL_TRANSLATOR)
          .put(JFloatLiteral.class, LITERAL_TRANSLATOR.FLOAT_LITERAL_TRANSLATOR)
          .put(JDoubleLiteral.class, LITERAL_TRANSLATOR.DOUBLE_LITERAL_TRANSLATOR)
          .put(JIntLiteral.class, LITERAL_TRANSLATOR.INT_LITERAL_TRANSLATOR)
          .put(JLongLiteral.class, LITERAL_TRANSLATOR.LONG_LITERAL_TRANSLATOR)
          .put(JNullLiteral.class, LITERAL_TRANSLATOR.NULL_LITERAL_TRANSLATOR)
          .put(JStringLiteral.class, LITERAL_TRANSLATOR.STRING_LITERAL_TRANSLATOR)
          .build();

  private enum LITERAL_TRANSLATOR {
