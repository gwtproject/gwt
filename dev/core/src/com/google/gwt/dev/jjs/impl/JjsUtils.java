...
public class JjsUtils {
  ...
  public static JMethod createForwardingMethod(JDeclaredType type,
    ...
    JMethod forwardingMethod = createEmptyMethod(type, methodToDelegateTo, false);
