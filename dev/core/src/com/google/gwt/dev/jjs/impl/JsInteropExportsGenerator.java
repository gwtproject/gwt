...
public class JsInteropExportsGenerator {
  ...
  boolean maybeExportTypeWithNoExportedMembers(JDeclaredType x, TreeLogger branch) {
    return false;
  }
  ...
  static class ClosureJsInteropExportsGenerator extends JsInteropExportsGenerator {
    ...
    /**
     * Ensures that enclosing namespaces are exported with an empty ctor even if the
     * enclosing type doesn't have any exported members, since the ctor.prototype fields will
     * need to exist for @JsDoc declarations that refer to the virtual methods of the class.
     */
    @Override
    boolean maybeExportTypeWithNoExportedMembers(JDeclaredType x, TreeLogger branch) {
