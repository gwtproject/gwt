...
public class JsInteropRestrictionChecker {
  ...
  private void checkLocalNames(JDeclaredType type) {
    MembersByLocalName membersByLocalName = new MembersByLocalName(type);

   for (String jsName : membersByLocalName.getLocalNames()) {
      Collection<JMember> members = membersByLocalName.getMembers(jsName);

      checkNameCollisionForPropertyAccessorAndRegular(membersByLocalName,jsName, type.getName());
  ...
  private void checkNameCollisionForPropertyAccessorAndRegular(
      MembersByLocalName membersByLocalName, String propertyName, String typeName) {
