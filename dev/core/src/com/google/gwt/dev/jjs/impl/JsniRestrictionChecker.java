...
public class JsniRestrictionChecker extends JVisitor {
  ...
  public boolean visit(JsniMethodRef x, Context ctx) {
    ...
    if (isJsoInterface(enclosingTypeOfCalledMethod)) {
      String signatureOfCurrentJsniMethod = currentJsniMethod.getEnclosingType().getShortName()
          + "." + currentJsniMethod.getSignature();
      String signatureOfCalledMethod =
          calledMethod.getEnclosingType().getShortName() + "." + calledMethod.getSignature();

      logger.log(TreeLogger.ERROR, "JSNI method " + signatureOfCurrentJsniMethod
          + " attempts to call method " + signatureOfCalledMethod
