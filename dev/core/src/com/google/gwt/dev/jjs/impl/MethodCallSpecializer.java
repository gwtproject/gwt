...
public class MethodCallSpecializer {
  ...
  private class MethodCallSpecializingVisitor extends OptimizerVisitor {
    ...
    public MethodCallSpecializingVisitor() {
      super(OptimizerDependencies.METHODCALLSPECIALIZER_IDX, MethodCallSpecializer.this.optDependencies);
    }
  ...
  private OptimizerStats execImpl() {
    optDependencies.removeModificationsByLastPass(OptimizerDependencies.METHODCALLSPECIALIZER_IDX);
    MethodCallSpecializingVisitor specializer = new MethodCallSpecializingVisitor();
    specializer.accept(program);
    optDependencies.getCallGraph().addCallers(specializer.newCallSite);
