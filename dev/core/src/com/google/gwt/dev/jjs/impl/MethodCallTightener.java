  ...
  public class MethodCallTighteningVisitor extends JChangeTrackingVisitor {
    ...
    public void endVisit(JMethodCall x, Context ctx) {
      ...
      if (mostSpecificTarget.getEnclosingType().isJsNative()) {
        // Never tighten to a native implementations. This is mainly done so that
        // java.lang.Object methods are dispatched through trampolines if they are not explicitly
        // declared in the type declaration.
        return;
      }
