...
public class MethodCallTightener {
  ...
  public class MethodCallTighteningVisitor extends JModVisitor {
    ...
    public void endVisit(JMethodCall x, Context ctx) {
      ...
      if (!foundMethod.getOverridenMethods().contains(method)) {
        // The method has the same signature but is not override. This found method is probably a
        // method with the same name and signature as a private package method of a super class
