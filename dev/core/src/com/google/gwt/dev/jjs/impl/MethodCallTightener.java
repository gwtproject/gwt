  ...
  public class MethodCallTighteningVisitor extends JModVisitor {
    ...
    public void endVisit(JMethodCall x, Context ctx) {
      ...
      if (!foundMethod.getOverriddenMethods().contains(method)) {
        ...
        // but does override it. this situation occurs for example when the target method is package
        // private and the found method is a method with the same name and signature as the target
        // method in a subclass declared in a different package).
        return;
      }
