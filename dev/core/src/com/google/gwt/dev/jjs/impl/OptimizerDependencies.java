...
public class OptimizerDependencies {
  ...
  /**
   *
   * Dependence info for MethodInliner maintain a {callee -> callers} map (callSite) and a set of
   * modified methods (modifiedMethods)
   */
  ...
  public boolean methodInlinerIsMaintained() {
    System.out.println(depForMethodInliner.isMaintained());
