...
public class Pruner {
   ...
   */
  private class CleanupRefsVisitor extends OptimizerVisitor {
    ...
    public CleanupRefsVisitor(Set<? extends JNode> referencedNodes,
      ...
      super(OptimizerDependencies.PRUNER_IDX, Pruner.this.optDependencies);
   ...
   */
  private class PruneVisitor extends OptimizerVisitor {
    private final Map<JMethod, ArrayList<JParameter>> methodToOriginalParamsMap =
  ...
  public static OptimizerStats exec(JProgram program, boolean noSpecialTypes) {
    Event optimizeEvent = SpeedTracerLogger.start(CompilerEventType.OPTIMIZE, "optimizer", NAME);
    OptimizerStats stats = new Pruner(program, noSpecialTypes, new OptimizerDependencies()).execImpl();
    optimizeEvent.end("didChange", "" + stats.didChange());
    return stats;
  }
  ...
  private OptimizerStats execImpl() {
    ...
    optDependencies.removeModificationsByLastPass(OptimizerDependencies.PRUNER_IDX);
    PruneVisitor pruner =
    ...
    optDependencies.getCallGraph().addCallers(pruner.newCallSite);
