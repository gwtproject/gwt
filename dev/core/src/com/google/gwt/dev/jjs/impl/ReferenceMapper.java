...
public class ReferenceMapper {
  ...
  public void setField(FieldBinding binding, JField field) {
    // Make sure at a the field binding enclosing type corresponds to the enclosing type of field,
    // to avoid associating a field binding with the wrong JField.
  ...
  public void setMethod(MethodBinding binding, JMethod method) {
    // Make sure at a the method binding enclosing type corresponds to the enclosing type of method,
    // to avoid associating a method binding with the wrong JMethod.
