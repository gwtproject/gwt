...
public class ReplaceDefenderMethodReferences {
  ...
  public static void exec(final JProgram program) {
    ...
    // At this point we could remove the <instance method> <-> <devirtualized method> mapping from
    // JProgram except for the fact that incremental compilation relies on this memory.
  }
}
