...
import com.google.gwt.dev.AnswerMap;
...
public class ResolveRebinds {
  ...
  public static boolean exec(JProgram program, List<AnswerMap> gwtCreateAnswers) {
    return new ResolveRebinds(program, gwtCreateAnswers).execImpl();
  }

  private final JProgram program;
  private final List<AnswerMap> answers;
  private final AnswerMap hardRebindAnswers;
  ...
  private ResolveRebinds(JProgram program, List<AnswerMap> gwtCreateAnswers) {
    this.program = program;
    this.answers = gwtCreateAnswers;
    this.hardRebindAnswers = AnswerMap.getCommonAnswers(gwtCreateAnswers);
  ...
  private JMethod rebindMethod(SourceInfo info, String requestType, List<String> resultTypes,
    ...
    Map<String, List<Integer>> resultsToPermutations =
        AnswerMap.getAnswerPermutations(answers, requestType);
