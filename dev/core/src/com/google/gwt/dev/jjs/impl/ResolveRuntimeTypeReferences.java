...
public abstract class ResolveRuntimeTypeReferences {
   ...
   */
  public static class IntoMostlyIntLiterals extends ResolveRuntimeTypeReferences {
    ...
    public static Map<JType, JLiteral> exec(JProgram program) {
      return new IntoMostlyIntLiterals(program,
          new IntTypeIdGenerator()).execImpl();
    }

    private IntTypeIdGenerator intTypeIdGenerator;

    private IntoMostlyIntLiterals(JProgram program, IntTypeIdGenerator intTypeIdGenerator) {
      super(program);
  ...
  protected void assignId(JType type) {
    if (type instanceof JArrayType) {
      ...
      // these two function should be consistent.
