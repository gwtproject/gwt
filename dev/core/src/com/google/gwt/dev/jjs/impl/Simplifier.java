...
public class Simplifier {
  ...
  private JExpression castImpl(JExpression original, SourceInfo info, JType type, JExpression exp) {
  ...
  private JExpression conditionalImpl(JConditional original, SourceInfo info, JType type,
  ...
  private JStatement ifStatementImpl(JIfStatement original, SourceInfo info, JExpression condExpr,
  ...
  private JExpression notImpl(JPrefixOperation original, SourceInfo info, JExpression arg) {
  ...
  private JExpression andImpl(JBinaryOperation original, SourceInfo info, JExpression lhs,
                              JExpression rhs) {
  ...
  private JExpression orImpl(JBinaryOperation original, SourceInfo info, JExpression lhs,
                             JExpression rhs) {
    info = getBestSourceInfo(original, info, lhs);
    if (lhs instanceof JMultiExpression) {
      // (a,b,c)|| d -> a,b,(c||d)
