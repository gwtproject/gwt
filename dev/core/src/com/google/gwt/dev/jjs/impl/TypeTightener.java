...
public class TypeTightener {
  ...
  /**
   * For each program Variable (includes fields, locals and parameters) tracksthe set
   * of expressions that are assigned to them. Assignements include parameter instantiations.
   *
   */
  ...
  /**
   * For each parameter P (in menthod M) tracks the set of parameters that share its position in all
   * the methods that are overriden by M.
   */
