...
class ExclusivityMap {
   ...
   */
  private class ExclusivityMapLivenessPredicate implements FragmentExtractor.LivenessPredicate {
  ...
  FragmentExtractor.LivenessPredicate getLivenessPredicate(int fragment) {
   ...
   * in the comment of {@link com.google.gwt.dev.jjs.impl.FragmentExtractor.LivenessPredicate}. Load-order dependencies can be
