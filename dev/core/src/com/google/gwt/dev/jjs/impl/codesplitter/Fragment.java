...
class Fragment {
  ...
  public Fragment(Type type, Fragment... immediatePredecessors) {
    this.type = type;
    this.addPredecessors(immediatePredecessors);
  }
  ...
  public void addPredecessors(Fragment... predecessors) {
    for (Fragment predecessor : predecessors) {
      this.immediatePredecessors.add(predecessor);
    }
  }
  ...
  private Set<Fragment> immediatePredecessors = Sets.newHashSet();
}
