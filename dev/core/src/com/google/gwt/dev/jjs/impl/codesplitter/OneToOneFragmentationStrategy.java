 ...
 * exclusive fragment.
*/
class OneToOneFragmentationStrategy implements FragmentationStrategy {
  @Override
  public List<Fragment> partitionIntoFragments(ControlFlowAnalyzer initiallyLive,
      Collection<JRunAsync> nonInitialRunAsyncs, int nextFragmentToAssign) {
    /**
    ...
    for (JRunAsync runAsync : nonInitialRunAsyncs) {
      Fragment fragment =
          new Fragment(Fragment.Type.EXCLUSIVE, nextFragmentToAssign++);
