...
public class BaselineCoverageGatherer {
  public static Multimap<String, Integer> exec(CompilerState compilerState) {
    return new BaselineCoverageGatherer(compilerState.getjProgram(), getCoveredSourceFiles())
        .execImpl();
  }
