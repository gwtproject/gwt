...
public class ClosureJsRunner {
  ...
  public void compile(CompilerState compilerState, String[] js, JsOutputOption jsOutputOption) {
    ...
    JsProgram program = compilerState.getJsProgram();
    // Translate the ASTs and build the modules
    computeFragmentMap(compilerState);
  ...
  private void computeFragmentMap(CompilerState compilerState) {
