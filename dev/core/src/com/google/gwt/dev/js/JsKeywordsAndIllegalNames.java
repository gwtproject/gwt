 ...
 */
public class JsKeywordsAndIllegalNames {

  private static Set<String> javaScriptKeywords = new HashSet<String>();

  private static Set<String> illegalNames = new HashSet<String>();
  ...
  private static synchronized void initNameBlacklist() {
    ...
    String[] namesToAvoid = {
        // These might be top level function that we care not to hide. Grabbed from closure
        // externs es?.js, w3c_d*.js and window.js.
        //
    ...
    for (int i = 0; i < keywords.length; i++) {
      ...
      illegalNames.add(keywords[i]);
    }

    for (int i = 0; i < namesToAvoid.length; i++) {
      illegalNames.add(namesToAvoid[i]);
    }
  }

  private JsKeywordsAndIllegalNames() {
  }
