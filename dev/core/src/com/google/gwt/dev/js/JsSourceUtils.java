...
public class JsSourceUtils {
  ...
  @VisibleForTesting
  static final String JS_STRING_PATTERN = "(\"([^\"\\\\]|(\\\\.))*\")";

  // A regular expression that matches a single line comment
  private static final String OPEN_TRAILING_BLOCK_COMMENT_PATTERN = "/\\*([^*]|\\*[^/])*";

  // Regular expression that maches a C-style a comment of the form /* .... */.
  @VisibleForTesting
  static final String BLOCK_COMMENT_PATTERN = OPEN_TRAILING_BLOCK_COMMENT_PATTERN + "\\*/";

  // Regular expression that maches a JS string.
  @VisibleForTesting
  static final String JS_REG_EXP_PATTERN = "(/([^/\\\\]|\\\\.)+/([mgi]{0,3}))";
  ...
  private static final String REGULAR_TEXT_PATTERN = "("
  ...
  // A regular expression that matches a single line comment
  private static final String TRAILING_SINGLE_LINE_COMMENT_PATTERN = "//.*";
   ...
   */
  public static String condenseIntoOneLine(String snippet) {
