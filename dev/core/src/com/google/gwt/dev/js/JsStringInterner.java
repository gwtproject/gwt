...
public class JsStringInterner {
   ...
   */
  public static Map<JsName, String> exec(CompilerContext compilerContext) {
    JProgram jProgram = compilerContext.getJProgram();
    JsProgram jsProgram = compilerContext.getJsProgram();
    StringVisitor v = new StringVisitor(jProgram, jsProgram.getScope(),
        compilerContext.isIE6OrUnknown() ? null : getOccurenceMap(jsProgram));
    v.accept(jsProgram);
