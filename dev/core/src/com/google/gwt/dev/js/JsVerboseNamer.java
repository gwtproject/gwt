...
public class JsVerboseNamer extends JsNamer {
  ...
  public static void exec(JsProgram jsProgram) {
    new JsVerboseNamer(jsProgram, null).execImpl();
  }

  public static void exec(CompilerState compilerState) {
    new JsVerboseNamer(compilerState.getJsProgram(), compilerState.getPropertyOracles()).execImpl();
  }
