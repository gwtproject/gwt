 ...
 * <p>
 * ResourceAccumulators consume native resources and so require very strict lifecycle management
 * but ClassPathEntry and PathPrefixSet lifecycle management is very loose. This makes it difficult
 * to release ResourceAccumulator at the proper time. This manager class uses weak references to
 * ClassPathEntry and PathPrefixSet instances to lazily discover when ResourceAccumulator become
...
class ResourceAccumulatorManager {
   ...
   * were requested.
   */
  public static synchronized ResourceAccumulator get(
   ...
   * destroyed (and thus can no longer be queried about) and shuts down the associated resource
   * accumulation.
   */
