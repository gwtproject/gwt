...
public class ResourceResolution {
  ...
  private SortedSet<String> sourceModuleNames = Sets.newTreeSet();

  public boolean addSourceModuleName(String sourceModuleName) {
    return sourceModuleNames.add(sourceModuleName);
  }
  ...
  public boolean equals(Object object) {
    if (object instanceof ResourceResolution) {
      ...
      return Objects.equal(this.pathPrefix, that.pathPrefix)
          && Objects.equal(this.sourceModuleNames, that.sourceModuleNames);
    }
    return false;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hashCode(pathPrefix, sourceModuleNames);
  }
