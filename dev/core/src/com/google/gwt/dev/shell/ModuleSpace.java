...
public abstract class ModuleSpace implements ShellJavaScriptHost {
  ...
  private void displayErrorGlassPanel(
    ...
    String stackTrace = Util.escapeXml(writer.toString()).replaceFirst(
        ...
        "(?ms)(Caused by:.+)", "<b>$1</b>");
    String details = "<p>Exception while loading module <b>" + Util.escapeXml(entryPointTypeName)
        + "</b>. See Development Mode for details.</p>"
        + "<div style='overflow:visisble;white-space:pre;'>" + stackTrace + "</div>";
