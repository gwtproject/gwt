...
public class SuperDevListener implements CodeServerListener {
  ...
  public SuperDevListener(TreeLogger treeLogger, HostedModeOptions options) {
    ...
    try {
      ...
      logger.log(TreeLogger.ERROR,
          "Unable to find main() method for Super Dev Mode code server. Hint: verify that gwt-codeserver.jar is in your classpath.");
      throw new RuntimeException(e);
  ...
  public void writeCompilerOutput(StandardLinkerContext linkerStack, ArtifactSet artifacts,
    ...
    try {
      ...
      File file = new File(options.getWarDir() + "/" + module.getName() + "/" + module.getName()
          + ".nocache.js");
      ...
      String recompileUrl = "http://" + options.getConnectAddress() + ":" + codeServerPort
          + "/recompile/" + module.getName() + "?user.agent=safari";
