...
import com.google.gwt.dev.cfg.SoftProps;
...
public class CollapsedPropertyKey extends StringKey {
   ...
   */
  private static String collapse(List<SoftProps> allProps) {
    ...
    for (SoftProps softProps : allProps) {
      BindingProperty[] props = softProps.getOrderedProps();
      String[] values = softProps.getOrderedPropValues();
   ...
   */
  public CollapsedPropertyKey(SoftProps props) {
