...
public class DiskCache {
  ...
  /**
   * Register a shutdown hook to close the RandomAccessFile associated to the temp file.<br>
   * There is a known <a href="https://bugs.java.com/bugdatabase/view_bug.do?bug_id=4171239"></a>bug</a>
