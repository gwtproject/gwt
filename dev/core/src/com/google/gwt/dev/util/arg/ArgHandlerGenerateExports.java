 ...
 */
public class ArgHandlerGenerateExports extends ArgHandlerFlag {
  private final OptionGenerateExports options;

  public ArgHandlerGenerateExports(OptionGenerateExports options) {
