...
public final class ArgHandlerIncrementalCompileWarnings extends ArgHandlerFlag {
  ...
  public <
      T extends OptionWarnOverlappingSource & OptionWarnMissingDeps & OptionStrictSourceResources &
                OptionStrict> ArgHandlerIncrementalCompileWarnings(
      T option) {
  ...
  public String getPurposeSnippet() {
    return "Whether to show warnings during monolithic compiles for issues that "
        ...
        + "directory inclusion, overlapping source inclusion, missing dependencies).";
  }
