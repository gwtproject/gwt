...
public class ArgHandlerNoopDeprecatedFlag extends ArgHandler {
  ...
  private final int numberOfArgumensToConsume;
  private String[] tags;

  public ArgHandlerNoopDeprecatedFlag(int numberOfArgumensToConsume, String... otherTags) {
    this.numberOfArgumensToConsume = numberOfArgumensToConsume;
    this.tags = otherTags;
  }
