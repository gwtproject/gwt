...
public final class Array {
  ...
  static native String addDimensions(String baseMap, int dimensions) /*-{
    var result = baseMap;
   ...
   * @param oneDimensionanlCastMap a partial castmap corresonding to one dimensional array of the
   *         leaf type.
   ...
   */
  public static Object initDim(Class<?> leafClassLiteral, JavaScriptObject oneDimensionanlCastMap,
    ...
    initValues(leafClassLiteral, oneDimensionanlCastMap, elementTypeId, elementTypeCategory,
        result, dimensions);
    return result;
  }
