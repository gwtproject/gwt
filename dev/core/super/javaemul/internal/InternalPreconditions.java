...
public final class InternalPreconditions {
  private static final boolean CHECKED_MODE =
      System.getProperty("goog.jre.checkedMode", "ENABLED").equals("ENABLED");
  private static final boolean TYPE_CHECK =
      System.getProperty("goog.jre.checks.type", "ENABLED").equals("ENABLED");
  private static final boolean API_CHECK =
      System.getProperty("goog.jre.checks.api", "ENABLED").equals("ENABLED");
  private static final boolean BOUND_CHECK =
      System.getProperty("goog.jre.checks.bounds", "ENABLED").equals("ENABLED");
