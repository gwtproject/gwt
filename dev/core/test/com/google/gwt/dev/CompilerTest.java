...
public class CompilerTest extends ArgProcessorTestBase {
  ...
  public void testIncrementalRecompile_devirtualizeString() throws UnableToCompleteException,
      IOException, InterruptedException {
    // Tests that a String calls through interfaces are correctly devirtualized when compiling per
    // file and neither String nor CharSequence interface are not stale.
