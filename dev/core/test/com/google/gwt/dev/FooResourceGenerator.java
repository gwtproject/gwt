...
public class FooResourceGenerator extends Generator {
  ...
  public String generate(TreeLogger logger, GeneratorContext context, String typeName)
    ...
    String generatedClassName =
        Util.readStreamAsString(Resource.toStreamOrNull(ResourceLocatorImpl.tryFindResourceUrl(
            logger, context.getResourcesOracle(), "com/foo/generatedClassName.txt"))).trim();
