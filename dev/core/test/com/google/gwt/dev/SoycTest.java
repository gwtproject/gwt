...
public class SoycTest extends TestCase {
  ...
  public void testSoyc() throws UnableToCompleteException, IOException {
    ...
    assertTrue(new File(options.getExtraDir() + "/hello/soycReport/compile-report/SoycDashboard-0-index.html").exists());
    assertTrue(new File(options.getExtraDir() + "/hello/soycReport/compile-report/total-0-overallBreakdown.html").exists());
