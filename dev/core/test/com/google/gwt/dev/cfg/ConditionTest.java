...
public class ConditionTest extends TestCase {
  ...
  public void testToSource() {
    ...
    // Exercise it all.
    assertEquals(
        "!((requestTypeName.equals(\"com.google.gwt.Foo\") && "
            + "BindingPropertiesProvider.getPropertyValue(\"user.agent\").equals(\"webkit\")) || "
            + "(Cast.canCastSeed(requestTypeName, \"com.google.gwt.HasFocus\") || "
            + "BindingPropertiesProvider.getPropertyValue(\"user.agent\").equals(\"ie9\")))",
        new ConditionNone(new ConditionAll(new ConditionWhenTypeIs("com.google.gwt.Foo"),
            new ConditionWhenPropertyIs("user.agent", "webkit")), new ConditionAny(
            new ConditionWhenTypeAssignableTo("com.google.gwt.HasFocus"),
