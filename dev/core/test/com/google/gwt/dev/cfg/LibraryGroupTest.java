...
public class LibraryGroupTest extends TestCase {
  ...
  public void testGetReboundTypeSourceNames() {
    ...
    for (Library library : libraries) {
      ...
      library.getRequestedReboundTypeSourceNames().add(reboundTypeSourceName);
      expectedReboundTypeSourceNames.add(reboundTypeSourceName);
    }

    // Show that the library group collects and returns them all.
    assertTrue(
        expectedReboundTypeSourceNames.equals(libraryGroup.getRequestedReboundTypeSourceNames()));
  }
  ...
  public static LibraryGroup buildVariedPropertyGeneratorLibraryGroup(
    ...
    subLibrary1.getRequestedReboundTypeSourceNames().addAll(reboundTypeSourceNamesOne);
    ...
    subLibrary2.getRequestedReboundTypeSourceNames().addAll(reboundTypeSourceNamesTwo);
