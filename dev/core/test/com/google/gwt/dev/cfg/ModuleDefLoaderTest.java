...
public class ModuleDefLoaderTest extends TestCase {
  ...
  private NullLibraryBuilder nullLibraryBuilder = new NullLibraryBuilder();
  private CompilerContext compilerContext =
      new CompilerContext.Builder().libraryBuilder(nullLibraryBuilder).build();
  ...
  public void testSeparateLibraryName() throws UnableToCompleteException {
    ...
    assertEquals("com.google.gwt.dev.cfg.testdata.separate.libraryone.LibraryOne",
        nullLibraryBuilder.getLibraryName());
  }
  ...
  public void testSeparateLibraryModuleReferences() throws UnableToCompleteException {
    ...
    // The library builder was given the module and it's direct fileset module xml files as build
    // resources.
    assertEquals(Sets.newHashSet(
        ...
        nullLibraryBuilder.getBuildResourcePaths());
    // The library builder was given LibraryTwo as a dependency library.
    assertEquals(Sets.newHashSet("com.google.gwt.dev.cfg.testdata.separate.librarytwo.LibraryTwo"),
        nullLibraryBuilder.getDependencyLibraryNames());
  }
