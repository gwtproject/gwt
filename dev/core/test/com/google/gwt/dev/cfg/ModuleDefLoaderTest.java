...
public class ModuleDefLoaderTest extends TestCase {
  ...
  /**
   * Test of that the tree representation for a module is correct.
   */
  public void testLibraryTree() throws Exception {
    ...
    assertTrue(six.getDirectDependents("com.google.gwt.dev.cfg.testdata.dependents.Six")
        .equals(ImmutableSet.of("com.google.gwt.dev.cfg.testdata.dependents.Five")));
    assertTrue("Contains " + six.getDirectDependents("com.google.gwt.dev.cfg.testdata.dependents.Five"),
        six.getDirectDependents("com.google.gwt.dev.cfg.testdata.dependents.Five")
