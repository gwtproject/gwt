...
public abstract class CheckerTestCase extends TestCase {
  ...
  protected Pass providePass() {
    return new Pass() {
      ...
      @Override
      public boolean run(TreeLogger logger, MockJavaResource buggyResource, MockJavaResource extraResource) {
        ...
        oracle = TypeOracleTestingUtils.buildStandardTypeOracleWith(logger,
  ...
  protected void shouldGenerate(MockJavaResource buggyCode, MockJavaResource extraCode,
    ...
    pass.run(logger, buggyCode, extraCode);
