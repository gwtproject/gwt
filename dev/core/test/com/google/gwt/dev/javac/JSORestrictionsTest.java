...
public class JSORestrictionsTest extends TestCase {
  ...
  public void testJsInterfacePrototypeExtensionNotAllowed() {
    ...
    buggyCode.append("import com.google.gwt.core.client.js.JsInterface;\n");
    buggyCode.append("public class Buggy {\n");
    buggyCode.append("@JsInterface interface Foo { static class Prototype implements Foo {} }\n");
    buggyCode.append("static class BuggyFoo extends Foo.Prototype {\n");
    buggyCode.append("}\n");
    buggyCode.append("}\n");
  ...
  public void testJsInterfacePrototypeExtensionNoError() {
    ...
    buggyCode.append("import com.google.gwt.core.client.js.JsInterface;\n");
    buggyCode.append("public class Buggy {\n");
    buggyCode.append("@JsInterface (prototype =\"foo\") interface Foo { static class Prototype implements Foo {} }\n");
    buggyCode.append("static class BuggyFoo extends Foo.Prototype {\n");
    buggyCode.append("}\n");
    buggyCode.append("}\n");
  ...
  public void testJsPropertyBadStyle() {
    ...
    shouldGenerateError(buggyCode, "Line 4: "
        + JSORestrictionsChecker.ERR_JSPROPERTY_ONLY_BEAN_OR_FLUENT_STYLE_NAMING);
  }
