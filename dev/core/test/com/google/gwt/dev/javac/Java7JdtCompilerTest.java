...
public class Java7JdtCompilerTest extends JdtCompilerTestBase {
  ...
  public void testJdtBugNameClash_3() throws Exception {
    ...
    assertOnlyLastUnitHasErrors(units, "Name clash: The method factoryMethod(List<P>) of type "
        + "X.Child<R> has the same erasure as factoryMethod(List<R>) of type X.Base<R> but does"
        + " not hide it");
  }
  ...
  protected List<CompilationUnit> invokeJdtCompiler(Collection<CompilationUnitBuilder> builders)
      throws UnableToCompleteException {
    return JdtCompiler.compile(TreeLogger.NULL, builders, SourceLevel.JAVA7);
  }
}
