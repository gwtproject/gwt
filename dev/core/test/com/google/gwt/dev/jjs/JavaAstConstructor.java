  ...
  public static final MockJavaResource ARRAY = new MockJavaResource("com.google.gwt.lang.Array") {
    ...
    public CharSequence getContent() {
      return Joiner.on("\n").join(
          ...
          "  static void initUnidimensionalArray(Class arrayClass, JavaScriptObject castableTypeMap,",
          "      int elementTypeId, int elementTypeCategory, int length) { }",
          "  static void initMultidimensionalArray(Class arrayClasses[], JavaScriptObject[] castableTypeMapExprs,",
