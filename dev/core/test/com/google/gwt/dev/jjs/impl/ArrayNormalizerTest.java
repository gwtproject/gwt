...
public class ArrayNormalizerTest extends OptimizerTestBase {
  ...
  public void testSetCheckElimination_finalTypeArray() throws Exception {
    ...
    result.intoString(
        "EntryPoint$A[] a = /*EntryPoint$A[]*/ Array.initUnidimensionalArray(EntryPoint$A.class, [], "
  ...
  public void testSetCheckPreservation_nonFinalTypeArray() throws Exception {
    ...
    result.intoString(
        "EntryPoint$A[] a = "
            + "/*EntryPoint$A[]*/ Array.initUnidimensionalArray(EntryPoint$A.class, [], "
            + "/* JRuntimeTypeReference */\"test.EntryPoint$A\", 1, 0, 1);",
        "a = /*EntryPoint$B[]*/ Array.initUnidimensionalArray(EntryPoint$B.class, [], "
  ...
  public void testObjectArray() throws Exception {
    optimize("void", "Object[] o = new Object[10];")
        .intoString("Object[] o = /*Object[]*/ Array.initUnidimensionalArray(Object.class, [], "
    ...
    optimize("void", "Object[] o = {null, null, Object.class};")
        .intoString("Object[] o = /*Object[]*/ Array.stampJavaTypeInfo("
    ...
    optimize("void", "Object[] o = new Object[] {};")
        .intoString("Object[] o = "
            + "/*Object[]*/ Array.stampJavaTypeInfo(Array.getClassLiteralForArray("
