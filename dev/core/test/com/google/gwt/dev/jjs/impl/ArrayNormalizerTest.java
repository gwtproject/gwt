...
public class ArrayNormalizerTest extends OptimizerTestBase {
  ...
  public void testSetCheckElimination_objectArray() throws Exception {
    addSnippetClassDecl("static class A { String name; public void set() { name = \"A\";} }");

    Result result =
        optimize("void", "Object[] o = new Object[1]; o[1] = new A();");
    result.intoString(
        "Object[] o = Array.initDim(" +
            "Object.class, , /* JRuntimeTypeReference */\"java.lang.Object\", 1, 3, 1);",
        "o[1] = new EntryPoint$A();");
  }
  ...
  public void testSetCheckElimination_exactTypeTightening() throws Exception {
    addSnippetClassDecl("static class A {String name; public void set() { name = \"A\";} }");
    addSnippetClassDecl("static class B extends A { }");

    Result result =
        optimize("void", "A[] a = null; a = new A[1]; a[1] = new B();");
    result.intoString(
        "EntryPoint$A[] a = null;",
        "a = Array.initDim(EntryPoint$A.class, , " +
            "/* JRuntimeTypeReference */\"test.EntryPoint$A\", 1, 0, 1);",
        "a[1] = new EntryPoint$B();");
  }
