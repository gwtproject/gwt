...
public class CompileTimeConstantsReplacerTest extends OptimizerTestBase {
  ...
  public void testReplacement_basic() throws Exception {
    addSnippetClassDecl(
        ...
        "  static { f3 = 3; }",
        "}");
    optimize("void", "int i = A.f1;").into("int i = 1;");
    optimize("void", "int i = A.f2;").into("int i = A.f2;");
    optimize("void", "int i = A.f3;").into("int i = A.f3;");
  }
  ...
  public void testReplacement_withAddition() throws Exception {
    addSnippetClassDecl(
        ...
        "  static { f3 = 3; }",
        "}");
    optimize("void", "int i = A.f1;").into("int i = 1 + 1;");
    optimize("void", "int i = B.f1;").into("int i = 1 + 1 + 1;");
  }
  ...
  public void testReplacement_withCoercion() throws Exception {
    addSnippetClassDecl(
        ...
        "  static { f3 = 3; }",
        "}");
    optimize("void", "double i = A.f1;").into("double i = (double) (1 + 1);");
    optimize("void", "double i = B.f1;").into("double i = 1 + (double) (1 + 1);");
  }
