...
public class DevirtualizerTest extends OptimizerTestBase {
  ...
  public void testDualJsoImpl() throws UnableToCompleteException {
    ...
    result.classHasMethodSnippets("EntryPoint$Jso1", Lists.newArrayList("test.EntryPoint$Jso1.a()I",
        "test.EntryPoint$Jso1.b()I", "test.EntryPoint$Jso1.$a(Ltest/EntryPoint$Jso1;)I",
        "test.EntryPoint$Jso1.$b(Ltest/EntryPoint$Jso1;)I"));
  }
