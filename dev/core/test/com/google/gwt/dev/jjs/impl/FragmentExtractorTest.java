...
public class FragmentExtractorTest extends JJSTestBase {
  ...
  private JsExprStmt createDefineSeedStatement(final JsName barConstructorName) {
    ...
    defineSeedInvocation.getArguments().add(new JsNameRef(null, barConstructorName));
    defineSeedInvocation.setQualifier(new JsNameRef(null, DEFINE_SEED_NAME));
    final JsExprStmt defineSeedStatement = new JsExprStmt(null, defineSeedInvocation);
