...
public class JChangeTrackingVisitorTest extends JJSTestBase {
  ...
  public void testAddParamWhenEnterMethodVisitor() throws Exception {
    ...
    assertParameterTypes(program, "test.EntryPoint$A.fun", "int");
    assertParameterTypes(program, "test.EntryPoint$A.EntryPoint$A", "int", "int");
  }
  ...
  public void testAddParamsWhenEnterAndExitMethodVisitor() throws Exception {
    ...
    assertParameterTypes(program, "test.EntryPoint$A.fun", "int", "int");
    assertParameterTypes(program, "test.EntryPoint$A.EntryPoint$A", "int", "int", "int");
  }
  ...
  public void testAddParamWhenEnterNonConstructorMethodVisitor() throws Exception {
    ...
    assertParameterTypes(program, "test.EntryPoint$A.fun", "int");
    assertParameterTypes(program, "test.EntryPoint$A.EntryPoint$A", "int");
  }
  ...
  public void testSetVariableOfIntToLongByEnterVisitor() throws Exception {
    ...
    assertParameterTypes(program, "test.EntryPoint$A.fun", "long");
  }
