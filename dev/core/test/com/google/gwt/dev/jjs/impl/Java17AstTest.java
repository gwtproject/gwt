...
public class Java17AstTest extends FullCompileTestBase {
  ...
  public void testInstanceOfPatternMatchingWithAnd() throws UnableToCompleteException {
    ...
    assertTrue(onModuleLoadMethod
        .toSource()
        .contains(
            "($instanceOfExpr_4 = shape1) instanceof Circle " +
                "&& null != (circle = (Circle) $instanceOfExpr_4)"));

    assertTrue(onModuleLoadMethod
        .toSource()
        .contains(
            "($instanceOfExpr_6 = shape2) instanceof Square " +
                "&& null != (square = (Square) $instanceOfExpr_6)"));
  }
  ...
  public void testInstanceOfPatternMatchingWithCondition() throws UnableToCompleteException {
    ...
    assertTrue(onModuleLoadMethod
        .toSource()
        .contains(
            "($instanceOfExpr_3 = shape2) instanceof Square " +
                "&& null != (square = (Square) $instanceOfExpr_3)"));
  }
  ...
  public void testInstanceOfPatternMatchingWithAsNotCondition() throws UnableToCompleteException {
    ...
    assertTrue(onModuleLoadMethod
        .toSource()
        .contains(
            "($instanceOfExpr_3 = shape1) instanceof Square " +
                "&& null != (square = (Square) $instanceOfExpr_3)"));
  }
  ...
  public void testMultipleInstanceOfPatternMatchingWithSameVariableName()
    ...
    assertTrue(onModuleLoadMethod
        .toSource()
        .contains(
            "($instanceOfExpr_4 = shape1) instanceof Square " +
                "&& null != (square = (Square) $instanceOfExpr_4)"));
  ...
  public void testInstanceOfPatternMatchingInLambda() throws UnableToCompleteException {
    ...
    assertTrue(lambda
        .toSource()
        .contains(
            "($instanceOfExpr_2 = this.shape) instanceof Square " +
                "&& null != (square = (Square) $instanceOfExpr_2)"));
  }
