...
public class Java8AstTest extends FullCompileTestBase {
  ...
  public void testIntersectionCastOfLambdaMultipleAbstractMethodsWithGenerics() throws Exception {
    addSnippetClassDecl("interface I1 { public void foo(String arg); }");
  ...
  public void testIntersectionCastOfMethodReference() throws Exception {
    ...
    assertEqualBlock("Object o=(EntryPoint$I2)(EntryPoint$I1)new EntryPoint$0methodref$go$Type();",
        methodReference);
  ...
  public void testMultipleIntersectionCastOfMethodReference() throws Exception {
    ...
    assertEqualBlock(
        "EntryPoint$I2 o=(EntryPoint$I3)(EntryPoint$I2)(EntryPoint$I1)new " +
            "EntryPoint$0methodref$go$Type();",
        methodReference);
  ...
  public void testIntersectionCastOfMethodReferenceMultipleAbstractMethodsWithGenerics() throws Exception {
    ...
    assertEqualBlock("Object o=(EntryPoint$I1)(EntryPoint$I2)new " +
            "EntryPoint$0methodref$go$Type();",
        methodReference);
  ...
  assertTrue(
    ...
    // should implement foo method
    JMethod samMethod = findMethod(lambdaInnerClass, "foo");
    assertEquals("public final void foo(String arg0){EntryPoint$C.go(arg0);}",
        formatSource(samMethod.toSource()));
  }
