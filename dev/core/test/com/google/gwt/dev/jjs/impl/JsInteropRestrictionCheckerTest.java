...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testCollidingAccidentalOverrideConcreteMethodFails() throws Exception {
    ...
    assertBuggyFails(
        "'test.EntryPoint$Buggy.doIt(Ltest/EntryPoint$Foo;)V' (synthetic override of "
            + "'test.EntryPoint$ParentBuggy.doIt(Ltest/EntryPoint$Foo;)V') can't be exported because the name "
            + "'doIt' is already taken by 'test.EntryPoint$Buggy.doIt(Ltest/EntryPoint$Bar;)V' "
            + "(synthetic override of 'test.EntryPoint$ParentBuggy.doIt(Ltest/EntryPoint$Bar;)V').");
  }
  ...
  public void testCollidingAccidentalOverrideHalfAndHalfFails() throws Exception {
    ...
    assertBuggyFails(
        "'test.EntryPoint$Buggy.doIt(Ltest/EntryPoint$Bar;)V (synthetic override of "
            + "'test.EntryPoint$ParentParent.doIt(Ltest/EntryPoint$Bar;)V') can't be exported because the "
            + "name 'doIt' is already taken by 'test.EntryPoint$Parent.doIt(Ltest/EntryPoint$Foo;)V'.");
  }
  ...
  public void testCollidingJsPropertiesTwoSettersFails() throws Exception {
    ...
    assertBuggyFails(
        ...
        "The setter and getter for JsProperty 'x' in type 'test.EntryPoint$Buggy' must have consistent types.");
  }
  ...
  public void tesNativeJsTypeStaticMethodOverloadSucceeds() throws UnableToCompleteException {
    addSnippetImport("jsinterop.annotations.JsType");
    addSnippetClassDecl(
        "@SuppressWarnings(\"unusable-by-js\")",
        "@JsType(isNative=true) public static class Buggy {",
  ...
  public void testNonJsTypeExtendingNativeJsTypeWithInstanceMethodOverloadsFails() {
    ...
    assertBuggyFails(
        "'test.EntryPoint$Buggy.m(Ljava/lang/Object;)V' can't be exported because the name 'm' is already taken by "
            + "'test.EntryPoint$Super.m([Ljava/lang/Object;)V'.");
  }
