...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testCollidingAccidentalOverrideConcreteMethodFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 13: 'void EntryPoint.ParentBuggy.doIt(EntryPoint.Foo)' "
            + "(exposed by 'EntryPoint.Buggy') cannot be exported because the name 'doIt' is "
            + "already taken by 'void EntryPoint.ParentBuggy.doIt(EntryPoint.Bar)' "
  ...
  public void testCollidingAccidentalOverrideAbstractMethodFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 13: 'void EntryPoint.Baz.doIt(EntryPoint.Foo)' cannot be exported because the "
            + "name 'doIt' is already taken by 'void EntryPoint.Baz.doIt(EntryPoint.Bar)'.");
  }
  ...
  public void testCollidingAccidentalOverrideHalfAndHalfFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 12: 'void EntryPoint.ParentParent.doIt(EntryPoint.Bar)' "
            + "(exposed by 'EntryPoint.Buggy') cannot be exported because the name 'doIt' is "
            + "already taken by 'void EntryPoint.Parent.doIt(EntryPoint.Foo)'.");
  }
  ...
  public void testCollidingJsTypeAndJsPropertyGetterFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: 'boolean EntryPoint.IBuggy.x(boolean)' cannot be exported because the name 'x' is "
            + "already taken by 'int EntryPoint.IBuggy.getX()'.",
        "Line 12: 'boolean EntryPoint.Buggy.x(boolean)' cannot be exported because the name 'x' is "
            + "already taken by 'int EntryPoint.Buggy.getX()'.");
  }
  ...
  public void testCollidingJsTypeAndJsPropertySetterFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: 'boolean EntryPoint.IBuggy.x(boolean)' cannot be exported because the name 'x' is a"
            + "lready taken by 'void EntryPoint.IBuggy.setX(int)'.",
        "Line 12: 'boolean EntryPoint.Buggy.x(boolean)' cannot be exported because the name 'x' is "
            + "already taken by 'void EntryPoint.Buggy.setX(int)'.");
  }
  ...
  public void testCollidingMethodToFieldJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: 'int EntryPoint.Buggy.show' cannot be exported because the name 'show' is already "
            + "taken by 'void EntryPoint.Buggy.show()'.");
  }
  ...
  public void testCollidingMethodToMethodJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 6: 'void EntryPoint.Buggy.show(int)' cannot be exported because the name 'show' is "
            + "already taken by 'void EntryPoint.Buggy.show()'.");
  }
  ...
  public void testCollidingSubclassFieldToFieldJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 10: 'int EntryPoint.Buggy.foo' cannot be exported because the name 'foo' is already "
            + "taken by 'int EntryPoint.ParentBuggy.foo'.");
  }
  ...
  public void testCollidingSubclassFieldToMethodJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 10: 'void EntryPoint.Buggy.foo(int)' cannot be exported because the name 'foo' is "
            + "already taken by 'int EntryPoint.ParentBuggy.foo'.");
  }
  ...
  public void testCollidingSubclassMethodToMethodInterfaceJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 16: 'void EntryPoint.Buggy2.show(boolean)' cannot be exported because the "
            + "name 'show' is already taken by 'void EntryPoint.Buggy.show()'.");
  }
  ...
  public void testCollidingSubclassMethodToMethodJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 10: 'void EntryPoint.Buggy.foo(int)' cannot be exported because the name 'foo' is "
            + "already taken by 'void EntryPoint.ParentBuggy.foo()'.");
  }
  ...
  public void testCollidingSubclassMethodToMethodTwoLayerInterfaceJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 20: 'void EntryPoint.Buggy2.show(boolean)' cannot be exported because the "
            + "name 'show' is already taken by 'void EntryPoint.Buggy.show()'.");
  }
  ...
  public void testCollidingSyntheticBridgeMethodFails() throws Exception {
    ...
    assertBuggyFails("Line 11: 'int EntryPoint.Enum.compareTo(EntryPoint.Enum)' cannot be exported "
        + "because the name 'compareTo' is already taken by "
        + "'int EntryPoint.Comparable.compareTo(Object)' (exposed by 'EntryPoint.Enum').");
  }
  ...
  public void testCollidingTwoLayerSubclassFieldToFieldJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 13: 'int EntryPoint.Buggy.foo' cannot be exported because the name 'foo' is already "
            + "taken by 'int EntryPoint.ParentParentBuggy.foo'.");
  }
  ...
  public void testRenamedSuperclassJsMethodFails() {
    ...
    assertBuggyFails("Line 10: 'void EntryPoint.Buggy.foo()' cannot be exported because the "
  ...
  public void testRenamedSuperInterfaceJsMethodFails() {
    ...
    assertBuggyFails("Line 10: 'void EntryPoint.Buggy.foo()' cannot be exported because the method "
  ...
  public void testNonJsTypeExtendingNativeJsTypeWithInstanceMethodOverloadsFails() {
    ...
    assertBuggyFails(
        "Line 10: 'void EntryPoint.Buggy.m(Object)' cannot be exported because the name 'm' is "
            + "already taken by 'void EntryPoint.Super.m(Object[])'.");
  }
  ...
  public void testNonJsTypeWithativeStaticMethodOverloadsFails() {
    ...
    assertBuggyFails(
        "Line 7: 'void EntryPoint.Buggy.m(Object[])' cannot be exported because the global "
  ...
  public void testNonJsTypeWithativeInstanceMethodOverloadsFails() {
    ...
    assertBuggyFails(
        "Line 6: 'void EntryPoint.Buggy.m(Object)' cannot be exported because the name 'm' is "
            + "already taken by 'void EntryPoint.Buggy.m(Object[])'.");
  }
