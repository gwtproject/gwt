...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testSpecializeReturnTypeInSubclassFails() {
    // TODO(rluble): this one should succeed.
    addSnippetImport("jsinterop.annotations.JsType");
    addSnippetClassDecl(
        "@JsType",
    ...
    assertBuggyFails("Line 10: 'EntryPoint.Buggy EntryPoint.Buggy.m()' and "
        + "'EntryPoint.S EntryPoint.S.m()' cannot both use the same JavaScript name 'm'.");
  }
