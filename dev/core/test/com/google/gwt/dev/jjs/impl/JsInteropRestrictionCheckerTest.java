...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testMultipleConstructorsNonJsSubtypeRestrictionFails() {
    ...
    assertBuggyFails(
        ...
        "Line 27: JsConstructor "
            + "'EntryPoint.OtherSubBuggyJsType.EntryPoint$OtherSubBuggyJsType(int)' can only "
            + "delegate to super constructor 'EntryPoint.BuggyJsType.EntryPoint$BuggyJsType()'.",
        "Line 29: More than one JsConstructor exists for 'EntryPoint.AnotherSubBuggyJsType'.",
        "Line 33: 'EntryPoint.AnotherSubBuggyJsType.EntryPoint$AnotherSubBuggyJsType(int)' cannot "
