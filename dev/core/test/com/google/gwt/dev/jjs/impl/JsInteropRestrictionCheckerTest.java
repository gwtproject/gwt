...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testNativeJsTypeBadMembersFails() {
    ...
    assertBuggyFails(
        ...
        "Line 24: Class 'EntryPoint.SomeClass2' can not implement interface 'EntryPoint.B' without "
            + "explicitly implementing 'int EntryPoint.B.hashCode()'. Subclasses of native JsTypes "
            + "cannot implement interfaces that declare equals, toString or hashCode through the "
            + "native supertype.",
