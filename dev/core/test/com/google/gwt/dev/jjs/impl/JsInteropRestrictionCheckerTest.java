...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testJsTypeInterfaceExtendsNonJsTypeInterfaceSucceeds() throws UnableToCompleteException {
    addSnippetImport("com.google.gwt.core.client.js.JsType");
    addSnippetClassDecl(
        "public interface Interface {",
        "}",
  ...
  public void testNonJsTypeInterfaceExtendsJsTypeInterfaceSucceeds() throws UnableToCompleteException {
    addSnippetImport("com.google.gwt.core.client.js.JsType");
    addSnippetClassDecl(
        "@JsType public interface Interface {",
        "}",
  ...
  public void testNativeJsTypeImplementsJsTypeFails() throws UnableToCompleteException {
    addSnippetImport("com.google.gwt.core.client.js.JsType");
    addSnippetClassDecl(
