...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testCollidingAccidentalOverrideConcreteMethodFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 13: 'test.EntryPoint$ParentBuggy.doIt(Ltest/EntryPoint$Foo;)V' (exposed by "
            + "'test.EntryPoint$Buggy') cannot be exported because the name 'doIt' is already taken "
  ...
  public void testCollidingAccidentalOverrideAbstractMethodFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 13: 'test.EntryPoint$Baz.doIt(Ltest/EntryPoint$Foo;)V' cannot be exported because "
            + "the name 'doIt' is already taken by "
  ...
  public void testCollidingAccidentalOverrideHalfAndHalfFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 12: 'test.EntryPoint$ParentParent.doIt(Ltest/EntryPoint$Bar;)V' (exposed by "
            + "'test.EntryPoint$Buggy') cannot be exported because the name 'doIt' is already "
            + "taken by 'test.EntryPoint$Parent.doIt(Ltest/EntryPoint$Foo;)V'.");
  }
  ...
  public void testCollidingFieldExportsFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 8: 'test.EntryPoint$Buggy.display' cannot be exported because the "
  ...
  public void testJsPropertyIncorrectGetterStyleFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: There cannot be non-boolean return for the JsProperty 'is' getter"
        ...
        "Line 10: There needs to be single parameter and void return type for the JsProperty setter"
            + " 'test.EntryPoint$Buggy.setX(II)V'.",
        "Line 11: There needs to be single parameter and void return type for the JsProperty setter"
            + " 'test.EntryPoint$Buggy.setY()V'.",
        "Line 12: There needs to be single parameter and void return type for the JsProperty setter"
            + " 'test.EntryPoint$Buggy.setZ(I)I'.",
        "Line 12: The setter and getter for JsProperty 'z' in type 'test.EntryPoint$Buggy' must "
  ...
  public void testJsPropertyNonGetterStyleFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: JsProperty 'test.EntryPoint$Buggy.hasX()Z' doesn't follow Java Bean naming "
            + "conventions.",
        "Line 8: JsProperty 'test.EntryPoint$Buggy.x()I' doesn't follow Java Bean naming "
            + "conventions.",
        "Line 9: JsProperty 'test.EntryPoint$Buggy.x(I)V' doesn't follow Java Bean naming "
            + "conventions.");
  }
  ...
  public void testCollidingJsPropertiesTwoGettersFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 8: There cannot be more than one getter for JsProperty 'x' in "
  ...
  public void testCollidingJsPropertiesTwoSettersFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 8: There cannot be more than one setter for JsProperty 'x' in "
            + "type 'test.EntryPoint$Buggy'.");
  }
  ...
  public void testCollidingJsTypeAndJsPropertyGetterFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: 'test.EntryPoint$IBuggy.x(Z)Z' cannot be exported because the name 'x' is "
            + "already taken by 'test.EntryPoint$IBuggy.getX()I'.",
        "Line 12: 'test.EntryPoint$Buggy.x(Z)Z' cannot be exported because the name 'x' is "
            + "already taken by 'test.EntryPoint$Buggy.getX()I'.");
  }
  ...
  public void testCollidingJsTypeAndJsPropertySetterFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: 'test.EntryPoint$IBuggy.x(Z)Z' cannot be exported because the name 'x' is already taken "
            + "by 'test.EntryPoint$IBuggy.setX(I)V'.",
        "Line 12: 'test.EntryPoint$Buggy.x(Z)Z' cannot be exported because the name 'x' is already taken "
            + "by 'test.EntryPoint$Buggy.setX(I)V'.");
  }
  ...
  public void testCollidingMethodExportsFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 8: 'test.EntryPoint$Buggy.display()V' cannot be exported "
  ...
  public void testCollidingMethodToFieldExportsFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: 'test.EntryPoint$Buggy.show()V' cannot be exported because the "
            + "global name 'test.EntryPoint.Buggy.show' is already taken.");
  }
  ...
  public void testCollidingMethodToFieldJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 7: 'test.EntryPoint$Buggy.show' cannot be exported because the name 'show' is "
            + "already taken by 'test.EntryPoint$Buggy.show()V'.");
  }
  ...
  public void testCollidingMethodToMethodJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 6: 'test.EntryPoint$Buggy.show(I)V' cannot be exported because the name 'show' is already "
  ...
  public void testCollidingSubclassFieldToFieldJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 10: 'test.EntryPoint$Buggy.foo' cannot be exported because the name 'foo' is already "
  ...
  public void testCollidingSubclassFieldToMethodJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 10: 'test.EntryPoint$Buggy.foo(I)V' cannot be exported because the name 'foo' is already "
            + "taken by 'test.EntryPoint$ParentBuggy.foo'.");
  }
  ...
  public void testCollidingSubclassMethodToMethodInterfaceJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 16: 'test.EntryPoint$Buggy2.show(Z)V' cannot be exported because the name 'show' is already "
            + "taken by 'test.EntryPoint$Buggy.show()V'.");
  }
  ...
  public void testCollidingSubclassMethodToMethodJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 10: 'test.EntryPoint$Buggy.foo(I)V' cannot be exported because the name 'foo' is "
            + "already taken by 'test.EntryPoint$ParentBuggy.foo()V'.");
  }
  ...
  public void testCollidingSubclassMethodToMethodTwoLayerInterfaceJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 20: 'test.EntryPoint$Buggy2.show(Z)V' cannot be exported because the name 'show' "
            + "is already taken by 'test.EntryPoint$Buggy.show()V'.");
  }
  ...
  public void testCollidingSyntheticBridgeMethodFails() throws Exception {
    addSnippetImport("jsinterop.annotations.JsType");
    addSnippetImport("jsinterop.annotations.JsProperty");
    addSnippetClassDecl(
        "@JsType",
    ...
    assertBuggyFails("Line 11: 'test.EntryPoint$Enum.compareTo(Ltest/EntryPoint$Enum;)I' cannot be "
        + "exported because the name 'compareTo' is already taken by "
        + "'test.EntryPoint$Comparable.compareTo(Ljava/lang/Object;)I' "
        + "(exposed by 'test.EntryPoint$Enum').");
  }
  ...
  public void testCollidingTwoLayerSubclassFieldToFieldJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 13: 'test.EntryPoint$Buggy.foo' cannot be exported because the name 'foo' is already "
  ...
  public void testRenamedSuperclassJsMethodFails() {
    ...
    assertBuggyFails("Line 10: 'test.EntryPoint$Buggy.foo()V' cannot be exported because the "
        + "method overrides a method with different name.");
  }
  ...
  public void testAccidentallyRenamedSuperInterfaceJsMethodFails() {
    ...
    assertBuggyFails("Line 11: 'test.EntryPoint$ParentBuggy.foo()V' (exposed by 'test.EntryPoint$Buggy') "
        + "cannot be exported because the method overrides a method with different name.");
  }
  ...
  public void __disabled__testRenamedSuperclassJsPropertyFails() {
    ...
    assertBuggyFails("'test.EntryPoint$Buggy.getFoo()I' cannot be exported because the method "
  ...
  public void testJsPropertyDifferentFlavourInSubclassFails() {
    ...
    assertBuggyFails("Line 10: There cannot be more than one getter for JsProperty 'foo' in type "
  ...
  public void testInconsistentGetSetPropertyTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 10: The setter and getter for JsProperty 'foo' in type 'test.EntryPoint$IBuggy' "
            + "must have consistent types.",
        "Line 14: The setter and getter for JsProperty 'foo' in type 'test.EntryPoint$Buggy' "
            + "must have consistent types.");
  }
  ...
  public void testJsPropertySuperCallFails()
    ...
    assertBuggyFails(
        "Line 9: Cannot call property accessor 'test.EntryPoint$Super.getX()I' via super.");
  }
  ...
  public void testMultipleConstructorsNotAllDelegatedToJsConstructorFails()
    ...
    assertBuggyFails(
        "Line 6: Constructor 'test.EntryPoint$Buggy.EntryPoint$Buggy() <init>' can be a "
            + "JsConstructor only if all constructors in the class are delegating to it.");
  }
  ...
  public void testMultiplePublicConstructorsExportFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 5: More than one JsConstructor exists for test.EntryPoint$Buggy.",
        "Line 7: 'test.EntryPoint$Buggy.EntryPoint$Buggy(I) <init>' cannot be "
  ...
  public void testJsFunctionExtendsInterfaceFails() throws Exception {
    ...
    assertBuggyFails("Line 6: JsFunction 'test.EntryPoint$Buggy' cannot extend other interfaces.");
  }
  ...
  public void testJsFunctionExtendedByInterfaceFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 3: 'test.EntryPoint$Buggy' cannot extend JsFunction 'test.MyJsFunctionInterface'.");
  }
  ...
  public void testJsFunctionMarkedAsJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 6: 'test.EntryPoint$Buggy' cannot be both a JsFunction and a JsType at the "
            + "same time.");
  }
  ...
  public void testJsFunctionImplementationWithMultipleSuperInterfacesFails() throws Exception {
    ...
    assertBuggyFails("Line 4: JsFunction implementation 'test.EntryPoint$Buggy' cannot "
  ...
  public void testJsFunctionImplementationWithSubclassesFails() throws Exception {
    ...
    assertBuggyFails("Line 6: 'test.EntryPoint$Buggy' cannot extend "
        + "JsFunction 'test.EntryPoint$BaseClass'.");
  }
  ...
  public void testJsFunctionImplementationMarkedAsJsTypeFails() throws Exception {
    ...
    assertBuggyFails(
        "Line 5: 'test.EntryPoint$Buggy' cannot be both a JsFunction implementation and a JsType "
            + "at the same time.");
  }
  ...
  public void testJsFunctionStaticInitializerFails() {
    ...
    assertBuggyFails(
        "Line 6: JsFunction 'test.EntryPoint$Buggy' cannot have static initializer.");
  }
  ...
  public void testNativeJsTypeStaticInitializerFails() {
    ...
    assertBuggyFails(
        "Line 4: Native JsType 'test.EntryPoint$Buggy' cannot have static initializer.");
  }
  ...
  public void testNativeJsTypeNonEmptyConstructorFails() {
    ...
    assertBuggyFails(
        "Line 5: Native JsType constructor 'test.EntryPoint$Buggy.EntryPoint$Buggy(I) <init>' "
  ...
  public void testNativeJsTypeInstanceInitializerFails() {
    ...
    assertBuggyFails(
        "Line 6: Native JsType constructor 'test.EntryPoint$Buggy.EntryPoint$Buggy(I) <init>' "
            + "cannot have non-empty method body.");
  }
  ...
  public void testJsTypeInterfaceInInstanceofFails() throws Exception {
    ...
    assertBuggyFails("Line 4: Cannot do instanceof against native JsType interface "
  ...
  public void testNativeJsTypeEnumFails() {
    ...
    assertBuggyFails(
        "Line 4: Enum 'test.EntryPoint$Buggy' cannot be a native JsType.");
  }
  ...
  public void testJsOverlayOnStaticFails() {
    ...
    assertBuggyFails("Line 6: JsOverlay method 'test.EntryPoint$Buggy.m()V' cannot be "
  ...
  public void testJsOverlayImplementingInterfaceMethodFails() {
    ...
    assertBuggyFails("Line 9: JsOverlay method 'test.EntryPoint$Buggy.m()V' cannot override a "
        + "supertype method.");
  }
  ...
  public void testJsOverlayOverridingSuperclassMethodFails() {
    ...
    assertBuggyFails(
        "Line 9: JsOverlay method 'test.EntryPoint$Buggy.m()V' cannot override a supertype method.");
  }
  ...
  public void testJsOverlayOnNonFinalFails() {
    ...
    assertBuggyFails(
        "Line 6: JsOverlay method 'test.EntryPoint$Buggy.m()V' cannot be non-final, static, nor native.");
  }
  ...
  public void testJsOverlayOnNonNativeJsTypeFails() {
    ...
    assertBuggyFails(
        "Line 6: Method 'test.EntryPoint$Buggy.m()V' in non-native type cannot be @JsOverlay.");
  }
  ...
  public void testJsOverlayOnNonJsTypeFails() {
    ...
    assertBuggyFails(
        "Line 5: Method 'test.EntryPoint$Buggy.m()V' in non-native type cannot be @JsOverlay.");
  }
  ...
  public void testNativeJsTypeNonPublicFieldFails() {
    ...
    assertBuggyFails(
        "Line 5: Native JsType member 'test.EntryPoint$Buggy.f' is not public or has @JsIgnore.");
  }
  ...
  public void testNativeJsTypeJsIgnoredFieldFails() {
    ...
    assertBuggyFails(
        "Line 6: Native JsType member 'test.EntryPoint$Buggy.x' is not public or has @JsIgnore.");
  }
  ...
  public void testNativeJsTypeNonPublicMethodFails() {
    ...
    assertBuggyFails(
        "Line 5: Native JsType member 'test.EntryPoint$Buggy.m()V' is not public or has @JsIgnore.");
  }
  ...
  public void testNativeJsTypeJsIgnoredMethodFails() {
    ...
    assertBuggyFails(
        "Line 6: Native JsType member 'test.EntryPoint$Buggy.m()V' is not public or has @JsIgnore.");
  }
  ...
  public void testNativeJsTypeJsIgnoredConstructorFails() {
    ...
    assertBuggyFails(
        "Line 6: Native JsType member 'test.EntryPoint$Buggy.EntryPoint$Buggy() <init>' "
  ...
  public void testNonJsTypeExtendingNativeJsTypeWithInstanceMethodOverloadsFails() {
    ...
    assertBuggyFails(
        "Line 10: 'test.EntryPoint$Buggy.m(Ljava/lang/Object;)V' cannot be exported because "
            + "the name 'm' is already taken by 'test.EntryPoint$Super.m([Ljava/lang/Object;)V'.");
  }
  ...
  public void testNonJsTypeWithativeStaticMethodOverloadsFails() {
    ...
    assertBuggyFails(
        "Line 7: 'test.EntryPoint$Buggy.m([Ljava/lang/Object;)V' cannot be exported because "
            + "the global name 'test.EntryPoint.Buggy.m' is already taken.");
  }
  ...
  public void testNonJsTypeWithativeInstanceMethodOverloadsFails() {
    ...
    assertBuggyFails(
        "Line 6: 'test.EntryPoint$Buggy.m(Ljava/lang/Object;)V' cannot be exported because the name "
            + "'m' is already taken by 'test.EntryPoint$Buggy.m([Ljava/lang/Object;)V'.");
  }
  ...
  public void testUnusuableByJsSucceedsWithWarnings() throws Exception {
    ...
    assertBuggySucceeds(
        "Line 21: [unusable-by-js] Return type of "
        ...
        "Line 22: [unusable-by-js] Return type of "
            ...
            + "is not usable by but exposed to JavaScript.",
        "Line 23: [unusable-by-js] Return type of "
            + "'test.EntryPoint$Buggy.f3(J)J' is not usable by but exposed to JavaScript.",
        "Line 24: [unusable-by-js] Return type of "
            + "'test.EntryPoint$Buggy.f4(Ltest/EntryPoint$B;)Ltest/EntryPoint$B;' "
            + "is not usable by but exposed to JavaScript.",
        "Line 20: [unusable-by-js] Type of field 'field' in type 'test.EntryPoint$Buggy' "
            + "is not usable by but exposed to JavaScript.",
        ...
        "Line 22: [unusable-by-js] Type of parameter 'a' in method "
            + "'test.EntryPoint$Buggy.f2([Ltest/EntryPoint$A;)[Ltest/EntryPoint$A;' "
            + "is not usable by but exposed to JavaScript.",
        "Line 23: [unusable-by-js] Type of parameter 'a' in method 'test.EntryPoint$Buggy.f3(J)J' "
            + "is not usable by but exposed to JavaScript.",
        ...
        "Line 26: [unusable-by-js] Type of parameter 'a' in method "
            ...
            + "is not usable by but exposed to JavaScript.",
        "Line 18: [unusable-by-js] Type of parameter 'a' in method " // JsFunction method
