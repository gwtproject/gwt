...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testJsNameInvalidNamesFails() {
    ...
    assertBuggyFails(
        ...
        "Line 17: name '*' can only be used for native interfaces with global namespace.",
        "Line 19: name '?' can only be used for native interfaces with global namespace.",
        "Line 21: name '*' can only be used for native interfaces with global namespace."
        );
  }
