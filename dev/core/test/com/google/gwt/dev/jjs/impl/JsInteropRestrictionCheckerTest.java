...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testJsOverlayOnJsMethodFails() {
    addSnippetImport("jsinterop.annotations.JsType");
    addSnippetImport("jsinterop.annotations.JsOverlay");
    addSnippetImport("jsinterop.annotations.JsMethod");
    addSnippetClassDecl(
    ...
    assertBuggyFails("Line 8: JsOverlay method 'void EntryPoint.Buggy.m()' cannot be JsMethod, "
        + "JsProperty nor JsConstructor.");
  }
