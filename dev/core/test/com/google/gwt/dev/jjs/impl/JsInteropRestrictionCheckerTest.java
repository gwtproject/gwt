...
public class JsInteropRestrictionCheckerTest extends OptimizerTestBase {
  ...
  public void testNativeJsTypeBadMembersFails() {
    ...
    assertBuggyFails(
        ...
        "Line 25: Method 'int EntryPoint.SomeClass2.hashCode()' in a native JsType subclass"
            + " can not implement method 'int EntryPoint.B.hashCode()' because it is not a JsMethod.",
        "Line 28: 'int EntryPoint.NativeTypeWithHashCode.hashCode()' "
            + "(exposed by 'EntryPoint.SomeClass3') cannot be assigned a different JavaScript name"
            + " than the method it overrides.",
        "Line 28: Cannot use super to call 'EntryPoint.NativeTypeWithHashCode.hashCode'. "
