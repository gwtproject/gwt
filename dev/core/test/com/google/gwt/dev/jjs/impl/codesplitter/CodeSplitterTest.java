...
public class CodeSplitterTest extends JJSTestBase {
  ...
  private void addMockIntrinsic() {
    ...
    sourceOracle.addOrReplace(new MockJavaResource("com.google.gwt.lang.MetadataUtil") {
      @Override
      public CharSequence getContent() {
        return "package com.google.gwt.lang; public class MetadataUtil {" +
               "public static Object defineClass(int id, int superTypeId, Object map)" +
               "{return null;}}";
      }
    });
