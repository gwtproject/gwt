...
public class JsDuplicateFunctionRemoverTest extends OptimizerTestBase {
  ...
  static private class LocalFreshNameGenerator implements JsFreshNameGenerator {
  ...
  static private class JsDuplicateFunctionRemoverProxy {
    static public void exec(JsProgram program) {
      JsDuplicateFunctionRemover.exec(program, new LocalFreshNameGenerator());
    }
  }
  ...
  public void testVirtualRemoveDuplicates() throws Exception {
    ...
    String firstName = new LocalFreshNameGenerator().getFreshName();
  ...
  public void testCodeSplittingError() throws Exception {
    ...
    LocalFreshNameGenerator tempFreshNameGenerator = new LocalFreshNameGenerator();
