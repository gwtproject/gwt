...
/**
 * Tests the JsDuplicateFunctionRemover optimizer.
 */
public class JsDuplicateFunctionRemoverTest extends OptimizerTestBase {

  static private class LocalNamer implements JsFreshNameGenerator {
  ...
  static private class JsDuplicateFunctionRemoverProxy {
    static public void exec(JsProgram program) {
      JsDuplicateFunctionRemover.exec(program, new LocalNamer());
    }
  }
  ...
  public void testVirtualRemoveDuplicates() throws Exception {
    ...
    String firstName = new LocalNamer().getFreshName();
  ...
  /**
   * Test for the first of the bugs causing issue 8284. JsObfuscateNamer was used to assign
  ...
  public void testRerunNamerError() throws Exception {
    ...
    // If _.c and _.b are collapsed the top scope name "a" and the one in f2() need to remain the
    // same.
  ...
  /**
   * Test for the second of the bugs causing issue 8284. JsObfuscateNamer was used to assign
   * obfuscated names to deduped functions and as a result it might have modified the other names
   * that had been assigned invalidating the irrevocable decision made by the deduper.
   */
  public void testCodeSplittingError() throws Exception {
    JsProgram program = new JsProgram();
    ...
    LocalNamer tempNamer = new LocalNamer();
    String firstName = tempNamer.getFreshName();
    String secondName = tempNamer.getFreshName();
