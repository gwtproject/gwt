...
public class JsLiteralInternerTest extends TestCase {
  ...
  private static final String ONES = "111111111111";
  private static final String TWOS = "222222222222";
  private static final String THREES = "333333333333";

  private static final String AS_STRING = "'aaaaaaaaaaaa'";
  private static final String BS_STRING = "'bbbbbbbbbbbb'";
  private static final String CS_STRING = "'cccccccccccc'";

  private static final String AS_REGEX = "/aaaaaaaaaaaa/";
  private static final String BS_REGEX = "/bbbbbbbbbbbb/";
  private static final String CS_REGEX = "/cccccccccccc/";
  ...
  public void testProfitability() throws Exception {
    ...
    checkTranslation(
        String.format("var x = %1$s, y = %1$s, z = %1$s, z = %1$s, z = %1$s, z = %1$s;",
            SMALL_BUT_INTERNABLE),
        String.format("var x=%1$s,y=%1$s,z=%1$s,z=%1$s,z=%1$s,z=%1$s;", SMALL_BUT_INTERNABLE));
  }
