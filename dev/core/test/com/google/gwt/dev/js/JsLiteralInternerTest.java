...
public class JsLiteralInternerTest extends TestCase {
  ...
  public void testSimpleIntern() throws Exception {
    ...
    // Objects
    checkTranslation("var x = {a:12, b:14}, y = {a:12, b: 14}, z = {a:11, b:13};",
        "var $intern_0={a:12,b:14};var x=$intern_0,y=$intern_0,z={a:11,b:13};");
  ...
  public void testDoNotInternEmptyObjects() throws Exception {
  ...
  private void checkTranslation(String source, String expectedJs, boolean internObjectLiterals)
      throws IOException, JsParserException {
    JsProgram program = parseJs(source);
    // Mark all object literals as internable
    if (internObjectLiterals) {
      new JsModVisitor() {
        @Override
