...
public class JsSourceUtilsTest extends OptimizerTestBase {
  ...
  public void testMatchString() {
    Pattern stringPattern = Pattern.compile(JsSourceUtils.JS_STRING_PATTERN);
  ...
  public void testMatchJsRegExp() {
    Pattern jsRegExpPattern = Pattern.compile(JsSourceUtils.JS_REG_EXP_PATTERN);
  ...
  public void testBlockComments() {
    Pattern blockCommentPattern = Pattern.compile(JsSourceUtils.BLOCK_COMMENT_PATTERN);
  ...
  private static  void assertOneLinerCorrect(String expected, String actual) {
    String oneLineSnippet = JsSourceUtils.condenseIntoOneLine(actual);
