 ...
 */
public class PropertyPermutationSetsTest extends TestCase {
  ...
  public void testCycle() {
    ...
    try {
      new PropertyPermutationSets(properties, md.getActiveLinkerNames());
      fail();
  ...
  public void testOneDimensionPerm() {
    ...
    //
    PropertyPermutationSets permutations = new PropertyPermutationSets(md.getProperties(),
  ...
  public void testOneDimensionPermWithCollapse() {
    ...
    List<PropertyPermutationSets> collapsed = permutations.collapseProperties();
  ...
  private void validateTwoDimensionPerm(Properties props, Set<String> activeLinkerNames) {
    PropertyPermutationSets permutations = new PropertyPermutationSets(props, activeLinkerNames);
