...
public class MapFromStringTests extends GWTTestCase {
  ...
  static void assertMapSamelitude(String[] keys, Object[] values, MapFromStringTo map) {
  ...
  static void assertMapSamelitude(String[] keys, double[] values, MapFromStringToNumber map) {
  ...
  static void assertMapSamelitude(String[] keys, int[] values, MapFromStringToInt map) {
  ...
  static void assertMapSamelitude(String[] keys, String[] values, MapFromStringToString map) {
  ...
  static void assertMapSamelitude(String[] keys, boolean[] values, MapFromStringToBoolean map) {
