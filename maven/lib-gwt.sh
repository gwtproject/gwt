  ...
  do
    ...
    if [[ "$i" == "user" ]]; then
      ...
      do
        ...
        find "./jsinterop/${i}" -not -name "*.java" > jsinterop-${i}-classfilelist
        if [ -s jsinterop-${i}-classfilelist ]; then
          ...
          echo jsinterop-${i}-classfilelist | zip -d $CUR_FILE -@

          jar cf jsinterop-${i}.jar @jsinterop-${i}-classfilelist
        fi
        find "./jsinterop/${i}" -name "*.java" > jsinterop-${i}-javafilelist
        if [ -s jsinterop-${i}-javafilelist ]; then
          echo "Removing jsinterop/${i} from gwt-user-sources"
          echo jsinterop-${i}-javafilelist | zip -d $SOURCES_FILE -@
