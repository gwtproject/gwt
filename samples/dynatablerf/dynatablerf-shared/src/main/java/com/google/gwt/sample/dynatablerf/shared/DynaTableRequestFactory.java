...
public interface DynaTableRequestFactory extends RequestFactory {
   ...
   */
  @ServiceName("com.google.gwt.sample.dynatablerf.domain.Person")
   ...
   */
  @ServiceName("com.google.gwt.sample.dynatablerf.server.SchoolCalendarService")
   ...
   */
  @ServiceName(value = "com.google.gwt.sample.dynatablerf.server.ScheduleService",
      locator = "com.google.gwt.sample.dynatablerf.server.ScheduleServiceLocator")
