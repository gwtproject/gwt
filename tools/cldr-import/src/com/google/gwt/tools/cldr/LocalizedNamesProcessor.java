...
public class LocalizedNamesProcessor extends Processor {
  ...
  protected void cleanupData() {
    localeData.copyLocaleData("en", "default", CATEGORY_TERRITORY, "languages", "scripts", "variants");
  ...
  protected void loadData() throws IOException {
    ...
    localeData.addEntries(CATEGORY_LOCALE_PATTERN, cldrFactory,
        "//ldml/localeDisplayNames/localeDisplayPattern", CATEGORY_LOCALE_PATTERN, null);
    localeData.addEntries(CATEGORY_LOCALE_SEPARATOR, cldrFactory,
        "//ldml/localeDisplayNames/localeDisplayPattern", CATEGORY_LOCALE_SEPARATOR, null);
    localeData.addEntries(CATEGORY_TERRITORY, cldrFactory, "//ldml/localeDisplayNames/territories",
        CATEGORY_TERRITORY, "type");
    localeData.addEntries(CATEGORY_LANGUAGE, cldrFactory, "//ldml/localeDisplayNames/languages",
        CATEGORY_LANGUAGE, "type");
    localeData.addEntries(CATEGORY_SCRIPT, cldrFactory, "//ldml/localeDisplayNames/scripts", CATEGORY_SCRIPT,
        "type");
    localeData.addEntries(CATEGORY_VARIANT, cldrFactory, "//ldml/localeDisplayNames/variants", CATEGORY_VARIANT,
        "type");
  }
