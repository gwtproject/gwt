...
public final class Impl {
  ...
  public static native void registerWindowOnError(boolean reportAlways) /*-{
    ...
    var frameHandler = function() {
      ...
      if (origFrameHandler) {
        origFrameHandler.apply(this, arguments);
      }
      return false;
    };
    ...
    var windowHandler = function() {
      ...
      if (origWindowHandler) {
        origWindowHandler.apply(this, arguments);
      }
      return false;
    };
    ...
    if (!origFrameHandler || reportAlways) {
      window.onerror = frameHandler;
    }
    if (!origWindowHandler || reportAlways) {
