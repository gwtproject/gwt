 ...
 *
 * Any class, method or field with an annotation @GwtIncompatible is ignored by the compiler.
 *
 * e.g.
 * {@code
 * class A {
...
public @interface GwtIncompatible {
  /**
   * Some attribute fields useful for documentation purposes. Form the compiler perspective
