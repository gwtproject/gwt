...
public final class SerializableThrowable extends Throwable {
  ...
  /**
   * Set the original throwable that this serializable throwable is derived from. Note that,
  ...
  /**
   * Returns the original throwable that this serializable throwable is derived from. Note that,
   * original throwable is kept in a transient field; that is; it will not be transferred to server
