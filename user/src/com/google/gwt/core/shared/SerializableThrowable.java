...
/**
 * A serializable copy of {@link Throwable}, including its causes and stack trace.
 * It overrides {@code #toString} to mimic original {@link Throwable#toString()} so
...
public final class SerializableThrowable extends Throwable {
  ...
  /**
   * Create a new {@link SerializableThrowable} from provided throwable and its causes recursively.
   *
  ...
  public String toString() {
    String type = exactTypeKnown ? typeName : (typeName + "(EXACTTYPEUNKNOWN)");
