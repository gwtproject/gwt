...
abstract class DOMImpl {
   ...
   * In particular, if x is outside the range [-2^31,2^31), then fastRound(x) would return a value
   * equivalent to x module 2^32, whereas (int) x would evaluate to either MIN_INT or MAX_INT
   */
