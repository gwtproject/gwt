...
abstract class DOMImpl {
   ...
   * 
   * <p>
   * Note: you should be aware that this uses JavaScript rounding (or flooring more specifically)
   * and thus does NOT provide the same semantics as <code>int b = (int) someDouble;</code>. In
   * particular, if x is outside the range [-2^31,2^31), then toInt32(x) would return a value
