...
public class Request {
   ...
   */
  protected Request(XMLHttpRequest xmlHttpRequest, int timeoutMillis, RequestCallback callback) {
   ...
   * reaches 4 (LOADED).
   */
  protected final void fireOnResponseReceived(RequestCallback callback) {
    if (xmlHttpRequest == null) {
