...
class MessagesImplCreator extends AbstractLocalizableImplCreator {
   ...
   * @param oracle types
   * @param context in which to locate resources
   *
   * @throws UnableToCompleteException
   */
  public MessagesImplCreator(TreeLogger logger, SourceWriter writer, JClassType localizableClass,
      ResourceList resourceList, TypeOracle oracle, GeneratorContext context)
      throws UnableToCompleteException {
    super(logger, writer, localizableClass, resourceList, false);
    try {
      MessagesMethodCreator creator = new MessagesMethodCreator(this, writer, context);
