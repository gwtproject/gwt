...
import com.google.gwt.i18n.shared.impl.DateTimeFormatImpl;
...
public interface LocaleInfo extends Localizable {
  ...
  /**
   * Returns a factory for creating {@link DateTimeFormatImpl} instances.  This is
   ...
   * 
   * @param forceLatingDigits true if latin digits should be used for number
