...
/**
 *  * Pure Java implementation of CurrencyList for locale "af".
 */
public class CurrencyListImpl_af extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ZAR", "R", 2, "ZAR", "R");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("ZAR", new CurrencyDataImpl("ZAR", "R", 2, "ZAR", "R"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("KMF", "Comoriese frank");
    ...
    result.put("MRO", "Mauritaniese ouguiya");
    ...
    result.put("PEN", "Peruaanse nuwe sol");
    result.put("PGK", "Papoease kina");
    ...
    result.put("SBD", "Salomons-eilande dollar");
    ...
    result.put("ZMK", "Zambiese kwacha");
