...
/**
 * Pure Java implementation of CurrencyList for locale "agq".
 */
public class CurrencyListImpl_agq extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("EUR", "Yulù");
    result.put("GBP", "Bɔ̀ŋ Sɨ̀telè è Bèletì");
    ...
    result.put("MRO", "Ùgueya è Mùlètenyìa");
    ...
    result.put("STD", "Dɔbàlà è Sàwu Tɔ̀me à Pèlènsipè");
    ...
    result.put("ZMK", "Kwachà è Zambìa");
