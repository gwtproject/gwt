...
/**
 * Pure Java implementation of CurrencyList for locale "ak".
 */
public class CurrencyListImpl_ak extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Mɔretenia Ouguiya");
    ...
    result.put("STD", "Sao Tome ne Principe Dobra");
