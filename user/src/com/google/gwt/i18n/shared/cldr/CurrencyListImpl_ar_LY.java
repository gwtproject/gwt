...
/**
 *  * Pure Java implementation of CurrencyList for locale "ar_LY".
 */
public class CurrencyListImpl_ar_LY extends CurrencyListImpl_ar {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("LYD", "د.ل.‏", 3, "د.ل.‏", "din");
  }
