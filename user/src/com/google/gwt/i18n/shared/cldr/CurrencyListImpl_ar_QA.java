...
/**
 *  * Pure Java implementation of CurrencyList for locale "ar_QA".
 */
public class CurrencyListImpl_ar_QA extends CurrencyListImpl_ar {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("QAR", "ر.ق.‏", 2, "ر.ق.‏", "Rial");
  }
