...
/**
 * Pure Java implementation of CurrencyList for locale "ar_SY".
 */
public class CurrencyListImpl_ar_SY extends CurrencyListImpl_ar {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("SYP", "ل.س.‏", 0, "ل.س.‏", "£");
  }
