...
/**
 *  * Pure Java implementation of CurrencyList for locale "asa".
 */
public class CurrencyListImpl_asa extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("STD", "dobra ya Thao Tome na Principe");
    ...
    result.put("ZMK", "kwacha ya Dhambia");
