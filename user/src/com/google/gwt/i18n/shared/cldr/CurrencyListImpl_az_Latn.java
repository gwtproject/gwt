...
/**
 * Pure Java implementation of CurrencyList for locale "az_Latn".
 */
public class CurrencyListImpl_az_Latn extends CurrencyListImpl_az {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("AZN", "man.", 2, "man.", "man.");
  }
