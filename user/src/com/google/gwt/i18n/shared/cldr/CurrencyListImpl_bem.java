...
/**
 * Pure Java implementation of CurrencyList for locale "bem".
 */
public class CurrencyListImpl_bem extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ZMK", "ZK", 0, "ZK", "ZWK");
  }

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("ZMK", new CurrencyDataImpl("ZMK", "ZK", 0, "ZK", "ZWK"));
    return result;
  }
