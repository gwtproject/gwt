...
/**
 *  * Pure Java implementation of CurrencyList for locale "bez".
 */
public class CurrencyListImpl_bez extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Lupila lwa Humolitania");
    ...
    result.put("STD", "Lupila lwa Husaotome na Huprinisipe");
    ...
    result.put("ZMK", "Lupila lwa Huzambia");
