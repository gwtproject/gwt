...
/**
 * Pure Java implementation of CurrencyList for locale "bg".
 */
public class CurrencyListImpl_bg extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("BGN", "лв.", 2, "лв.", "lev");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("BGN", new CurrencyDataImpl("BGN", "лв.", 2, "лв.", "lev"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AED", "Обединени арабски емирства-дирхам");
    ...
    result.put("AOA", "Анголска кванца");
    ...
    result.put("AWG", "Арубски гилдер - о. Аруба");
    ...
    result.put("BBD", "Барбейдоски долар");
    ...
    result.put("BWP", "Ботсуанска пула");
    result.put("BYB", "Беларуска нова рубла (1994-1999)");
    result.put("BYR", "Беларуска рубла");
    ...
    result.put("CNY", "Китайски ренминби юан");
    ...
    result.put("CVE", "Кабо Верде ескудо");
    ...
    result.put("FJD", "Фиджи - долар");
    result.put("FKP", "Фолкландска лира");
    ...
    result.put("GMD", "Гамбийски даласи");
    ...
    result.put("KRW", "КНДР вон");
    result.put("KWD", "Кувейтски динар");
    result.put("KYD", "Кайманови острови - долар");
    ...
    result.put("MXN", "Мексиканско ново песо");
    ...
    result.put("MZM", "Мозамбикски метикал");
    result.put("MZN", "Мозамбишки метикал");
    result.put("NAD", "Намибийски долар");
    result.put("NGN", "Нигерийска найра");
    result.put("NIC", "Никарагуанска кордоба");
    result.put("NIO", "Никарагуанска златна кордоба");
    ...
    result.put("PAB", "Панамски балбоа");
    ...
    result.put("SBD", "Соломонови острови - долар");
    ...
    result.put("SHP", "Света Елена лира");
    ...
    result.put("STD", "Сао Томе и Принсипи - добра");
    ...
    result.put("UGX", "Угандийски нов шилинг");
    result.put("USD", "САЩ долар");
    ...
    result.put("UZS", "Узбекистански сум");
    result.put("VEB", "Венецуелски боливар (1871-2008)");
    result.put("VEF", "Венецуелски боливар");
    result.put("VND", "Виетнамски донг");
    result.put("VUV", "Вануату - вату");
    result.put("WST", "Самоа - тала");
    result.put("XAF", "Буркина Фасо - CFA - франк");
    ...
    result.put("XXX", "Непозната или невалидна валута");
    ...
    result.put("ZMK", "Замбийска квача");
