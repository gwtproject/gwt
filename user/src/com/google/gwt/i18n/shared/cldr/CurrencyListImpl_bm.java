...
/**
 * Pure Java implementation of CurrencyList for locale "bm".
 */
public class CurrencyListImpl_bm extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("EUR", "ero");
    result.put("GBP", "angilɛ Livri Siterlingi");
    ...
    result.put("MRO", "mɔritani Uguwiya");
