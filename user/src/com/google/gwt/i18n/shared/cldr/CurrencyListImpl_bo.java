...
/**
 * Pure Java implementation of CurrencyList for locale "bo".
 */
public class CurrencyListImpl_bo extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("INR", "རྒྱ་གར་སྒོར་མོ་");
    result.put("USD", "ཨ་རིའི་སྒོར་མོ།");
