...
/**
 * Pure Java implementation of CurrencyList for locale "bs".
 */
public class CurrencyListImpl_bs extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("ANG", "Holandski Antili gilder");
    result.put("AOA", "Angolijska kvanza");
    ...
    result.put("AWG", "Arubijski florin");
    ...
    result.put("BWP", "Botsvanska pula");
    result.put("BYB", "Beloruska nova rublja (1994-1999)");
    result.put("BYR", "Beloruska rublja");
    result.put("BZD", "Belize dolar");
    result.put("CAD", "Kanadski dolar");
    result.put("CDF", "Kongolski franak");
    ...
    result.put("CVE", "Kejp verdanški eskudo");
    ...
    result.put("KYD", "Kajmanska ostrva dolar");
    result.put("KZT", "Kazahstanski tendž");
    result.put("LAK", "Laoški kip");
    result.put("LBP", "Lebanska funta");
    result.put("LKR", "Šrilankanski rupi");
    ...
    result.put("MDL", "Moldovski lju");
    result.put("MGA", "Malagasijski ariari");
    ...
    result.put("PYG", "Paragvajski guarni");
    ...
    result.put("SBD", "Solomonska ostrva dolar");
    result.put("SCR", "Sejšelski rupi");
    ...
    result.put("SHP", "Sv. Helenska funta");
    ...
    result.put("STD", "Sao Tome i Principe dobra");
    result.put("SUR", "Sovjetska rublja");
    result.put("SVC", "Salvadorski kolon");
    result.put("SYP", "Sirijska funta");
    result.put("SZL", "Švazi lilangeni");
    result.put("THB", "Tai baht");
    ...
    result.put("XCD", "Istočnokaribijski dolar");
