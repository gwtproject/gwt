...
/**
 *  * Pure Java implementation of CurrencyList for locale "cgg".
 */
public class CurrencyListImpl_cgg extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("UGX", "USh", 0, "USh", "UGX");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("UGX", new CurrencyDataImpl("UGX", "USh", 0, "USh", "UGX"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ougwiya ya Mouriteeniya");
    ...
    result.put("STD", "Dobra ya Sao Tome na Purinsipo");
