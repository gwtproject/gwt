...
/**
 *  * Pure Java implementation of CurrencyList for locale "de".
 */
public class CurrencyListImpl_de extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AFN", "Afghanische Afghani");
    result.put("ALL", "Albanische Lek");
    result.put("AMD", "Armenische Dram");
    ...
    result.put("BAD", "Bosnien und Herzegowina Dinar");
    ...
    result.put("NLG", "Holländischer Gulden");
    ...
    result.put("SRD", "Surinamischer Dollar");
    ...
    result.put("TMM", "Turkmenistan-Manat");
    result.put("TMT", "Neuer Turkmenistan-Manat");
    result.put("TND", "Tunesischer Dinar");
    result.put("TOP", "Paʻanga");
    result.put("TPE", "Timor-Escudo");
    result.put("TRL", "Alte Türkische Lira");
    ...
    result.put("UYP", "Uruguayischer Neuer Peso (1975-1993)");
    ...
    result.put("VUV", "Vatu");
    result.put("WST", "Tala");
    result.put("XAF", "CFA Franc (Äquatorial)");
