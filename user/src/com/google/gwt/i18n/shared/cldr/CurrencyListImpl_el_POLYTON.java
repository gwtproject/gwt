...
/**
 *  * Pure Java implementation of CurrencyList for locale "el_POLYTON".
 */
public class CurrencyListImpl_el_POLYTON extends CurrencyListImpl_el {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("ADP", "Πεσέτα Ἀνδόρας");
    result.put("AED", "Ντιρὰμ Ἡνωμένων Ἀραβικῶν Ἐμιράτων");
    result.put("ALL", "Λὲκ Ἀλβανίας");
    result.put("AMD", "Dram Ἀρμενίας");
    result.put("ANG", "Γκίλντα Ὁλλανδικῶν Ἀντιλλῶν");
    result.put("AOA", "Kwanza Ἀνγκόλας");
    result.put("AOK", "Kwanza Ἀνγκόλας (1977-1990)");
    result.put("AON", "Νέα Kwanza Ἀνγκόλας (1990-2000)");
    result.put("AOR", "Kwanza Reajustado Ἀνγκόλας (1995-1999)");
    result.put("ARA", "Austral Ἀργεντινῆς");
    result.put("ARP", "Πέσο Ἀργεντινῆς (1983-1985)");
    result.put("ARS", "Πέσο Ἀργεντινῆς");
    result.put("ATS", "Σελίνι Αὐστρίας");
    result.put("AUD", "Δολάριο Αὐστραλίας");
    result.put("AWG", "Γκίλντα Ἀρούμπα");
    result.put("AZM", "Μανὰτ Ἀζερμπαϊτζάν");
    result.put("BAD", "Δηνάριο Βοσνίας-Ἑρζεγοβίνης");
    result.put("BAM", "Μάρκο Βοσνίας-Ἑρζεγοβίνης");
    result.put("BEL", "Φράγκο Βελγίου (οἰκονομικό)");
    result.put("BGL", "Μεταλλικὸ Λὲβ Βουλγαρίας");
    result.put("BGN", "Νέο Λὲβ Βουλγαρίας");
    result.put("CAD", "Δολάριο Καναδᾶ");
    result.put("CHF", "Φράγκο Ἑλβετίας");
    result.put("CLF", "Unidades de Fomento Χιλῆς");
    result.put("CLP", "Πέσο Χιλῆς");
    result.put("CSK", "Σκληρὴ Κορόνα Τσεχοσλοβακίας");
    result.put("CVE", "Ἐσκούδο Πράσινου Ἀκρωτηρίου");
    result.put("DDM", "Ostmark Ἀνατολικῆς Γερμανίας");
    result.put("DZD", "Δηνάριο Ἀλγερίας");
    result.put("ECS", "Sucre Ἰσημερινοῦ");
    result.put("ECV", "Unidad de Valor Constante (UVC) Ἰσημερινοῦ");
    result.put("EEK", "Κορόνα Ἐστονίας");
    result.put("EGP", "Λίρα Αἰγύπτου");
    result.put("ERN", "Nakfa Ἐρυθραίας");
    result.put("ESP", "Πεσέτα Ἱσπανίας");
    result.put("ETB", "Birr Αἰθιοπίας");
    result.put("EUR", "Εὐρώ");
    result.put("FKP", "Λίρα Νήσων Φώλκλαντ");
    result.put("GMD", "Dalasi Γκάμπιας");
    result.put("GQE", "Ekwele Guineana Ἰσημερινῆς Γουινέας");
    result.put("GTQ", "Quetzal Γουατεμάλας");
    result.put("GWE", "Γκινέα Ἐσκούδο Πορτογαλίας");
    result.put("HKD", "Δολάριο Χὸνγκ Κόνγκ");
    result.put("HTG", "Gourde Ἁϊτῆς");
    result.put("HUF", "Φιορίνι Οὑγγαρίας");
    result.put("IDR", "Ρούπια Ἰνδονησίας");
    result.put("IEP", "Λίρα Ἰρλανδίας");
    result.put("ILP", "Λίρα Ἰσραήλ");
    result.put("ILS", "Νέο Sheqel Ἰσραήλ");
    result.put("INR", "Ρούπια Ἰνδίας");
    result.put("IQD", "Δηνάριο Ἰράκ");
    result.put("IRR", "Rial Ἰράκ");
    result.put("ISK", "Κορόνα Ἰσλανδίας");
    result.put("ITL", "Λιρέτα Ἰταλίας");
    result.put("JOD", "Δηνάριο Ἰορδανίας");
    result.put("JPY", "Γιὲν Ἰαπωνίας");
    result.put("LKR", "Ρούπια Σρὶ Λάνκας");
    result.put("MOP", "Pataca Μακάου");
    result.put("MXN", "Πέσο Μεξικοῦ");
    result.put("MXP", "Ἀσημένιο Πέσο Μεξικοῦ (1861-1992)");
    result.put("MXV", "Unidad de Inversion (UDI) Μεξικοῦ");
    result.put("MZE", "Ἐσκούδο Μοζαμβίκης");
    result.put("NAD", "Δολάριο Ναμίμπιας");
    result.put("NIO", "Χρυσὴ Κόρδοβα Νικαράγουας");
    result.put("NLG", "Γκίλντα Ὁλλανδίας");
    result.put("PAB", "Μπαλμπόα Παναμᾶ");
    result.put("PGK", "Kina Παπούα Νέα Γουινέας");
    result.put("PTE", "Ἐσκούδο Πορτογαλίας");
    result.put("PYG", "Γκουαρανὶ Παραγουάης");
    result.put("SBD", "Δολάριο Νήσων Σολομῶντος");
    result.put("SCR", "Ρούπια Σεϋχελῶν");
    result.put("SHP", "Λίρα Ἀγίας Ἑλένης");
    result.put("SUR", "Σοβιετικὸ Ρούβλι");
    result.put("SVC", "Colon Ἒλ Σαλβαδόρ");
    result.put("SZL", "Lilangeni Ζουαζιλάνδης");
    result.put("THB", "Μπὰτ Ταϊλάνδης");
    result.put("TMM", "Μανὰτ Τουρκμενιστάν");
    result.put("TPE", "Ἐσκούδο Τιμόρ");
    result.put("TTD", "Δολάριο Τρινιδὰδ καὶ Τομπάγκο");
    result.put("UAH", "Hryvnia Οὐκρανίας");
    result.put("UAK", "Karbovanetz Οὐκρανίας");
    result.put("UGS", "Σελίνι Οὐγκάντας (1966-1987)");
    result.put("UGX", "Σελίνι Οὐγκάντας");
    result.put("USN", "Δολάριο ΗΠΑ (Ἑπόμενη ἡμέρα)");
    result.put("USS", "Δολάριο ΗΠΑ (Ἴδια ἡμέρα)");
    result.put("UYP", "Πέσο Οὐρουγουάης (1975-1993)");
    result.put("UYU", "Πέσο Uruguayo Οὐρουγουάης");
    result.put("UZS", "Sum Οὐζμπεκιστάν");
    result.put("VEB", "Μπολιβὰλ Βενεζουέλας");
    result.put("WST", "Tala Δυτικῆς Σαμόας");
    result.put("XBA", "Εὐρωπαϊκὴ Σύνθετη Μονάδα");
    result.put("XBB", "Εὐρωπαϊκὴ Νομισματικὴ Μονάδα");
    result.put("XBC", "Εὐρωπαϊκὴ Μονάδα Λογαριασμοῦ (XBC)");
    result.put("XBD", "Εὐρωπαϊκὴ Μονάδα Λογαριασμοῦ (XBD)");
    result.put("XCD", "Δολάριο Ἀνατολικῆς Καραϊβικῆς");
    result.put("XDR", "Εἰδικὰ Δικαιώματα Ἀνάληψης");
    result.put("XEU", "Εὐρωπαϊκὴ Συναλλαγματικὴ Μονάδα");
    result.put("XFO", "Χρυσὸ Φράγκο Γαλλίας");
    result.put("YDD", "Δηνάριο Ὑεμένης");
    result.put("YER", "Rial Ὑεμένης");
    result.put("YUD", "Μεταλλικὸ Δηνάριο Γιουγκοσλαβίας");
    result.put("ZAL", "Ραντ Νότιας Ἀφρικῆς (οἰκονομικό)");
    result.put("ZAR", "Ρὰντ Νότιας Ἀφρικῆς");
    return result;
  }
}
