...
/**
 * Pure Java implementation of CurrencyList for locale "en_GY".
 */
public class CurrencyListImpl_en_GY extends CurrencyListImpl_en {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("GYD", "GYD", 0, "GYD", "$");
  }
