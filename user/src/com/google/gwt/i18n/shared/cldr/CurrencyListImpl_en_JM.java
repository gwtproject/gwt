...
/**
 * Pure Java implementation of CurrencyList for locale "en_JM".
 */
public class CurrencyListImpl_en_JM extends CurrencyListImpl_en {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("JMD", "$", 2, "JA$", "$");
  }

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("JMD", new CurrencyDataImpl("JMD", "$", 2, "JA$", "$"));
