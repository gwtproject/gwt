...
/**
 *  * Pure Java implementation of CurrencyList for locale "en_SG".
 */
public class CurrencyListImpl_en_SG extends CurrencyListImpl_en {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("SGD", "$", 2, "S$", "$");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("SGD", new CurrencyDataImpl("SGD", "$", 2, "S$", "$"));
