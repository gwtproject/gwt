...
/**
 * Pure Java implementation of CurrencyList for locale "es_CO".
 */
public class CurrencyListImpl_es_CO extends CurrencyListImpl_es {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("COP", "$", 0, "COL$", "$");
  }

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("COP", new CurrencyDataImpl("COP", "$", 0, "COL$", "$"));
    return result;
  }
