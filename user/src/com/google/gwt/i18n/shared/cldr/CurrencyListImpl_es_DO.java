...
/**
 *  * Pure Java implementation of CurrencyList for locale "es_DO".
 */
public class CurrencyListImpl_es_DO extends CurrencyListImpl_es {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("DOP", "$", 2, "RD$", "$");
  }
  
  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("DOP", new CurrencyDataImpl("DOP", "$", 2, "RD$", "$"));
    return result;
  }
