...
/**
 * Pure Java implementation of CurrencyList for locale "es_MX".
 */
public class CurrencyListImpl_es_MX extends CurrencyListImpl_es {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MXN", "$", 2, "Mex$", "$");
  }

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("MXN", new CurrencyDataImpl("MXN", "$", 2, "Mex$", "$"));
    return result;
  }
