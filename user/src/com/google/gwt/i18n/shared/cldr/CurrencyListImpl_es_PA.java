...
/**
 *  * Pure Java implementation of CurrencyList for locale "es_PA".
 */
public class CurrencyListImpl_es_PA extends CurrencyListImpl_es {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PAB", "B/.", 2, "B/.", "B/.");
  }
