...
/**
 *  * Pure Java implementation of CurrencyList for locale "es_PY".
 */
public class CurrencyListImpl_es_PY extends CurrencyListImpl_es {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PYG", "₲", 0, "₲", "Gs");
  }
  
  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("PYG", new CurrencyDataImpl("PYG", "₲", 0, "₲", "Gs"));
    return result;
  }
