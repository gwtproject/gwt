...
/**
 * Pure Java implementation of CurrencyList for locale "es_UY".
 */
public class CurrencyListImpl_es_UY extends CurrencyListImpl_es {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("UYU", "$", 2, "UY$", "$");
  }

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("UYU", new CurrencyDataImpl("UYU", "$", 2, "UY$", "$"));
    return result;
  }
