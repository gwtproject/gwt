...
/**
 *  * Pure Java implementation of CurrencyList for locale "es_VE".
 */
public class CurrencyListImpl_es_VE extends CurrencyListImpl_es {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("VEF", "Bs.F.", 2, "Bs.F.", "Bs");
  }
