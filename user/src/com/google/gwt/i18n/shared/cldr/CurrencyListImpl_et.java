...
/**
 *  * Pure Java implementation of CurrencyList for locale "et".
 */
public class CurrencyListImpl_et extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AWG", "Aruba guilder");
    result.put("AZM", "Aserbaidžaani manat, 1993-2006");
    result.put("AZN", "Aserbaidžaani manat");
    result.put("BAD", "Bosnia-Hertsegoviina dinaar");
    result.put("BAM", "Bosnia-Hertsegoviina mark");
    ...
    result.put("BYR", "Valgevene rubla");
    ...
    result.put("COP", "Kolumbia peeso");
    result.put("CRC", "Costa Rica colón");
    result.put("CSD", "Serbia vana dinaar");
    result.put("CUC", "Kuuba konverteeritav peeso");
    result.put("CUP", "Kuuba peeso");
    result.put("CVE", "Roheneemesaarte eskuudo");
    ...
    result.put("GHC", "Ghana sedi");
    result.put("GHS", "Ghaana cedi");
    ...
    result.put("GTQ", "Guatemala ketsal");
    ...
    result.put("MGA", "Madagaskari ariary");
    result.put("MKD", "Makedoonia denaar");
    result.put("MMK", "Myanmari kjatt");
    result.put("MNT", "Mongoolia tugrik");
    result.put("MOP", "Macao pataka");
    result.put("MRO", "Mauretaania ugia");
    result.put("MTL", "Malta liir");
    result.put("MUR", "Mauritiuse ruupia");
    result.put("MVR", "Maldiivide ruupia");
    result.put("MWK", "Malawi kvatša");
    result.put("MXN", "Mehhiko peeso");
    result.put("MXP", "Mehhiko peeso, 1861-1990");
    ...
    result.put("NIC", "Nicaragua kordoba");
    result.put("NIO", "Nicaragua kuldkordoba");
    ...
    result.put("PEN", "Peruu uus soll");
    result.put("PES", "Peruu soll");
    result.put("PGK", "Paapua Uus-Guinea kina");
    result.put("PHP", "Filipiinide peeso");
    ...
    result.put("PYG", "Paraguai guaranii");
    result.put("QAR", "Quatari riaal");
    result.put("ROL", "Rumeenia lei, -2005");
    result.put("RON", "Rumeenia lei");
    result.put("RSD", "Serbia dinaar");
    result.put("RUB", "Venemaa rubla");
    result.put("RUR", "Venemaa rubla, 1991-1998");
    result.put("RWF", "Ruanda frank");
    result.put("SAR", "Saudi-Araabia riaal");
    result.put("SBD", "Saalomoni saarte dollar");
    result.put("SCR", "Seišelli saarte ruupia");
    ...
    result.put("SKK", "Slovakkia kroon");
    result.put("SLL", "Sierra Leone leoone");
    result.put("SOS", "Somaalia šilling");
    result.put("SRD", "Surinami dollar");
    result.put("SRG", "Surinami kulden");
    result.put("STD", "São Tomé ja Príncipe Dobra");
    result.put("SUR", "NSVL rubla");
    result.put("SVC", "Salvadori koloon");
    ...
    result.put("TRL", "Türgi liir");
    result.put("TRY", "Türgi uus liir");
    result.put("TTD", "Trinidadi ja Tobago dollar");
    result.put("TWD", "Taiwani dollar");
    ...
    result.put("UYU", "Uruguai peeso");
    result.put("UZS", "Usbekistani somm");
    result.put("VEB", "Venezuela boliivar");
    result.put("VEF", "Venezuela bolívar");
    result.put("VND", "Vietnami dong");
    result.put("VUV", "Vanuatu vatu");
    result.put("WST", "Lääne-Samoa tala");
    ...
    result.put("XOF", "Aafrika ühisfrank BCEAO");
    result.put("XPD", "pallaadium");
    result.put("XPF", "Prantsuse Vaikse-Ookeani frank");
    ...
    result.put("YUM", "Jugoslaavia uus dinaar");
    result.put("YUN", "Jugoslaavia konverteeritav dinaar");
    result.put("ZAR", "LAVi rand");
    result.put("ZMK", "Sambia kvatša");
