...
/**
 *  * Pure Java implementation of CurrencyList for locale "eu".
 */
public class CurrencyListImpl_eu extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AWG", "Arubeko florina");
    ...
    result.put("GBP", "Britainia Handiko libera esterlina");
    ...
    result.put("IDR", "Indonesiako rupiah");
    result.put("ILS", "Israeleko sheqel berria");
    ...
    result.put("KES", "Kenyako shillinga");
    result.put("KGS", "Kyrgystango soma");
    ...
    result.put("MKD", "Mazedoniako denara");
    result.put("MMK", "Myanmako kyata");
    result.put("MNT", "Mongoliako tugrika");
    result.put("MOP", "Macanako pataca");
    result.put("MRO", "Mauritaniako ouguiya");
    result.put("MUR", "Mauriziar uharteetako errupia");
    result.put("MVR", "Maldibiako rufiyaa");
    ...
    result.put("PEN", "Peruko sol berria");
    ...
    result.put("SGD", "Singapurgo dolarra");
    result.put("SHP", "Santa Helenako libera");
    result.put("SLL", "Sierra Leonako leona");
    result.put("SOS", "Somaliako shillinga");
    result.put("SRD", "Surinameko dolarra");
    result.put("STD", "Sao Tomeko eta Principeko dobra");
    result.put("SYP", "Siriako libera");
    result.put("SZL", "Swaziko lilangenia");
