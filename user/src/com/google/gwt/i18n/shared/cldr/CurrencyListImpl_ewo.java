...
/**
 * Pure Java implementation of CurrencyList for locale "ewo".
 */
public class CurrencyListImpl_ewo extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AOA", "Kwánǝza yá Angolá");
    result.put("AUD", "Dolár yá Osǝtǝralí");
    result.put("BHD", "Dinár yá Bahǝrɛ́n");
    result.put("BIF", "Fǝláŋ yá Burundí");
    result.put("BWP", "Púlá yá Botswána");
    result.put("CAD", "Dolár yá Kanáda");
    result.put("CDF", "Fǝláŋ yá Kongo");
    result.put("CHF", "Fǝláŋ yá Suís");
    result.put("CNY", "Yuán Renǝminǝbí yá Tsainís");
    result.put("CVE", "Esǝkúdo yá Kápǝ́vɛ́rǝ");
    result.put("DJF", "Fǝláŋ yá dzibutí");
    result.put("DZD", "Dinár yá Alehérí");
    result.put("EGP", "Lívǝ́lǝ yá Ehíbǝtía");
    result.put("ERN", "Náfǝka yá Eritelé");
    result.put("ETB", "Bír yá Etsiópia");
    result.put("EUR", "ǝró");
    result.put("GBP", "Lívǝ́lǝ Sǝtǝrǝlíŋ");
    ...
    result.put("RWF", "Fǝláŋ yá Ruwandá");
    result.put("SAR", "Riál yá Arabí Saudí");
    result.put("SCR", "Rupí yá Sɛsɛ́l");
    result.put("SDG", "Lívǝlǝ yá Sudán");
    result.put("SDP", "Lívǝlǝ yá Sudán (1956–2007)");
    result.put("SHP", "Lívǝlǝ yá Ǹfúfúb Elɛ́n");
    result.put("SLL", "Leóne yá Sierá-leónǝ");
    result.put("SOS", "Silíŋ yá Somalí");
    result.put("STD", "Dóbǝ́ra yá Saó Tomé ai Pǝlinǝsípe");
    ...
    result.put("USD", "Dolár yá amɛ́rǝkǝ");
    result.put("XAF", "Fǝláŋ CFA (BEAC)");
    result.put("XOF", "Fǝláŋ CFA (BCEAO)");
    result.put("ZAR", "Ránǝdǝ yá Afiríka");
    result.put("ZMK", "Kwatsa yá Zambí");
