...
/**
 * Pure Java implementation of CurrencyList for locale "ff".
 */
public class CurrencyListImpl_ff extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ugiyya Muritani");
    ...
    result.put("STD", "Dobra Sawo Tome e Prensipe");
