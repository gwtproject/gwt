...
/**
 * Pure Java implementation of CurrencyList for locale "fil".
 */
public class CurrencyListImpl_fil extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("PHP", "₱", 2, "PHP", "₱");
  }
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("CHF", "Swiss Francs");
    result.put("CLP", "Chilean Peso");
    result.put("CNY", "Yuan Renminbi");
    ...
    result.put("GBP", "British Pounds Sterling");
    ...
    result.put("HKD", "Hong Kong Dollars");
    ...
    result.put("NOK", "Norwegian Kroner");
    result.put("NPR", "Nepalese Rupee");
    result.put("NZD", "New Zealand Dollars");
    ...
    result.put("PKR", "Pakistan Rupee");
    result.put("PLN", "Polish NewZloty");
    ...
    result.put("SEK", "Sweden Kronor");
    result.put("SGD", "Singapore Dollars");
    ...
    result.put("VEB", "Venezuela Bolivar");
