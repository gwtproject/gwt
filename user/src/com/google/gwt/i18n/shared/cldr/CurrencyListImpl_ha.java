...
/**
 * Pure Java implementation of CurrencyList for locale "ha".
 */
public class CurrencyListImpl_ha extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Kuɗin Moritaniya");
    ...
    result.put("STD", "Kuɗin Sawo Tome da Paransip");
