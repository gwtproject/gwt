...
/**
 * Pure Java implementation of CurrencyList for locale "hi".
 */
public class CurrencyListImpl_hi extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AED", "संयुक्त अरब अमीरात दिर्हाम");
    result.put("AFA", "अफगानी (1927-2002)");
    result.put("AFN", "अफगानी");
    result.put("ALL", "अल्बानियाई लेक");
    result.put("AMD", "अरमेनियाई दरम");
    result.put("ANG", "नीदरलैंड एंटीलियन गिल्डर");
    result.put("AOA", "अंगोला क्वांज़ा");
    result.put("ARS", "अर्जेण्टीनी पीसो");
    result.put("AUD", "ऑस्ट्रेलियाई डॉलर");
    result.put("AWG", "अरुबा फ़्लोरिन");
    result.put("AZN", "आज़रबाइजानी मैनेट");
    result.put("BAM", "बोस्निया हर्ज़ेगोविना परिवर्तनीय चिह्न");
    result.put("BBD", "बार्बेडियन डॉलर");
    result.put("BDT", "बांग्लादेशी टाका");
    result.put("BGN", "बुल्गारियाई लेव्");
    result.put("BHD", "बहरीनी दिनार");
    result.put("BIF", "बरुंडी फ्रैंक");
    result.put("BMD", "बरमूडा डॉलर");
    result.put("BND", "ब्रुनेई डॉलर");
    result.put("BOB", "बोलिवियाई बोलिवियानो");
    result.put("BRL", "रीयाल");
    result.put("BSD", "बहेमियन डॉलर");
    result.put("BTN", "भूटानी एंगलट्रम");
    result.put("BWP", "वोत्स्वानन पुला");
    result.put("BYR", "बेलारुसी");
    result.put("BZD", "बेलिज़े डॉलर");
    result.put("CAD", "कनेडियन डॉलर");
    result.put("CDF", "कोंगोली फ़्रैंक");
    result.put("CHF", "स्विस फ़्रैंक");
    result.put("CLP", "चिली पीसो");
    result.put("CNY", "युवान");
    result.put("COP", "कोलम्बियाई पीसो");
    result.put("CRC", "कोस्टा रिका कोलोन");
    result.put("CSD", "सर्बिय का ढीनार");
    result.put("CUC", "क्यूबा परिवर्तनीय पेसो");
    result.put("CUP", "क्यूबा पेसो");
    result.put("CVE", "केप वर्दे एस्कूदो");
    result.put("CYP", "साईप्रस पाऊंड");
    result.put("CZK", "चेक कोरुना");
    result.put("DEM", "डच मार्क");
    result.put("DJF", "जिबोटीयन फ़्रैंक");
    result.put("DKK", "डेनमार्क क्रोन");
    result.put("DOP", "डोमिनिकन पेसो");
    result.put("DZD", "अल्जीरीयाई दिनार");
    result.put("EEK", "एस्टोनियाई क्रून्");
    result.put("EGP", "मिस्री पाउण्ड");
    result.put("ERN", "एरिट्रेन नाक्फ़ा");
    result.put("ETB", "इथियोपिक बिर");
    result.put("EUR", "युरो");
    result.put("FJD", "फ़िजी का डालर");
    result.put("FKP", "फ़ॉकलैंड आइलैंड पाउंड");
    result.put("FRF", "फ़्रांसीसी फ़्रैंक");
    result.put("GBP", "ब्रितन का पौन्ड स्टर्लिग");
    result.put("GEL", "जॉर्जियन लारी");
    result.put("GHS", "घानियन सेडी");
    result.put("GIP", "जिब्राल्टर पाउंड");
    result.put("GMD", "गैम्बियन डलासी");
    result.put("GNF", "गिनीयन फ़्रैंक");
    result.put("GTQ", "ग्वाटेमाला केत्ज़ल");
    ...
    result.put("HTG", "हैशियन गॉर्डे");
    result.put("HUF", "हंगरी फोरेंट्");
    result.put("IDR", "इंडोनेशियाई रुपिया");
    result.put("ILS", "इस्राइली शेकेल");
    result.put("INR", "भारतीय रूपया");
    ...
    result.put("JOD", "जार्डनियन दिनार");
    result.put("JPY", "जापानी येन");
    result.put("KES", "केनियाई शिलिंग");
    result.put("KGS", "किर्गिस्तानी सोम");
    result.put("KHR", "कम्बोडियाई रियल");
    result.put("KMF", "कोमोरियन फ़्रैंक");
    result.put("KPW", "उत्तर कोरियाई वोन");
    result.put("KRW", "दक्षिण कोरियाई वोन");
    result.put("KWD", "कुवैती दिनार");
    result.put("KYD", "कैमैन आइलैंड डॉलर");
    result.put("KZT", "कज़ाक़िस्तानी टेंज़");
    result.put("LAK", "लाओशियन किप");
    result.put("LBP", "लेबनानी पाउंड");
    result.put("LKR", "श्रीलंकाई रुपया");
    result.put("LRD", "लाईबेरीयाई डालर");
    result.put("LSL", "लेसोथो लोटी");
    result.put("LTL", "लिथुआनियाई लितास");
    result.put("LVL", "लात्वियन लैत्स");
    result.put("LYD", "लिबियाई दिनार");
    result.put("MAD", "मोराक्को दिरहम");
    result.put("MAF", "मोरक्को फ्रैंक");
    result.put("MDL", "मोल्डोवन लियू");
    result.put("MGA", "मेलेगसी अइयारी");
    result.put("MKD", "मेसीडोनियन दिनार");
    result.put("MMK", "म्यनमा कियाट");
    result.put("MNT", "मंगोलियाई तुगरिक");
    result.put("MOP", "मेकानिज़ी पटाका");
    result.put("MRO", "मार्टिनियन ऊगिया");
    result.put("MUR", "मॉरीशस रुपी");
    result.put("MVR", "मलदीप रुफ़िया");
    result.put("MWK", "मेलावियन क्वाचा");
    result.put("MXN", "मेक्सिको पेसो");
    result.put("MYR", "मलेशियाई रिंगित");
    result.put("NAD", "नामीबियाई डालर");
    result.put("NGN", "नाइजेरियाई नाइरा");
    result.put("NIO", "निकेरागुयन कोरडोबा");
    result.put("NOK", "नॉर्वे क्रोन");
    result.put("NPR", "नेपाली रुपया");
    result.put("NZD", "न्यूज़ीलैंड डॉलर");
    result.put("OMR", "ओमानी रियाल");
    result.put("PAB", "पनामेनियन बैल्बोआ");
    result.put("PEN", "पेरूवियन नुएवो सोल");
    result.put("PGK", "पापुआ न्यू गिनीयन किना");
    result.put("PHP", "फ़िलिपीनी पीसो");
    result.put("PKR", "पाकिस्तानी रुपया");
    result.put("PLN", "पोलिश ज़्लॉटी");
    result.put("PYG", "परागुआयन गुआरानी");
    ...
    result.put("RWF", "रवांडाई फ्रैंक");
    result.put("SAR", "सउदी रियाल");
    result.put("SBD", "सोलोमन आइलैंड डॉलर");
    result.put("SCR", "सेशिल्वा");
    ...
    result.put("ZMK", "ज़ाम्बियन क्वाचा");
    return result;
  }
}
