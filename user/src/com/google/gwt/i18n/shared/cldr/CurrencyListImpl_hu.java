...
/**
 *  * Pure Java implementation of CurrencyList for locale "hu".
 */
public class CurrencyListImpl_hu extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("HUF", "Ft", 0, "Ft", "Ft");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("HUF", new CurrencyDataImpl("HUF", "Ft", 0, "Ft", "Ft"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AMD", "Dram");
    result.put("ANG", "Holland-antilla forint");
    ...
    result.put("AWG", "Arubai forint");
    result.put("AZM", "Azerbajdzsáni manat (1993-2006)");
    result.put("AZN", "Azerbajdzsáni manat");
    result.put("BAD", "Bosznia-hercegovinai dínár");
    result.put("BAM", "Bozsnia-hercegovinai konvertibilis márka");
    ...
    result.put("BRC", "Brazi cruzado");
    result.put("BRE", "Brazil cruzeiro (1990-1993)");
    result.put("BRL", "Brazil real");
    result.put("BRN", "Brazil cruzado novo");
    result.put("BRR", "Brazil cruzeiro");
    ...
    result.put("BYR", "Fehérorosz rubel");
    result.put("BZD", "Belizei dollár");
    ...
    result.put("CNY", "Kínai jüan renminbi");
    result.put("COP", "Kolumbiai peso");
    result.put("COU", "Unidad de Valor Real");
    result.put("CRC", "Costa Ricai colon");
    ...
    result.put("CVE", "Cape Verdei escudo");
    ...
    result.put("GBP", "Brit font sterling");
    ...
    result.put("JMD", "Jamaikai dollár");
    ...
    result.put("LKR", "Sri Lankai rúpia");
    ...
    result.put("MRO", "Mauritániai ouguiya");
    ...
    result.put("NIO", "Nikaraguai cordoba oro");
    ...
    result.put("PEN", "Perui sol nuevo");
    result.put("PES", "Perui sol");
    ...
    result.put("ROL", "Régi román lej");
    result.put("RON", "új román lej");
    ...
    result.put("TMM", "Türkmenisztáni manat");
    result.put("TMT", "Türkmenisztáni új manat");
    result.put("TND", "Tunéziai dínár");
    result.put("TOP", "tongai paanga");
    result.put("TPE", "Timori escudo");
    result.put("TRL", "Régi török líra");
    result.put("TRY", "új török líra");
    result.put("TTD", "Trinidad és tobagoi dollár");
    ...
    result.put("UYU", "Uruguay-i peso uruguayo");
    result.put("UZS", "Üzbegisztáni szum");
    result.put("VEB", "Venezuelai bolívar");
    result.put("VEF", "Venezuelai bolivar fuerte");
    ...
    result.put("XXX", "Ismeretlen vagy érvénytelen pénznem");
    ...
    result.put("ZMK", "Zambiai kwacha");
    result.put("ZRN", "Zairei új zaire");
    result.put("ZRZ", "Zairei zaire");
    result.put("ZWD", "Zimbabwei dollár");
