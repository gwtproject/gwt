...
/**
 *  * Pure Java implementation of CurrencyList for locale "hy".
 */
public class CurrencyListImpl_hy extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("AMD", "դր.", 0, "դր.", "Dram");
  }
  
  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("AMD", new CurrencyDataImpl("AMD", "դր.", 0, "դր.", "Dram"));
    return result;
  }
