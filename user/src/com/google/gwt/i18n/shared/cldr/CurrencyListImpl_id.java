...
/**
 * Pure Java implementation of CurrencyList for locale "id".
 */
public class CurrencyListImpl_id extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("IDR", "Rp", 0, "Rp", "Rp");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("IDR", new CurrencyDataImpl("IDR", "Rp", 0, "Rp", "Rp"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("BYR", "Rubel Belarusia");
    ...
    result.put("GBP", "Pound Sterling Inggris");
    ...
    result.put("RON", "Leu Rumania Baru");
    ...
    result.put("STD", "Dobra Sao Tome dan Principe");
    ...
    result.put("VEF", "Bolivar Venezuela");
