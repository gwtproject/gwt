...
/**
 * Pure Java implementation of CurrencyList for locale "ja".
 */
public class CurrencyListImpl_ja extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("SCR", "セイシェル ルピー");
    result.put("SDD", "スーダン ディナール");
    result.put("SDG", "スーダン ポンド");
    result.put("SDP", "旧スーダン ポンド");
    ...
    result.put("TMM", "トルクメニスタン マナト");
    result.put("TMT", "トルクメニスタン 新マナト");
    result.put("TND", "チュニジア ディナール");
    result.put("TOP", "トンガ パ・アンガ");
    result.put("TPE", "ティモール エスクード");
    result.put("TRL", "トルコ リラ");
    ...
    result.put("VEB", "ベネズエラ ボリバル");
    result.put("VEF", "ベネズエラ ボリバルフエルテ");
    result.put("VND", "ベトナム ドン");
    result.put("VUV", "バヌアツ バツ");
    result.put("WST", "西サモア タラ");
    result.put("XAF", "フラン (CFA-BEAC)");
    result.put("XAG", "銀");
    result.put("XAU", "金");
    ...
    result.put("YUD", "ユーゴスラビア ディナール");
    result.put("YUM", "ユーゴスラビア スーパー ディナール");
    result.put("YUN", "ユーゴスラビア 新ディナール (YUN)");
    result.put("ZAL", "南アフリカ ランド (ZAL)");
    result.put("ZAR", "南アフリカ ランド");
    result.put("ZMK", "ザンビア クワチャ");
    result.put("ZRN", "ザイール 新ザイール");
    result.put("ZRZ", "ザイール ザイール");
    result.put("ZWD", "ジンバブエ ドル");
