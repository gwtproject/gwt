...
/**
 * Pure Java implementation of CurrencyList for locale "kab".
 */
public class CurrencyListImpl_kab extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("DZD", "DA", 2, "DA", "din");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("DZD", new CurrencyDataImpl("DZD", "DA", 2, "DA", "din"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("EUR", "Uru");
    result.put("GBP", "Apund Sterling Aglizi");
    ...
    result.put("MRO", "Agiya Amuriṭani");
    ...
    result.put("STD", "Asw Ṭum d Udubra Amenzay");
