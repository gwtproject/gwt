...
/**
 * Pure Java implementation of CurrencyList for locale "kea".
 */
public class CurrencyListImpl_kea extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("CVE", "CVE", 2, "CVE", "CVE");
  }
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("EUR", "Euro");
    result.put("GBP", "Libra sterlina britaniku");
    result.put("GHC", "Sedi di Gana");
    ...
    result.put("SDP", "Libra sudanes antigu");
    ...
    result.put("STD", "Dobra di Sãu Tume i Prinsipi");
    ...
    result.put("ZMK", "Kuaxa zambianu");
    result.put("ZWD", "Dola di Zimbabue");
    return result;
  }
}
