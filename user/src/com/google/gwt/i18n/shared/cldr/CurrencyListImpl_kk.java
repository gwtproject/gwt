...
/**
 * Pure Java implementation of CurrencyList for locale "kk".
 */
public class CurrencyListImpl_kk extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AED", "Дихрам (БАЭ)");
    result.put("AFN", "Афгани");
    result.put("ALL", "Албания лекі");
    result.put("AMD", "Армения драмы");
    result.put("ARS", "Аргентина пессосы");
    result.put("AUD", "Австралия доллары");
    result.put("AZM", "Азербайджан манаты (1993-2006)");
    result.put("AZN", "Азербайджан манаты");
    result.put("BBD", "Барбадиан доллары");
    result.put("BDT", "Бангладеш Такасы");
    result.put("BGN", "Болгар леві");
    result.put("BHD", "Бахрейн динары");
    result.put("BIF", "Бурундиан франкі");
    result.put("BND", "Бруней доллары");
    result.put("BRL", "Бразилия реалы");
    result.put("BYR", "Беларус рублі");
    result.put("CAD", "Канада доллары");
    result.put("CHF", "Швейцар франкі");
    result.put("CNY", "Қытай юаны");
    result.put("CZK", "Чех кронасы");
    result.put("DKK", "Дат кроны");
    result.put("EUR", "Еуро");
    result.put("GBP", "Британия фунты");
    result.put("HKD", "Гонконг доллары");
    result.put("IDR", "Индонезия рупиі");
    result.put("INR", "Үнді рупия");
    result.put("JMD", "Ямайка доллары");
    result.put("JOD", "Йорданиан динары");
    result.put("JPY", "Жапон иені");
