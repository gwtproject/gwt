...
/**
 *  * Pure Java implementation of CurrencyList for locale "kln".
 */
public class CurrencyListImpl_kln extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Rabisiekab Mauritania");
    ...
    result.put("STD", "Rabisiekab Sao Tome ak Principe");
    ...
    result.put("ZMK", "Kwachaitab Zambia");
