...
/**
 *  * Pure Java implementation of CurrencyList for locale "km".
 */
public class CurrencyListImpl_km extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("KHR", "៛", 2, "៛", "Riel");
  }
  
  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("KHR", new CurrencyDataImpl("KHR", "៛", 2, "៛", "Riel"));
    return result;
  }
