...
/**
 *  * Pure Java implementation of CurrencyList for locale "kn".
 */
public class CurrencyListImpl_kn extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AED", "ಯುನೈಟೆಡ್ ಅರಬ್ ಎಮಿರೇಟ್ಸ್ ದಿರಾಮ್‌");
    result.put("AFN", "ಆಫ್ಘನ್‌ನ ಆಫ್ಘಾನೀ");
    result.put("ALL", "ಅಲ್ಬೇನಿಯಾದ ಲೇಕ್‌‌");
    result.put("AMD", "ಆರ್ಮೇನಿಯಾದ ಡ್ರಮ್‌");
    result.put("ANG", "ನೆದರ್‌ಲ್ಯಾಂಡ್ಸ್‌‌ ಎಂಟಿಲಿಯಾದ ಗಿಲ್ಡರ್‌‌");
    result.put("AOA", "ಅಂಗೋಲಾದ ಕ್ವಾನ್ಝಾ");
    result.put("ARS", "ಅರ್ಜೆಂಟಿನಾ ಪೆಸೊ");
    result.put("AUD", "ಆಸ್ಟ್ರೇಲಿಯಾದ ಡಾಲ‌‌ರ್‌");
    result.put("AWG", "ಅರುಬ ಫ್ಲೊರೀನ್‌‌");
    result.put("AZN", "ಅಜೆರ್‌ಬೇಜಾನಿ ಮನತ್‌");
    result.put("BAM", "ಬೋಸ್ನಿಯಾ, ಹರ್ಝ್‌‌ಗೋವಿನ ಪರಿವರ್ತನೀಯ ಮಾರ್ಕ್‌");
    result.put("BBD", "ಬರ್ಬಾದಿಯಾ ಡಾಲರ್‌");
    result.put("BDT", "ಬಾಂಗ್ಲಾದೇಶದ ಟಾಕಾ");
    result.put("BGN", "ಬಲ್ಗೇರಿಯಾದ ಲೇವ್‌");
    result.put("BHD", "ಬಹ್ರಾನ್‌‌ನ ದಿನಾರ್‌");
    result.put("BIF", "ಬುರುಂಡಿಯ ಫ್ರಾಂಕ್‌");
    result.put("BMD", "ಬರ್ಮುಡಾದ ಡಾಲರ್‌");
    result.put("BND", "ಬ್ರೂನಿ ಡಾಲರ್‌");
    result.put("BOB", "ಬೊಲಿವಿಯಾದ ಬೊಲಿವಿಯಾನೊ");
    result.put("BRL", "ಬ್ರೆಜಿಲ್‌ನ ರಿಯಾಲ್‌");
    result.put("BSD", "ಬಹಮಿಯಾನ್‌ ಡಾಲರ್‌");
    result.put("BTN", "ಭೂತಾನ್‌‌ದ ಎಂಗುಲ್‌ತ್ರೆಮ್‌‌");
    result.put("BWP", "ಬೊತ್ಸವಾನನ್‌ ಪುಲಾ");
    result.put("BYR", "ಬೆಲರಷ್ಯಾದ ರೂಬಲ್‌‌");
    result.put("BZD", "ಬೆಲೀಜ್‌ ಡಾಲರ್‌");
    result.put("CAD", "ಕೆನಡಾದ ಡಾಲರ್");
    result.put("CDF", "ಕಾಂಗೋಲಿಯಾದ ಫ್ರಾಂಕ್‌");
    result.put("CHF", "ಸ್ವಿಸ್ ಫ್ರಾಂಕ್‌");
    result.put("CLP", "ಚಿಲಿಯ ಪೆಸೊ");
    result.put("CNY", "ಚೀನಾದ ಯಾನ್‌");
    result.put("COP", "ಕೊಲೊಂಬಿಯೋದ ಪೆಸೊ");
    result.put("CRC", "ಕೋಸ್ಟಾ ರಿಕಾದ ಕೊಲೊನ್‌");
    result.put("CUC", "ಕ್ಯುಬಾದ ಪರಿವರ್ತನೀಯ ಪೆಸೊ");
    result.put("CUP", "ಕ್ಯೂಬಾದ ಪೆಸೊ");
    result.put("CVE", "ಕೇಪ್‌ ವರ್ದೀಯಾದ ಎಸ್ಕುಡೊ");
    result.put("CZK", "ಝೆಕ್‌ ರಿಪಬ್ಲಿಕ್‌ ಕೊರುನಾ");
    result.put("DJF", "ಜೆಬ್ಯುಟಿಯ ಫ್ರಾಂಕ್‌");
    result.put("DKK", "ಡ್ಯಾನಿಶ್ ಕ್ರೋನ್");
    result.put("DOP", "ಡಾಮಿನಿಕ್‌ನ ಪೆಸೊ");
    result.put("DZD", "ಅಲ್ಜಿರಿಯಾದ ದಿನಾರ್‌");
    result.put("EGP", "ಈಜಿಪ್ಟಿಯನ್ ಪೌಂಡ್");
    result.put("ERN", "ಎರಿತ್ರಿಯನ್ ನಕ್ಫಾ");
    result.put("ETB", "ಇಥಿಯೋಪಿಯನ್‌‌ ಬಿರ್‌");
    result.put("EUR", "ಯೂರೊ");
    result.put("FJD", "ಫಿಜಿಯ ಡಾಲರ್‌");
    result.put("FKP", "ಫಾಕ್ಲ್ಯಾಂಡ್‌ ಐಲ್ಯಾಂಡ್ಸ್‌‌ ಪೌಂಡ್‌");
    result.put("GBP", "ಬ್ರಿಟಿಷ್‌‌ ಪೌಂಡ್‌ ಸ್ಟರ್ಲಿಂಗ್‌");
    result.put("GEL", "ಜಾರ್ಜಿಯಾದ ಲಾರಿ");
    result.put("GHS", "ಘಾನಾದ ಸೆದಿ");
    result.put("GIP", "ಜಿಬ್ರಲ್ತಾರ್‌‌ನ ಪೌಂಡ್‌");
    result.put("GMD", "ಗ್ಯಾಂಬಿಯಾದ ದಲಾಸಿ");
    result.put("GNF", "ಗಿನಿಯ ಫ್ರಾಂಕ್‌");
    ...
    result.put("HUF", "ಹಂಗೇರಿಯ ಫೋರಿಂತ್‌");
    result.put("IDR", "ಇಂಡೊನೇಷ್ಯಾ ರುಪೈ");
    result.put("ILS", "ಇಸ್ರೇಲಿ ಹೊಸ ಶೆಖೆಲ್‌");
    result.put("INR", "ಭಾರತೀಯ ರುಪಾಯಿ");
    result.put("IQD", "ಇರಾಕ್‌ನ ದಿನಾರ್‌");
    result.put("IRR", "ಇರಾನ್‌ನ ರಿಯಾಲ್‌");
    result.put("ISK", "ಐಸ್‌ಲ್ಯಾಂಡ್‌ನ ಕ್ರೋನಾ");
    result.put("JMD", "ಜಮೈಕಾದ ಡಾಲರ್‌");
    result.put("JOD", "ಜೋರ್ಡಾನ್‌‌ನ ದಿನಾರ್‌");
    result.put("JPY", "ಜಪಾನೀಸ್ ಯೆನ್");
    result.put("KES", "ಕೀನ್ಯಾದ ಶಿಲ್ಲಿಂಗ್‌");
    result.put("KGS", "ಕಿರ್ಝಿಸ್ಥಾನ್‌‌ನ ಸೋಮ್‌");
    result.put("KHR", "ಕಾಂಬೋಡಿಯಾದ ರಿಯಲ್‌‌");
    result.put("KMF", "ಕಮರೋಸ್‌ನ ಫ್ರಾಂಕ್‌");
    result.put("KPW", "ಉತ್ತರ ಕೋರಿಯಾದ ವಾನ್‌‌");
    result.put("KRW", "ದಕ್ಷಿಣ ಕೋರಿಯಾದ ವನ್‌");
    result.put("KWD", "ಕುವೈತ್‌ನ ದಿನಾರ್‌");
    result.put("KYD", "ಕೆಮ್ಯಾನ್‌ ಐಲ್ಯಾಂಡ್‌ನ ಡಾಲರ್‌");
    result.put("KZT", "ಕಝಕ್‌ಸ್ತಾನ್‌ ತೆಂಜ್‌‌");
    result.put("LAK", "ಲಾವೋದ ಕೈಪ್‌");
    result.put("LBP", "ಲೆಬನಾನ್‌ನ ಪೌಂಡ್‌");
    result.put("LKR", "ಶ್ರೀಲಂಕಾದ ರುಪೀ");
    result.put("LRD", "ಲೈಬೀರಿಯಾದ ಡಾಲರ್‌");
    result.put("LSL", "ಲೆಸೊತೊ ಲೊತಿ");
    result.put("LTL", "ಲಿಥುಯೇನಿಯಾದ ಲಿತಾಸ್‌");
    result.put("LVL", "ಲಾತ್ವಿಯನ್‌ ಲಾತ್ಸ್‌‌");
    result.put("LYD", "ಲಿಬಿಯಾದ ದಿನಾರ್‌");
    result.put("MAD", "ಮೊರೊಕ್ಕನ್‌ ದಿರಾಮ್‌");
    result.put("MDL", "ಮಲ್ದೋವಾದ ಲೆವೂ");
    result.put("MGA", "ಮಲಗಾಸಿ ಅರಿಯಾರಿ");
    result.put("MKD", "ಮೆಸೆಡೋನಿಯಾದ ದಿನಾರ್‌‌");
    result.put("MMK", "ಮ್ಯಾನ್ಮಾ ಕ್ಯಾತ್‌");
    result.put("MNT", "ಮಂಗೋಲಿಯಾದ ತುಗ್ರಿಕ್‌‌");
    result.put("MOP", "ಮಕ್ಯೂದ ಪಟಕಾ");
    result.put("MRO", "ಮಾರಿಷಸ್‌‌ನ ಊಗ್ವಿಯಾ");
    result.put("MUR", "ಮಾರಿಷಿಯಸ್‌‌ನ ರುಪೀ");
    result.put("MVR", "ಮಾಲ್ಡೀವ್‌ನ ರುಫಿಯಾ");
    result.put("MWK", "ಮಲಾವಿಯ ಕ್ವಾಚ");
    result.put("MXN", "ಮೆಕ್ಸಿಕೊದ ಪೆಸೊ");
    result.put("MYR", "ಮಲೇಷ್ಯಾದ ರಿಂಗೆಟ್‌");
    result.put("NAD", "ನಮೀಬಿಯಾ ಡಾಲರ್‌");
    result.put("NGN", "ನೈಜೀರಿಯಾದ ನೇರಾ");
    result.put("NIO", "ನಿಕಾರಗ್ವಾದ ಕರ್ದೊಬಾ");
    result.put("NOK", "ನಾರ್ವೇಜಿಯದ ಕ್ರೋನ್‌");
    result.put("NPR", "ನೇಪಾಳದ ರುಪೀ");
    result.put("NZD", "ನ್ಯೂಜಿಲ್ಯಾಂಡ್ ಡಾಲರ್");
    result.put("OMR", "ಓಮನಿ ರಿಯಾಲ್‌");
    result.put("PAB", "ಪನಮಾನಿಯನ್‌ ಬಾಲ್ಬೊ");
    result.put("PEN", "ಪೆರುವೆಯ ನ್ಯೂವೊ ಸೊಲ್‌");
    result.put("PGK", "ಪ್ಯಾಪ್ಯುವ ನ್ಯೂ ಗಿನಿಯಾದ ಕೈನ್‌");
    result.put("PHP", "ಫಿಲಿಫೈನ್‌ ಪೆಸೊ");
    result.put("PKR", "ಪಾಕಿಸ್ತಾನದ ರುಪೀ");
    result.put("PLN", "ಪೊಲಿಶ್‌‌ ಜ್ವಾತೀ");
    result.put("PYG", "ಪೆರುಗ್ವೇಯ ಗ್ವಾರನೀ");
    result.put("QAR", "ಕತಾರ್‌ನ ರಿಯಾಲ್‌");
    result.put("RSD", "ಸರ್ಬಿಯಾದ ದಿನಾರ್‌");
    result.put("RUB", "ರಷ್ಯಾದ ರೂಬೆಲ್‌");
    result.put("RWF", "ರ‍್ವಾಂಡನ್‌ ಫ್ರಾಂಕ್‌");
    result.put("SAR", "ಸೌದಿಯ ರಿಯಾಲ್‌‌‌‌");
    result.put("SBD", "ಸೊಲೊಮನ್‌ ಐಲ್ಯಾಂಡ್ಸ್‌‌‌ನ ಡಾಲರ್‌");
    result.put("SCR", "ಸೆಶೆಲ್‌ನ ರುಪೀ");
    result.put("SDG", "ಸುಡಾನ್‌ನ ಪೌಂಡ್‌");
    result.put("SEK", "ಸ್ವೀಡಿಶ್ ಕ್ರೋನಾ");
    result.put("SGD", "ಸಿಂಗಾಪೂರ್‌‌ ಡಾಲರ್");
    result.put("SHP", "ಸೇಂಟ್‌ ಹೆಲೆನಾ ಪೌಂಡ್‌");
    result.put("SLL", "ಸಿಯೆರಾ ಲಿಯೋನ್‌ನ ಲಿಯೋನ್‌");
    result.put("SOS", "ಸೋಮಾಲಿ ಶಿಲ್ಲಿಂಗ್‌");
    result.put("SRD", "ಸುರಿನಾಮ್‌ನ ಡಾಲರ್‌");
    result.put("STD", "ಸಾವೊ ಟೋಮ್ ಮತ್ತು ಪ್ರಿನ್ಸಿಪ್ ದೊಬ್ರಾ");
    result.put("SYP", "ಸಿರಿಯಾದ ಪೌಂಡ್‌‌");
    result.put("SZL", "ಸ್ವಾಜಿ ಲಿಲಂಗೆನಿ");
    result.put("THB", "ಥಾಯ್‌ ಭತ್‌‌");
    result.put("TJS", "ತಝಕಿಸ್ತಾನ್‌ನ ಸೊಮೊನಿ");
    result.put("TMT", "ತುರ್ಕೆಮಿಸ್ತಾನಿ ಮಾನತ್‌");
    result.put("TND", "ಟ್ಯುನಿಷಿಯಾದ ದಿನಾರ್‌");
    result.put("TOP", "ಟೊಂಗಾ ಪಾಂಗ");
    result.put("TRY", "ಟರ್ಕಿಶ್‌ ಲಿರಾ");
    result.put("TTD", "ಟ್ರಿನಿಡಾಡ್ ಮತ್ತು ಟೊಬಾಗೋ ಡಾಲರ್‌");
    result.put("TWD", "ನ್ಯೂ ತೈವಾನ್ ಡಾಲರ್");
    result.put("TZS", "ತಾಂಝೇನಿಯಾದ ಶಿಲ್ಲಿಂಗ್‌");
    result.put("UAH", "ಉಕ್ರೇನ್‌ನ ರೇವ್ನಿಯಾ");
    result.put("UGX", "ಉಗಾಂಡ ಶಿಲ್ಲಿಂಗ್‌");
    result.put("USD", "ಅಮೆರಿಕದ ಡಾಲರ್‌");
    result.put("UYU", "ಉರುಗ್ವೆಯ ಪೆಸೊ");
    result.put("UZS", "ಉಜ್ಬೇಕಿಸ್ತಾನ್‌ ಸೊಮ್‌");
    result.put("VEF", "ವೆನೆಜುವೆಲಾದ ಬೊಲಿವರ್‌");
    result.put("VND", "ವಿಯೆಟ್ನಾಮ್‌‌ನ ಡಾಂಗ್‌");
    result.put("VUV", "ವ್ಯಾನ್‌ವಾತೂ ವಾಟು");
    result.put("WST", "ಸಮೋವನ್‌ ತಾಲಾ");
    result.put("XAF", "CFA ಫ್ರಾಂಕ್‌ BEAC");
    result.put("XCD", "ಪೂರ್ವ ಕೆರಿಬಿಯನ್‌ ಡಾಲರ್‌");
    result.put("XOF", "CFA ಫ್ರಾಂಕ್‌ BCEAO");
    result.put("XPF", "CFP ಫ್ರಾಂಕ್‌");
    result.put("XXX", "ಗೊತ್ತಿಲ್ಲದ ಕರೆನ್ಸಿ");
    result.put("YER", "ಯೆಮೆನ್‌ನ ರಿಯಾಲ್‌");
    result.put("ZAR", "ದಕ್ಷಿಣ ಆಫ್ರಿಕಾದ ರ‍್ಯಾಂಡ್‌");
    result.put("ZMK", "ಜಾಂಬಿಯಾ ಕ್ವಾಚ");
    return result;
  }
}
