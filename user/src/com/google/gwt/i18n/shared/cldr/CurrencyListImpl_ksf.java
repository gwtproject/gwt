...
/**
 * Pure Java implementation of CurrencyList for locale "ksf".
 */
public class CurrencyListImpl_ksf extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "mɔni mǝ á mwaritaní");
    ...
    result.put("STD", "mɔni mǝ á saotomɛ́ ri priŋsib");
    ...
    result.put("ZMK", "mɔni mǝ á zambí");
