...
/**
 * Pure Java implementation of CurrencyList for locale "ksh".
 */
public class CurrencyListImpl_ksh extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("ARS", "ajentiinesche Peesos");
    ...
    result.put("BAM", "öpmtuuschbaa Mark us Boßnije un dä Hächejovvina");
    ...
    result.put("BIF", "burundesche Franke");
    result.put("BMD", "Bermuuda-Dollaa");
    result.put("BND", "Brunei-Dollaaa");
    ...
    result.put("BYR", "wiißrußesche Rubel");
    ...
    result.put("CLP", "schileenesche Peesos");
    result.put("CNY", "schineesesche Yuan Renminbi");
    result.put("COP", "kolumbesche Pesos");
    result.put("CRC", "Kaßtarikaanesche Colón");
    ...
    result.put("DJF", "Franke uß Dschibuti");
    ...
    result.put("HRK", "korwaatesche Kuna");
    ...
    result.put("KMF", "kommooresche Frangke");
    ...
    result.put("KZT", "kasakstaanesche Tenge");
    result.put("LAK", "loaatesche Kip");
    result.put("LBP", "libaneesesche Pongk");
    result.put("LKR", "schri-lankesche Ruupije");
    ...
    result.put("MRO", "mauretanesche Ouguiya");
    ...
    result.put("PEN", "perruaanesche Nuevo Sol");
    ...
    result.put("STD", "Dobra vun São Tomé un Príncipe");
    ...
    result.put("VEF", "venezuelaanesche Bolívar");
    ...
    result.put("ZMK", "sambesche Kwacha");
