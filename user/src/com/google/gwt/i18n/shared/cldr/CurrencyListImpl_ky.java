...
/**
 * Pure Java implementation of CurrencyList for locale "ky".
 */
public class CurrencyListImpl_ky extends CurrencyListImpl {

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("KGS", new CurrencyDataImpl("KGS", "сом", 2, "сом", "KGS"));
    return result;
  }
