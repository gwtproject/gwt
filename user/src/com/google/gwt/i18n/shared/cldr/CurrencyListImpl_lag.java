...
/**
 * Pure Java implementation of CurrencyList for locale "lag".
 */
public class CurrencyListImpl_lag extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ungwíiya ya Moritánia");
    ...
    result.put("STD", "Dóbura ya SaoTóome na Pirínsipe");
    ...
    result.put("ZMK", "Kwácha ya Sámbia");
