...
/**
 * Pure Java implementation of CurrencyList for locale "lg".
 */
public class CurrencyListImpl_lg extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Wugwiya ey'eMawritenya");
    ...
    result.put("STD", "Dobura ey'eSantome ne Purincipe");
    ...
    result.put("ZMK", "Kwaca ey'eZambya");
