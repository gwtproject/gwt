...
/**
 *  * Pure Java implementation of CurrencyList for locale "ln".
 */
public class CurrencyListImpl_ln extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("CDF", "CDF", 2, "CDF", "FrCD");
  }
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ugwiya ya Moritani");
    ...
    result.put("STD", "Dobra ya Sao Tomé mpé Presipe");
    ...
    result.put("ZMK", "Kwasha ya Zambi");
