...
/**
 * Pure Java implementation of CurrencyList for locale "lu".
 */
public class CurrencyListImpl_lu extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ugwiya wa Moritani");
    ...
    result.put("STD", "Dobra wa Sao Tome ne Presipe");
    ...
    result.put("ZMK", "Kwasha wa Zambi");
