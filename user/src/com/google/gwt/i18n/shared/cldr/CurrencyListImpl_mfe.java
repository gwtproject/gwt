...
/**
 * Pure Java implementation of CurrencyList for locale "mfe".
 */
public class CurrencyListImpl_mfe extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MUR", "MUR", 0, "MUR", "Rs");
  }
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "ouguiya moritanien");
    ...
    result.put("STD", "dobra santomeen");
