...
/**
 * Pure Java implementation of CurrencyList for locale "mg".
 */
public class CurrencyListImpl_mg extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("MGA", "MGA", 0, "MGA", "Ar");
  }
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ouguiya moritanianina");
    ...
    result.put("ZMK", "Kwacha zambianina");
