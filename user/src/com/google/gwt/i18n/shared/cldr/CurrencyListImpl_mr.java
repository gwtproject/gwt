...
/**
 *  * Pure Java implementation of CurrencyList for locale "mr".
 */
public class CurrencyListImpl_mr extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("DZD", "अल्जेरियन दीनार");
    result.put("EGP", "इजिप्शियन पाउंड");
    result.put("ERN", "इरिट्रिया नाफ्का");
    result.put("ETB", "इथिओपियन बियर");
    result.put("EUR", "यूरो");
    result.put("FJD", "फिजीचा डॉलर");
    result.put("FKP", "फॉकलंड आयलंड पाउंड");
    result.put("GBP", "ब्रिटिश पाऊंड स्टर्लिंग");
    result.put("GEL", "जॉर्दियन लारी");
    result.put("GHS", "घानाचा सेडी");
    result.put("GIP", "जीब्राल्टर पाउंड");
    ...
    result.put("PEN", "पेरुवियन नुइव्हो सोल");
    result.put("PGK", "पापुआ न्यू गिनीचे किना");
    result.put("PHP", "फिलीपिनी पेसो");
    result.put("PKR", "पाकिस्तानी रुपया");
    result.put("PLN", "जोलिस झ्लॉटी");
    result.put("PYG", "पराग्वे गुआरानी");
    result.put("QAR", "कतारी रियाल");
    result.put("RSD", "सर्बियन दिनार");
    result.put("RUB", "रशियान रुबल");
    result.put("RWF", "रवांडा फ्रँक");
    result.put("SAR", "सौदी रियाल");
    result.put("SBD", "सोलोमन आयलँड्स");
    result.put("SCR", "सेशेलुआन रुपी");
    result.put("SDG", "सुदानी पौंड");
    result.put("SEK", "स्वीडिश क्रोन");
    result.put("SGD", "सिंगापूर डॉलर");
    result.put("SHP", "सेंट हेलेना पौंड");
    result.put("SLL", "सिएरा लिऑनचा लिऑन");
    result.put("SOS", "सोमाली शिलिंग");
    result.put("SRD", "सुरिनामी डॉलर");
    result.put("STD", "साओ टोम आणि प्रिन्सिपे डोबरा");
    result.put("SYP", "सीरियन पाउंड");
    result.put("SZL", "स्वाझी लीलांगेनी");
    result.put("THB", "थाई बाह्त");
    result.put("TJS", "ताजकीस्तानचा सोमोनी");
    result.put("TMT", "तुर्कमेनिस्तानी मानाट");
    result.put("TND", "ट्यूनिसियन दीनार");
    result.put("TOP", "टोंगा पाआंगा");
    ...
    result.put("UAH", "यूक्रेनियन हरिन्या");
    result.put("UGX", "युगांडा शिलिंग");
    result.put("USD", "यूएस डॉलर");
    result.put("UYU", "उरुग्वेचा पेसो");
    result.put("UZS", "उझबेकिस्तान सॉम");
    result.put("VEF", "व्हेनेझुएला बोलिव्हार");
    result.put("VND", "व्हिएतनामी डोंग");
    result.put("VUV", "वानाटु वाटु");
    result.put("WST", "सामोआ का टाला");
    result.put("XAF", "CFA फ्रँक BEAC");
    result.put("XCD", "पूर्व करीबियन डॉलर");
    result.put("XOF", "CFA फ्रँक BCEAO");
    result.put("XPF", "सीएफपी फ्रँक");
    result.put("XXX", "अज्ञात चलन");
    result.put("YER", "येमेनी रियाल");
    result.put("ZAR", "दक्षिण अफ्रिकी रँड");
    result.put("ZMK", "झांबियन क्वाचा");
    return result;
  }
}
