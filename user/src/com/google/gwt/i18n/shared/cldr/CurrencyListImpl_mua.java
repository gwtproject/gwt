...
/**
 * Pure Java implementation of CurrencyList for locale "mua".
 */
public class CurrencyListImpl_mua extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Solai Mauritaniya");
