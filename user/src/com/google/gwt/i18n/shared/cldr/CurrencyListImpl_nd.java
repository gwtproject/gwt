...
/**
 *  * Pure Java implementation of CurrencyList for locale "nd".
 */
public class CurrencyListImpl_nd extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ugwiya yase Moritaniya");
    ...
    result.put("STD", "Dobra yase Sao Tome lo Principe");
    ...
    result.put("ZMK", "Kwacha yase Zambiya");
