...
/**
 * Pure Java implementation of CurrencyList for locale "nmg".
 */
public class CurrencyListImpl_nmg extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("STD", "Mɔn Sao tomé na prinship");
