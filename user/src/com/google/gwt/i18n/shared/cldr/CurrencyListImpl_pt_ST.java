...
/**
 *  * Pure Java implementation of CurrencyList for locale "pt_ST".
 */
public class CurrencyListImpl_pt_ST extends CurrencyListImpl_pt {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("STD", "Db", 0, "Db", "Db");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("STD", new CurrencyDataImpl("STD", "Db", 0, "Db", "Db"));
