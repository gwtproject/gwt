...
/**
 *  * Pure Java implementation of CurrencyList for locale "rn".
 */
public class CurrencyListImpl_rn extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ugwiya ryo muri Moritaniya");
    ...
    result.put("STD", "Idobura ryo muri Sawotome na Perensipe");
    ...
    result.put("ZMK", "Ikwaca ryo muri Zambiya");
