...
/**
 *  * Pure Java implementation of CurrencyList for locale "rof".
 */
public class CurrencyListImpl_rof extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "heleri sa Moritania");
    ...
    result.put("STD", "heleri sa Sao Tome na Principe");
    ...
    result.put("ZMK", "heleri sa Zambia");
