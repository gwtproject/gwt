...
/**
 *  * Pure Java implementation of CurrencyList for locale "sbp".
 */
public class CurrencyListImpl_sbp extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ihela ya Molitaniya");
    ...
    result.put("STD", "Ihela ya Sao Tome ni Pilinsipe");
    ...
    result.put("ZMK", "Ihela ya Sambiya");
