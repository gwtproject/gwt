...
/**
 *  * Pure Java implementation of CurrencyList for locale "ses".
 */
public class CurrencyListImpl_ses extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Mooritaani Ugiya");
    ...
    result.put("STD", "Sao Tome nda Prinsipe Dobra");
