...
/**
 * Pure Java implementation of CurrencyList for locale "shi_Tfng".
 */
public class CurrencyListImpl_shi_Tfng extends CurrencyListImpl_shi {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "ⵓⵇⵉⵢⵢⴰ ⵏ ⵎⵓⵕⵉⵟⴰⵏⵢⴰ");
    ...
    result.put("STD", "ⴰⴷⵓⴱⵔⴰ ⵏ ⵙⴰⵏⵟⵓⵎⵉ");
    ...
    result.put("ZMK", "ⴰⴽⵡⴰⵛⴰ ⵏ ⵣⴰⵎⴱⵢⴰ");
