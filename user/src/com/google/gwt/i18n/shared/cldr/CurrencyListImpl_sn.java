...
/**
 * Pure Java implementation of CurrencyList for locale "sn".
 */
public class CurrencyListImpl_sn extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ugwiya ye Moritania");
    ...
    result.put("STD", "Dobra re Sao Tome ne Principe");
    ...
    result.put("ZMK", "Kwacha ye Zambia");
