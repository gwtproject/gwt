...
/**
 * Pure Java implementation of CurrencyList for locale "sq".
 */
public class CurrencyListImpl_sq extends CurrencyListImpl {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("ALL", "Lek", 0, "Lek", "Lek");
  }

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("ALL", new CurrencyDataImpl("ALL", "Lek", 0, "Lek", "Lek"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("CNY", "Renminbi(Yuan) Kinez");
    result.put("EUR", "Euro");
    result.put("GBP", "Paund Sterlina Britanike");
    result.put("INR", "Rupee indiane");
    result.put("JPY", "Jeni Japonez");
    result.put("RUB", "Rubla ruse");
    result.put("USD", "Dollar amerikan");
    return result;
  }
}
