...
/**
 * Pure Java implementation of CurrencyList for locale "sr_Cyrl".
 */
public class CurrencyListImpl_sr_Cyrl extends CurrencyListImpl_sr {

  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("RSD", "дин.", 0, "дин.", "din");
  }
