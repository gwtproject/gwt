...
/**
 *  * Pure Java implementation of CurrencyList for locale "sw".
 */
public class CurrencyListImpl_sw extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("TZS", "TSh", 0, "TSh", "TSh");
  }
  ...
  protected Map<String, CurrencyData> loadCurrencies() {
    ...
    result.put("TZS", new CurrencyDataImpl("TZS", "TSh", 0, "TSh", "TSh"));
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AFN", "Afghani ya Afuganistani");
    ...
    result.put("ARS", "Peso ya Ajentina");
    result.put("AUD", "dola ya Australia");
    result.put("AWG", "Florin ya Aruba");
    result.put("AZN", "Manat ya Azebaijan");
    result.put("BAM", "Mark ya Bosnia na Hezegovina Inayoweza Kubadilishwa");
    ...
    result.put("BYR", "Ruble ya Belarusi");
    ...
    result.put("COP", "Peso ya Kolombia");
    result.put("CRC", "Colon ya Kostarika");
    result.put("CUC", "Peso ya Cuba Inayoweza Kubadilishwa");
    result.put("CUP", "Peso ya Cuba");
    result.put("CVE", "eskudo ya Kepuvede");
    result.put("CZK", "Koruna ya Jamhuri ya Cheki");
    result.put("DJF", "faranga ya Jibuti");
    result.put("DKK", "Krone ya Denmaki");
    result.put("DOP", "Peso ya Dominika");
    ...
    result.put("GNF", "Franc ya Guinea");
    ...
    result.put("HRK", "Kuna ya Kroeshia");
    result.put("HTG", "Gourde ya Haiti");
    result.put("HUF", "Forint ya Hangaria");
    result.put("IDR", "Rupiah ya Indonesia");
    result.put("ILS", "Sheqel Mpya ya Israeli");
    result.put("INR", "rupia ya India");
    result.put("IQD", "Dinari ya Irak");
    result.put("IRR", "Rial ya Iran");
    result.put("ISK", "Króna ya Iceland");
    result.put("JMD", "Dola ya Jamaica");
    result.put("JOD", "Dinar ya Yordani");
    result.put("JPY", "sarafu ya Kijapani");
    result.put("KES", "shilingi ya Kenya");
    result.put("KGS", "Som ya Kirigistani");
    result.put("KHR", "Riel ya Kambodia");
    ...
    result.put("KZT", "Tenge ya Kazakistani");
    result.put("LAK", "Kip ya Laosi");
    result.put("LBP", "Pauni ya Lebanon");
    result.put("LKR", "Rupee ya Sri Lanka");
    ...
    result.put("MKD", "Denar ya Masedonia");
    result.put("MMK", "Kyat ya Myama");
    result.put("MNT", "Tugrik ya Mongolia");
    result.put("MOP", "Pataca ya Macau");
    result.put("MRO", "ugwiya ya Moritania");
    result.put("MUR", "rupia ya Morisi");
    result.put("MVR", "Rufiyaa ya Maldivi");
    result.put("MWK", "kwacha ya Malawi");
    result.put("MXN", "Peso ya Meksiko");
    ...
    result.put("NIO", "Córdoba ya Nikaragua");
    result.put("NOK", "Krone ya Norwe");
    result.put("NPR", "Rupee ya Nepali");
    result.put("NZD", "Dola ya Nyuzilandi");
    result.put("OMR", "Rial ya Oman");
    result.put("PAB", "Balboa ya Panama");
    result.put("PEN", "Nuevo Sol ya Peru");
    result.put("PGK", "Kina ya Papua New Guinea");
    result.put("PHP", "Peso ya Ufilipino");
    result.put("PKR", "Rupee ya Pakistan");
    result.put("PLN", "Zloty ya Polandi");
    result.put("PYG", "Guarani ya Paragwai");
    result.put("QAR", "Rial ya Katari");
    ...
    result.put("UAH", "Hryvnia ya Ukrania");
    result.put("UGX", "shilingi ya Uganda");
    result.put("USD", "dola ya Marekani");
    result.put("UYU", "Peso ya Urugwai");
    result.put("UZS", "Som ya Uzibekistani");
    result.put("VEF", "Bolivar ya Venezuela");
    result.put("VND", "Dong ya Kivietinamu");
    result.put("VUV", "Vatu ya Vanuatu");
    result.put("WST", "Tala ya Samoa");
    result.put("XAF", "faranga CFA BEAC");
    result.put("XCD", "Dola ya Karibea ya Mashariki");
    result.put("XOF", "faranga CFA BCEAO");
    result.put("XPF", "Franc ya CFP");
    result.put("XXX", "Fedha Isiyojulikana");
    result.put("YER", "Rial ya Yemen");
    result.put("ZAR", "randi ya Afrika Kusini");
    result.put("ZMK", "kwacha ya Zambia");
