...
/**
 * Pure Java implementation of CurrencyList for locale "teo".
 */
public class CurrencyListImpl_teo extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ango'otol lok' Moritania");
    ...
    result.put("STD", "Ango'otol lok' Sao Tome na Principe");
    ...
    result.put("ZMK", "Ango'otol lok' Zambia");
