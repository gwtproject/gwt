...
/**
 * Pure Java implementation of CurrencyList for locale "tg".
 */
public class CurrencyListImpl_tg extends CurrencyListImpl {

  @Override
  protected Map<String, CurrencyData> loadCurrencies() {
    Map<String, CurrencyData> result = super.loadCurrencies();
    result.put("TJS", new CurrencyDataImpl("TJS", "сом", 2, "сом", "Som"));
    return result;
  }
