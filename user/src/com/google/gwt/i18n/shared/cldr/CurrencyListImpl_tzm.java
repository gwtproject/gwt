...
/**
 * Pure Java implementation of CurrencyList for locale "tzm".
 */
public class CurrencyListImpl_tzm extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("EUR", "Uṛu");
    result.put("GBP", "Junih Usterlini Ubriṭani");
    ...
    result.put("MRO", "Uqiyya Umuritani");
