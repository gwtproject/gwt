...
/**
 *  * Pure Java implementation of CurrencyList for locale "vai_Latn".
 */
public class CurrencyListImpl_vai_Latn extends CurrencyListImpl_vai {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("EUR", "Yuro");
    result.put("GBP", "Jengési Pɔɔ̃ Sitɛ́liŋ");
    ...
    result.put("MRO", "Mɔretani Yugiya");
    ...
    result.put("STD", "Sawo Tombe ɓɛ a Gbawo Dobura");
    ...
    result.put("ZMK", "Zambiya Kuwacha");
