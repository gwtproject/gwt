...
/**
 *  * Pure Java implementation of CurrencyList for locale "vi".
 */
public class CurrencyListImpl_vi extends CurrencyListImpl {
  
  @Override
  public CurrencyData getDefault() {
    return new CurrencyDataImpl("VND", "₫", 24, "₫", "₫");
  }
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("AED", "Điram UAE");
    result.put("AFN", "Đồng afghani của Afghanistan");
    result.put("ALL", "Đồng lek của Albani");
    result.put("AMD", "Đồng dram của Armenia");
    result.put("ANG", "Đồng guilder của Antille thuộc Hà Lan");
    result.put("AOA", "Đồng kwanza của Angola");
    result.put("ARS", "Đồng peso của Argentina");
    result.put("AUD", "Đồng đô la của Úc");
    result.put("AWG", "Đồng florin của Aruba");
    result.put("AZN", "Đồng manat của Azerbaijan");
    result.put("BAM", "Đồng mác có thể chuyển đổi của Bosnia-Herzegovina");
    result.put("BBD", "Đồng đô la của Barbadia");
    result.put("BDT", "Đồng taka của Bangladesh");
    result.put("BGN", "Lép Bungari");
    result.put("BHD", "Đồng dinar của Bahrain");
    result.put("BIF", "Đồng franc của Burundi");
    result.put("BMD", "Đồng đô la Bermuda");
    result.put("BND", "Đồng đô la của Brunei");
    result.put("BOB", "Đồng boliviano của Bolivia");
    result.put("BRL", "Real Braxin");
    result.put("BSD", "Đồng đô la của Bahamia");
    result.put("BTN", "Đồng ngultrum của Bhutan");
    result.put("BWP", "Đồng pula của Botswana");
    result.put("BYR", "Đồng rúp của Belarus");
    result.put("BZD", "Đồng đô la của Belize");
    result.put("CAD", "Đồng đô la của Canada");
    result.put("CDF", "Đồng franc của Congo");
    result.put("CHF", "Franc Thụy sĩ");
    result.put("CLP", "Đồng Peso của Chile");
    result.put("CNY", "Yuan Trung Quốc");
    result.put("COP", "Đồng Peso của Colombia");
    result.put("CRC", "Đồng colón của Costa Rica");
    result.put("CUC", "Đồng peso có thể chuyển đổi của Cuba");
    result.put("CUP", "Đồng peso của Cu Ba");
    result.put("CVE", "Đồng escudo của Cape Verde");
    result.put("CZK", "Đồng curon của cộng hòa Séc");
    result.put("DJF", "Đồng franc của Djibouti");
    result.put("DKK", "Đồng curon của Đan Mạch");
    result.put("DOP", "Đồng peso của Dominica");
    result.put("DZD", "Đồng dina của Algeri");
    result.put("EEK", "Crun Extônia");
    result.put("EGP", "Đồng bảng của Ai Cập");
    result.put("ERN", "Đồng nakfa của Eritrea");
    result.put("ETB", "Đồng birr của Ethiopia");
    result.put("EUR", "Euro");
    result.put("FJD", "Đô-la Fi-ji");
    result.put("FKP", "Đồng bảng của quần đảo Falkland");
    ...
    result.put("GIP", "Pao Gibraltar");
    result.put("GMD", "Đồng dalasi của Gambia");
    ...
    result.put("HRK", "Đồng kuna của Croatia");
    result.put("HTG", "Gourde Haiti");
    result.put("HUF", "Phôrin Hungari");
    result.put("IDR", "Rupia Inđônêxia");
    result.put("IEP", "Pao Ai-len");
    result.put("ILP", "Pao Ixraen");
    result.put("ILS", "Sêken Ixraen");
    result.put("INR", "Rupi Ấn Độ");
    result.put("IQD", "Dinar I-rắc");
    result.put("IRR", "Rial I-ran");
    result.put("ISK", "Đồng curon của Iceland");
    result.put("ITL", "Lia Ý");
    result.put("JMD", "Đô la Jamaica");
    result.put("JOD", "Dinar Jordan");
    result.put("JPY", "Yên Nhật");
    result.put("KES", "Si-ling Kê-ny-a");
    result.put("KGS", "Đồng som của Kyrgystan");
    result.put("KHR", "Riên Campuchia");
    result.put("KMF", "Đồng franc của Comoros");
    result.put("KPW", "Đồng Won Triều Tiên");
    result.put("KRW", "Won Hàn Quốc");
    result.put("KWD", "Đồng dina của Kuwait");
    result.put("KYD", "Đô la Quần đảo Cayman");
    result.put("KZT", "Kazakhstan Tenge");
    result.put("LAK", "Đồng kíp của Lào");
    result.put("LBP", "Đồng bảng của Li Băng");
    result.put("LKR", "Đồng rupi của Sri Lanka");
    result.put("LRD", "Đô la Liberia");
    result.put("LSL", "Đồng loti của Lesotho");
    result.put("LTL", "Litat Lituani");
    result.put("LVL", "Đồng lats của Latvia");
    result.put("LYD", "Đồng dinar của Libi");
    result.put("MAD", "Điaham Marốc");
    result.put("MDL", "Đồng leu của Moldova");
    result.put("MGA", "Đồng Ariary của Malagasy");
    result.put("MKD", "Đồng dena của Macedonia");
    result.put("MMK", "Đồng kyat của Myanma");
    result.put("MNT", "Đồng tugrik của Mông Cổ");
    result.put("MOP", "Đồng pataca của Ma Cao");
    result.put("MRO", "Đồng ouguiya của Mauritania");
    result.put("MTL", "Lia xứ Man-tơ");
    result.put("MUR", "Đồng rupi của Mauritius");
    result.put("MVR", "Đồng rufiyaa của Maldives");
    result.put("MWK", "Đồng kwacha của Malawi");
    result.put("MXN", "Peso Mêhicô");
    result.put("MYR", "Rinhgit Malaixia");
    result.put("NAD", "Đồng đô la của Namibia");
    result.put("NGN", "Đồng naira của Nigeria");
    result.put("NIO", "Đồng córdoba của Nicaragua");
    result.put("NOK", "Curon Na Uy");
    result.put("NPR", "Đồng rupi của Nepal");
    result.put("NZD", "Đô-la New Zealand");
    result.put("OMR", "Đồng rial của Oman");
    result.put("PAB", "Đồng balboa của Panama");
    result.put("PEN", "Nuevo Sol Pêru");
    result.put("PGK", "Đồng kina của Papua New Guinean");
    result.put("PHP", "Peso Philíppin");
    result.put("PKR", "Rupi Pakistan");
    result.put("PLN", "Zloty Ba Lan");
    result.put("PYG", "Đồng guarani của Paraguay");
    result.put("QAR", "Đồng rial của Qatari");
    result.put("RON", "Lây Rumani");
    result.put("RSD", "Đina Xéc-bi");
    result.put("RUB", "Rúp Nga");
    result.put("RWF", "Đồng franc của Rwanda");
    result.put("SAR", "Rian Ả rập Xêút");
    result.put("SBD", "Đô la quần đảo Solomon");
    result.put("SCR", "Đồng rupi của Seychelles");
    result.put("SDG", "Đồng bảng của Sudan");
    result.put("SEK", "Cua-ron Thuỵ Điển");
    result.put("SGD", "Đô-la Singapore");
    result.put("SHP", "Đồng bảng của Saint Helena");
    result.put("SIT", "Tôla Xlôvênia");
    result.put("SKK", "Cuaron Xlôvác");
    result.put("SLL", "Đồng leone của Sierra Leone");
    result.put("SOS", "Đồng shilling của Somali");
    result.put("SRD", "Đồng đô la của Suriname");
    result.put("STD", "Đồng dobra của São Tomé và Príncipe");
    result.put("SYP", "Đồng bảng của Syria");
    result.put("SZL", "Đồng Lilangeni của Swazi");
    result.put("THB", "Bạt Thái Lan");
    result.put("TJS", "Đồng somoni của Tajikistan");
    result.put("TMT", "Đồng manat của Turkmenistan");
    result.put("TND", "Đồng dinar của Tunisia");
    result.put("TOP", "Đồng paʻanga của Tonga");
    result.put("TRL", "Lia Thổ Nhĩ Kỳ");
    result.put("TRY", "Lia Thổ Nhĩ Kỳ Mới");
    result.put("TTD", "Đồng đô la của Trinidad và Tobago");
    result.put("TWD", "Đô-la Đài Loan");
    result.put("TZS", "Đồng shilling của Tanzania");
    result.put("UAH", "Rúp U-crai-na");
    result.put("UGX", "Đồng shilling của Uganda");
    result.put("USD", "Đô-la Mỹ");
    result.put("UYU", "Đồng peso của Uruguay");
    result.put("UZS", "Đồng som của Uzbekistan");
    result.put("VEB", "Bôliva Vênêduêla");
    result.put("VEF", "Đồng bolívar của Venezuela");
    result.put("VND", "Đồng");
    result.put("VUV", "Đồng vatu của Vanuatu");
    result.put("WST", "Đồng tala của Samoa");
    result.put("XAF", "Đồng CFA Franc BEAC");
    result.put("XAU", "Vàng");
    result.put("XCD", "Đồng đô là của phía đông Caribê");
    result.put("XOF", "Franc CFA BCEAO");
    result.put("XPF", "Đồng Franc Thái Bình Dương");
    result.put("XXX", "Tiền tệ chưa biết hoặc không hợp lệ");
    result.put("YER", "Đồng rial của Yemen");
    result.put("ZAR", "Ran Nam Phi");
    result.put("ZMK", "Đồng kwacha của Zambia");
    return result;
  }
}
