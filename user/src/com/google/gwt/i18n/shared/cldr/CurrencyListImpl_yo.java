...
/**
 *  * Pure Java implementation of CurrencyList for locale "yo".
 */
public class CurrencyListImpl_yo extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("MRO", "Ouguiya ti Orílẹ́ède Maritania");
    ...
    result.put("STD", "Dobira ti Orílẹ́ède Sao tome Ati Pirisipe");
    ...
    result.put("ZMK", "Kawaṣa ti Orílẹ́ède Saabia");
