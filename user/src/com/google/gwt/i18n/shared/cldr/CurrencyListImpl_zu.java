...
/**
 *  * Pure Java implementation of CurrencyList for locale "zu".
 */
public class CurrencyListImpl_zu extends CurrencyListImpl {
  ...
  protected Map<String, String> loadCurrencyNames() {
    ...
    result.put("BYR", "i-Belarusian Ruble");
    ...
    result.put("GBP", "i-British Pound Sterling");
    ...
    result.put("MRO", "i-Mauritanian Ouguiya");
    ...
    result.put("STD", "i-São Tomé kanye ne-Príncipe Dobra");
    ...
    result.put("TTD", "Idola lase-Trinidad nase-Tobago");
