...
/**
 * Locale information for the "en_Dsrt" locale.

 */
public class LocaleInfoImpl_en_Dsrt extends LocaleInfoImpl_en {
  ...
  protected DateTimeFormatInfo createDateTimeFormatInfo() {
    return new com.google.gwt.i18n.shared.cldr.DateTimeFormatInfoImpl_en_Dsrt();
  }
  
  @Override
  protected LocaleDisplayNames createLocaleDisplayNames() {
    return new com.google.gwt.i18n.shared.cldr.LocaleDisplayNamesImpl_en_Dsrt();
  }
  
  @Override
  protected LocalizedNames createLocalizedNames() {
    return new com.google.gwt.i18n.shared.cldr.LocalizedNamesImpl_en_Dsrt();
  }
}
