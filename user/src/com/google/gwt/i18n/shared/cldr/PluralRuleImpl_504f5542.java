 ...
 */
public class PluralRuleImpl_504f5542 extends VariantSelectorBase {
  
  public PluralRuleImpl_504f5542() {
  ...
  public String getFormDescription(VariantForm form) {
    switch (form) {
      ...
      case MANY:
        return "n mod 10 is 0 or n mod 10 in 5..9 or n mod 100 in 11..14";
      case ONE:
  ...
  public VariantForm select(double n) {
    ...
    if (((n10 == 0) || ((n - (long) n == 0.0) && (n10 >= 5 && n10 <= 9))) || ((n - (long) n == 0.0) && (n100 >= 11 && n100 <= 14))) {
