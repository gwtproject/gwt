 ...
 *   mt
 */
public class PluralRuleImpl_mt extends VariantSelectorBase {
  
  public PluralRuleImpl_mt() {
  ...
  public String getFormDescription(VariantForm form) {
    switch (form) {
      case FEW:
        return "n is 0 or n mod 100 in 2..10";
      case MANY:
        return "n mod 100 in 11..19";
      case ONE:
        return "n is 1";
      default:
  ...
  public VariantForm select(double n) {
    double n100 = n % 100;
    if ((n == 0) || ((n - (long) n == 0.0) && (n100 >= 2 && n100 <= 10))) {
      return VariantForm.FEW;
    }
    if ((n - (long) n == 0.0) && (n100 >= 11 && n100 <= 19)) {
