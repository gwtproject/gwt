...
/**
 * Implementation of {@link DateTimeFormat}.
 */
public class DateTimeFormatImpl implements DateTimeFormat {
   ...
   */
  static boolean usesFixedEnglishStrings(PredefinedFormat predef) {
    switch (predef) {
      case RFC_2822:
        return true;
      case ISO_8601:
   ...
   */
  protected DateTimeFormatImpl(String pattern, DateTimeFormatInfo dtfi) {
