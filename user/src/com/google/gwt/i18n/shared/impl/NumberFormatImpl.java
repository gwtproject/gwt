 ...
 *
 * @Deprecated - use {@link com.google.gwt.i18n.shared.NumberFormatFactory}
 * instead.
 */
public class NumberFormatImpl implements NumberFormat {
   ...
   */
  protected static CurrencyData lookupCurrency(String currencyCode) {
    LocaleInfo localeInfo = GWT.create(LocaleInfo.class);
    CurrencyData currencyData = localeInfo.getCurrencyList().lookup(currencyCode);
  ...
  private static String toPrecision(double d, int digits) {
    return NumberFormatHelper.toPrecision(d, digits);
  }
   ...
   */
  protected NumberFormatImpl(NumberConstants numberConstants, String pattern, CurrencyData cdata,
  ...
  /**
   * Copy constructor used for overriding the min/max fraction digits.
   * 
   * @param copy
   * @param minFractionDigits
   * @param maxFractionDigits
   */
  private NumberFormatImpl(NumberFormatImpl copy, int minFractionDigits, int maxFractionDigits) {
    currencyData = copy.currencyData;
    decimalSeparatorAlwaysShown = copy.decimalSeparatorAlwaysShown;
    groupingSize = copy.groupingSize;
    isCurrencyFormat = copy.isCurrencyFormat;
    maximumFractionDigits = maxFractionDigits;
    maximumIntegerDigits = copy.maximumIntegerDigits;
    minExponentDigits = copy.minExponentDigits;
    minimumFractionDigits = minFractionDigits;
    minimumIntegerDigits = copy.minimumIntegerDigits;
    multiplier = copy.multiplier;
    negativePrefix = copy.negativePrefix;
    negativeSuffix = copy.negativeSuffix;
    numberConstants = copy.numberConstants;
    pattern = copy.pattern;
    positivePrefix = copy.positivePrefix;
    positiveSuffix = copy.positiveSuffix;
    useExponentialNotation = copy.useExponentialNotation;
  }
  ...
  public NumberFormat overrideFractionDigits(int minDigits, int maxDigits) {
    ...
    return new NumberFormatImpl(this, minDigits, maxDigits);
  }
