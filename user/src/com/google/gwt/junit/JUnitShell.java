...
public class JUnitShell extends DevMode {
  ...
  static class ArgProcessor extends ArgProcessorBase {
    ...
    public ArgProcessor(final JUnitShell shell) {
      ...
      // deprecated -out argument. Still present for backward compatibility because tools using it.
      // will be totally removed in a future release.
      registerHandler(new ArgHandler() {
        @Override
        public String getPurpose() {
          return "Don't use -out argument. This option is not used anymore and is still present " +
              "for backward compatibility only. This option will be removed in future GWT " +
