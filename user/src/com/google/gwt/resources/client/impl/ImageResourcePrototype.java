...
public class ImageResourcePrototype implements ImageResource {
  ...
  /**
   * Marker class for {@link ImageResourcePrototype} for standalone images.
   */
  public static class Standalone extends ImageResourcePrototype {
    public Standalone(String name, SafeUri url, int left, int top, int width, int height,
