...
public class InterfaceGenerator extends ToolBase {
  ...
  private String process() throws MalformedURLException,
    ...
    names.addAll(new ClassNamesCollector().getClassNames(cssTree, Sets.newHashSet()));
  ...
  /**
   * In GSS, constants namre are defined in upper case but the method name to access a constant in
   * a CssResource interface can be written in lower camel case.
   * <p>
   * This method converts all contants name in lower camel case identifier.
   *
   */
