...
/**
 * Visitor that converts the ast in a String chain. This string will contain the needed java code
 * that will be used to build the final css at runtime.
 */
public class CssPrinter extends CompactPrinter {
  ...
  private static final String CONTATENATION_BLOCK = RIGHT_PARENTHESIS + CONTATENATION +
      LEFT_PARENTHESIS;
  private static final String CONDITIONAL_OPERATOR = RIGHT_PARENTHESIS + " ? " +
      LEFT_PARENTHESIS;
