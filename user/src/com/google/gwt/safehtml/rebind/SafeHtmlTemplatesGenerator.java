...
public class SafeHtmlTemplatesGenerator extends Generator {
  ...
  private void writeTemplateMethod(TreeLogger logger, SourceWriter sw, JMethod method)
    ...
    if (!isSafeHtml(method.getReturnType())) {
   ...
   *
   * @param logger the logger to log failures to
   * @param sw the source writer to emit the method body to
  ...
  /**
   * Check if the specified parameter type represents a {@link java.lang.String}.
   *
   * @param parameterType the Java parameter type
   * @return true if the type represents a {@link java.lang.String}
   */
