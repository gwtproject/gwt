 ...
 * {@link com.google.gwt.safehtml.shared.Types} annotation is used in a context where 
 * such an annotation is required (e.g., the return statement of a method that 
 * returns {@code @Types.Html String}).
 * 
