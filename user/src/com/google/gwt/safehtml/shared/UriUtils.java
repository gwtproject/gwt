...
public final class UriUtils {
  ...
  private static final Set<String> NO_EXTRA_ALLOWED_SCHEMES = Collections.emptySet();
  ...
  public static SafeUri fromString(String s) {
    return fromString(s, NO_EXTRA_ALLOWED_SCHEMES);
  }
  ...
  public static boolean isSafeUri(String uri) {
    return isSafeUri(uri, NO_EXTRA_ALLOWED_SCHEMES);
  }
  ...
  public static boolean isSafeUri(String uri, Set<String> extraAllowedSchemes) {
    ...
    String schemeUc = scheme.toUpperCase(Locale.ROOT);

    for (String extraAllowedScheme : extraAllowedSchemes) {

      if (extraAllowedScheme.toLowerCase(Locale.ROOT).equals(schemeLc)) {
        return true;
      }

      if (extraAllowedScheme.toUpperCase(Locale.ROOT).equals(schemeUc)) {
        return true;
      }
    }
  ...
  public static String sanitizeUri(String uri) {
    return sanitizeUri(uri, NO_EXTRA_ALLOWED_SCHEMES);
  }
