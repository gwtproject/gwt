...
public final class UriUtils {
   ...
   *
   * @param uri the URI to validate
   * @param extraAllowedSchemes optional extra allowed schemes (e.g. 'tel')
   * @return {@code true} if {@code uri} is safe in the above sense; {@code
   *         false} otherwise
   */
  public static boolean isSafeUri(String uri, Set<String> extraAllowedSchemes) {
    ...
    if (extraAllowedSchemes != null) {

      for (String extraAllowedScheme : extraAllowedSchemes) {

        if (extraAllowedScheme == null) {
          continue;
        }
