 ...
 *
 * <p>This annotation marks methods in which an  expression without a
 ...
 * returns {@code @IsSafeHtml String}).</p>
 *
 * <p>As such, use of this annotation marks code that is potentially prone to HTML-injection
 *  vulnerabilities, and which hence needs to be carefully security reviewed.</p>
 */
