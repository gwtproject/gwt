...
public class CellTable<T> extends AbstractCellTable<T> implements
  ...
  private boolean colGroupLegacyBehavior = true;
  ...
  public void setColGroupLegacyBehavior(boolean colGroupLegacyBehavior) {
    this.colGroupLegacyBehavior = colGroupLegacyBehavior;
  }
