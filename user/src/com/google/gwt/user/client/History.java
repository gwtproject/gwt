...
public class History {
   ...
   * This is the fallback implementation for browsers that do not support HTML5
   * pushstate.
   */
  ...
  private static class HistoryImplIE8 extends HistoryImplHashToken {
    ...
    public native void attachListener(JavaScriptObject handler) /*-{
      ...
      $wnd.onhashchange = function() {
        ...
        // throw GWT modules exception first
        // helping the current module to find an error
        if (ex != null) {
          throw ex;
        }
        if (oldEx !=null) {
