...
/**
 * Custom field serializer for {@link java.util.LinkedHashSet} for the server (uses reflection).
 */
@SuppressWarnings("rawtypes")
public final class LinkedHashSet_CustomFieldSerializer extends
 CustomFieldSerializer<LinkedHashSet> {
