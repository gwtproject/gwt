...
public class Anchor extends FocusWidget implements HasHorizontalAlignment,
   ...
   */
  public Anchor(SafeHtml html, @IsSafeUrl String href) {
   ...
   * @param href the url to which it will link
   */
  public Anchor(SafeHtml html, Direction dir, @IsSafeUrl String href) {
   ...
   * @param href the url to which it will link
   */
  public Anchor(SafeHtml html, DirectionEstimator directionEstimator, @IsSafeUrl String href) {
  ...
  public Anchor(String text, @IsSafeUrl String href) {
   ...
   */
  @SuppressIsSafeHtmlCastCheck
  public Anchor(String text, Direction dir, @IsSafeUrl String href) {
   ...
   */
  @SuppressIsSafeHtmlCastCheck
  public Anchor(String text, DirectionEstimator directionEstimator, @IsSafeUrl String href) {
   ...
   * @param href the url to which it will link
   */
  public Anchor(@IsSafeHtml String text, boolean asHTML, @IsSafeUrl String href) {
    this();
   ...
   *          window)
   */
  public Anchor(SafeHtml html, @IsSafeUrl String href, String target) {
   ...
   */
  @SuppressIsSafeHtmlCastCheck
  public Anchor(String text, @IsSafeUrl String href, String target) {
   ...
   *          window)
   */
  public Anchor(@IsSafeHtml String text, boolean asHtml, @IsSafeUrl String href, String target) {
   ...
   * @param href the url to which it will link
   */
  private Anchor(@IsSafeHtml String text, boolean asHTML, Direction dir, @IsSafeUrl String href) {
    this();
   ...
   * @param href the anchor's href
   */
  public void setHref(@IsSafeUrl String href) {
    getAnchorElement().setHref(href);
  }
