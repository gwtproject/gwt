...
public abstract class HTMLTable extends Panel implements SourcesTableEvents,
  ...
  private interface HTMLTableImpl {
    JsArray<com.google.gwt.dom.client.Element> getRows(com.google.gwt.dom.client.Element table);
  ...
  private static class HTMLTableStandardImpl implements HTMLTableImpl {
    ...
    public native JsArray<com.google.gwt.dom.client.Element> getRows(
        com.google.gwt.dom.client.Element table) /*-{
      return table.rows;
    }-*/;
  ...
  public class CellFormatter {
    ...
    private Element getCellElement(Element table, int row, int col) {
      return impl.getCells(impl.getRows(table).get(row)).get(col).cast();
    }
  ...
  public class RowFormatter {
    ...
    protected Element getRow(Element elem, int row) {
      return impl.getRows(elem).get(row).cast();
    }
  ...
  private final HTMLTableImpl impl = GWT.create(HTMLTableImpl.class);
  ...
  protected int getDOMRowCount(Element elem) {
    return impl.getRows(elem).length();
  }
  ...
  void addCells(Element table, int row, int num) {
    com.google.gwt.dom.client.Element rowElem = impl.getRows(table).get(row);
    for (int i = 0; i < num; i++) {
