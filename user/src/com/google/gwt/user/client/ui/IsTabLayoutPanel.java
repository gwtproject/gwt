...
public interface IsTabLayoutPanel extends IsWidget2, HasWidgets.ForIsWidget2,
    IndexedPanel.ForIsWidget, ProvidesResize, HasBeforeSelectionHandlers<Integer>,
  ...
  IsWidget2 getTabIsWidget(int index);

  IsWidget2 getTabIsWidget(IsWidget child);
