...
public class TabLayoutPanel extends ResizeComposite implements IsTabLayoutPanel {
   ...
   */
  @Override
  public IsWidget2 getTabIsWidget(int index) {
   ...
   * Convenience overload to allow {@link IsWidget} to be used directly.
   */
  public IsWidget2 getTabIsWidget(IsWidget child) {
  ...
  @Override
  public IsWidget2 getIsWidget(int index) {
  ...
  @Override
  public Iterator<IsWidget2> iteratorIsWidgets() {
