...
public class TextBoxBase extends ValueBoxBase<String> implements
  ...
  public void setPlaceholder(final String placeholder) {
    final String value = (placeholder == null || "".equals(placeholder)) ? "" : placeholder;
    getElement().getStyle().setProperty("placeholder", value);
  }
  ...
  public String getPlaceholder() {
    return getElement().getStyle().getProperty("placeholder");
  }
}
