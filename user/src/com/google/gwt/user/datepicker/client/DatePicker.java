...
public class DatePicker extends Composite implements
  ...
  private int yearsBeforeCurrentInDropdown = DEFAULT_YEARS_TO_DISPLAY;
  private int yearsAfterCurrentInDropdown = DEFAULT_YEARS_TO_DISPLAY;
  private boolean monthDropdownVisible;
  private boolean yearArrowsVisible;
  private boolean yearDropdownVisible;
  ...
  /**
   * Gets the number of year to display before the current year. This number fixes the lower bound
   * of the range of years to display.
   *
   * @return the number of year to display before the current year
   */
  public int getYearsBeforeCurrentInDropdown() {
    return yearsBeforeCurrentInDropdown;
  }

  /**
   * Gets the number of year to display after the current year. This number fixes the upper bound
   * of the range of years to display.
   *
   * @return the number of year to display after the current year
   */
  public int getYearsAfterCurrentInDropdown() {
    return yearsAfterCurrentInDropdown;
  }
  ...
  /**
   * Set the number of year to display after the current year.
   */
  public void setYearsAfterCurrentInDropdown(int numberOfYears) {
    yearsAfterCurrentInDropdown = numberOfYears;
    getMonthSelector().refresh();
  }

  /**
   * Set the number of year to display before the current year.
   */
  public void setYearsBeforeCurrentInDropdown(int numberOfYears) {
    yearsBeforeCurrentInDropdown = numberOfYears;
    getMonthSelector().refresh();
  }

  /**
   * if the <code>monthDropdownVisible</code> is equal to true, the user will be able to change the
   * current month of the date picker via a dropdown list containing the months of the year.
   */
  public void setMonthDropdownVisible(boolean monthDropdownVisible) {
    this.monthDropdownVisible = monthDropdownVisible;
    getMonthSelector().refresh();
  }
  ...
  /**
   * if the <code>yearDropdownVisible</code> is equal to true, the user will be able to change the
   * current month of the date picker via a dropdown list containing a list of years. The range of
   * years to display can be configured via the methods
   * {@link #setYearsBeforeCurrentInDropdown(int)} and {@link #setYearsAfterCurrentInDropdown(int)}.
   */
  public void setYearDropdownVisible(boolean yearDropdownVisible) {
    this.yearDropdownVisible = yearDropdownVisible;
    getMonthSelector().refresh();
  }

  /**
   * if the <code>dropdownVisible</code> is equal to true, the user will be able to change the
   * current month and the current yearof the  date picker via two dropdown lists.
   *
   * @see #setYearDropdownVisible(boolean)
   * @see #setMonthDropdownVisible(boolean)
   */
  public void setYearAndMonthDropdownVisible(boolean dropdownVisible) {
    this.yearDropdownVisible = dropdownVisible;
    this.monthDropdownVisible = dropdownVisible;
    getMonthSelector().refresh();
  }
