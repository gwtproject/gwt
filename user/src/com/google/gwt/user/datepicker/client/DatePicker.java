 ...
 *
 * <li>.datePickerMonth { the year in the month selector widget } <li>
 *
...
public class DatePicker extends Composite implements
  ...
  private static final int DEFAULT_YEARS_TO_DISPLAY = 10;
  ...
  private int numberOfMonthToDisplayBeforeCurrentYear = DEFAULT_YEARS_TO_DISPLAY;
  private int numberOfMonthToDisplayAfterCurrentYear = DEFAULT_YEARS_TO_DISPLAY;
  private boolean monthSelectable;
  private boolean yearNavigationEnabled;
  private boolean yearSelectable;
  ...
  /**
   * Gets the number of year to display before the current year. This number fixes the lower bound of the range
   * of years to display.
   *
   * @return the number of year to display before the current year
   */
  public int getNumberOfMonthToDisplayBeforeCurrentYear() {
    return numberOfMonthToDisplayBeforeCurrentYear;
  }

  /**
   * Gets the number of year to display after the current year. This number fixes the upper bound of the range
   * of years to display.
   *
   * @return the number of year to display after the current year
   */
  public int getNumberOfMonthToDisplayAfterCurrentYear() {
    return numberOfMonthToDisplayAfterCurrentYear;
  }
  ...
  /**
   * Is the month selectable via a dropdown ?
   * @return is the month is selectable
   */
  public boolean isMonthSelectable() {
    return monthSelectable;
  }
  ...
  public boolean isYearNavigationEnabled() {
    return yearNavigationEnabled;
  }

  /**
   * Is the year selectable via a dropdown ?
   * @return is the year is selectable
   */
  public boolean isYearSelectable() {
    return yearSelectable;
  }
  ...
  /**
   * Set the number of year to display after the current year. This number will fix the upper bound of the range
   * of years to display.
   *
   */
  public void setNumberOfMonthToDisplayAfterCurrentYear(int numberOfYears) {
    this.numberOfMonthToDisplayAfterCurrentYear = numberOfYears;
    getMonthSelector().refresh();
  }

  /**
   * Set the number of year to display before the current year. This number will fix the lower bound of the range
   * of years to display.
   *
   */
  public void setNumberOfMonthToDisplayBeforeCurrentYear(int numberOfYears) {
    this.numberOfMonthToDisplayBeforeCurrentYear = numberOfYears;
    getMonthSelector().refresh();
  }

  /**
   * if the month is selectable, the date picker will display a dropdown list containing the months of the year
   *
   * @param selectable
   */
  public void setMonthSelectable(boolean selectable) {
    monthSelectable = selectable;
    getMonthSelector().refresh();
  }
   ...
   */
  public void setYearNavigationEnabled(boolean navigationEnabled) {
    this.yearNavigationEnabled = navigationEnabled;
    getMonthSelector().refresh();
  }

  /**
   * if the year is selectable, the date picker will display a dropdown list containing a list of years. The range of
   * years to display can be configured via the methods {@link #setNumberOfMonthToDisplayBeforeCurrentYear(int)} and
   * {@link #setNumberOfMonthToDisplayAfterCurrentYear(int)}
   *
   * @param selectable
   */
  public void setYearSelectable(boolean selectable) {
    yearSelectable = selectable;
    getMonthSelector().refresh();
  }
