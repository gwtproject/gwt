...
public class DatePicker extends Composite implements
  ...
  private static final int DEFAULT_YEARS_TO_DISPLAY = 21;
  ...
  private int visibleYearCount = DEFAULT_YEARS_TO_DISPLAY;
  ...
  public void setVisibleYearCount(int numberOfYears) {
    assert numberOfYears > 0 : "The number of years must be strictly positive";
