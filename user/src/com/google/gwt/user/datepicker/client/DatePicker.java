...
public class DatePicker extends Composite implements
  ...
  /**
   * Set the number of year to display after the current year. This number will fix the upper bound
   * of the range of years to display.
   *
   */
  ...
  /**
   * Set the number of year to display before the current year. This number will fix the lower bound
   * of the range of years to display.
   *
   */
  ...
  /**
   * if the month is selectable, the date picker will display a dropdown list containing the months
   * of the year
   *
   * @param selectable
   */
  ...
  /**
   * if the year is selectable, the date picker will display a dropdown list containing a list of
   * years. The range of years to display can be configured via the methods
