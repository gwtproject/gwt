...
public class UserAgentPropertyGenerator implements PropertyProviderGenerator {
  ...
  /**
   * The list of <code>user.agent</code> values listed here should be kept in sync with
  ...
  private enum UserAgent {
    ...
    // Although checking for 10+, this will not match IE11+ due to UA string change
