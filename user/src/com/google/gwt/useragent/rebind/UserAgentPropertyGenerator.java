...
public class UserAgentPropertyGenerator implements PropertyProviderGenerator {
  ...
  private enum UserAgent {
    ...
    ie11("return (ua.indexOf('msie') == -1 && (window.ActiveXObject || 'ActiveXObject' in window));"),
    ...
    gecko1_8("return (ua.indexOf('gecko') != -1 && !(window.ActiveXObject || 'ActiveXObject' in window);");
