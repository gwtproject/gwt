...
/**
 * This class is the IE8-9 implementation of the XMLParser interface.
 */
class XMLParserImplIE8To9 extends XMLParserImpl {
  ...
  private static native JavaScriptObject selectDOMDocumentVersion() /*-{
    ...
    throw new Error("XMLParserImplIE8To9.createDocumentImpl: Could not find appropriate version of DOMDocument.");
  }-*/;

  @Override
  protected native JavaScriptObject createDocumentImpl() /*-{
    var doc = @com.google.gwt.xml.client.impl.XMLParserImplIE8To9::selectDOMDocumentVersion()();
  ...
  protected native JavaScriptObject parseImpl(String contents) /*-{
    var doc = this.@com.google.gwt.xml.client.impl.XMLParserImplIE8To9::createDocumentImpl()();
