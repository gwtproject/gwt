...
/**
 * HandlerCollection allows to group many
 * {@link HandlerRegistration HandlerRegistrations} together into one object,
 * that will cancel all event registrations on each individual
 * {@link HandlerRegistration} once
 * {@link HandlerRegistrationCollection#removeHandler()} is called.
 *
 * <p>Note: {@link HandlerRegistration}s are removed once
 * {@link HandlerRegistrationCollection#removeHandler()} is called.
 *
 * A simple example:
 * <code><pre>
...
public class HandlerRegistrationCollection implements HandlerRegistration {
   ...
   * {@link HandlerRegistration HandlerRegistrations}
   * @param handlers the {@link HandlerRegistration HandlerRegistrations} to
