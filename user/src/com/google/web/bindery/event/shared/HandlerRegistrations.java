...
/**
 * A utility class to help deal with {@link HandlerRegistration HandlerRegistrations}.
 */
public class HandlerRegistrations {
   ...
   * 
   * <p>
   * A simple example: <code><pre> * HandlerRegistration hr1 = ... * HandlerRegistration hr2 = ... * return HandlerRegistrationCollection.compose(hr1, hr2); * </pre></code>
   * 
   * @param handlers the {@link HandlerRegistration HandlerRegistrations} that should be composed
