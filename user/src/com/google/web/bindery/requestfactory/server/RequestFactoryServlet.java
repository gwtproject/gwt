...
public class RequestFactoryServlet extends HttpServlet {
  ...
  private void ensureConfig() {
    ...
    String symbolMapsUrl = getServletConfig().getInitParameter("symbolMapsUrl");
    if (symbolMapsUrl != null) {
      try {
        Logging.setStackTraceDeobfuscator(StackTraceDeobfuscator
            .fromUrl(getServletContext().getResource(symbolMapsResource)));
