 ...
 * compiler to construct a one-to-one mapping to the generated JavaScript function and the SAM to be
 * invoked in Java and preserve referential equality.
 ...
 * from improved checking in IDEs.
 */
