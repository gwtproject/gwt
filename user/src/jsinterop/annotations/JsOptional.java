 ...
 *
 * <p>Note that JsOptional can only be used in a JsMethod or a JsFunction method. An optional
 * argument cannot precede a non-optional argument (a vararg is considered an optional argument).
 *
 * <p>This annotation is informational in the GWT compiler but other compilers or tools might use it
 * for example to type annotate the ouptut.
 */
