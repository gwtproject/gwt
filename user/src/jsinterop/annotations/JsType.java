 ...
 * </ul>
 *
 * <p>A name collision needs to be avoided by providing a custom name (e.g. {@link JsProperty#name})
 * or by completely ignoring the member using {@link JsIgnore}.
 *
 * <p>If the JsType is marked as "native", then the type is considered a stub for an existing class
 * that is available in native JavaScript. Unlike non-native JsTypes, all members are considered
 * {@link JsProperty}/{@link JsMethod}/{@link JsConstructor} unless they are explicitly marked with
 * {@link JsOverlay}.
 *
 ...
 * <li>For interfaces native JsTypes, instanceof is forbidden and no checks will be performed on
 *     cast so casts will always succeed.
 * </ul>
 */
