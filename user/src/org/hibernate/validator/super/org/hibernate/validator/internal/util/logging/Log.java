...
public class Log {
  ...
  public IllegalArgumentException getInvalidBigDecimalFormatException(String value, NumberFormatException e){
    return new IllegalArgumentException("" + value + " does not represent a valid BigDecimal format.", e);
  }
}