...
public class ArrayHelper {
  ...
  public static void arrayCopy(Object src, int srcOfs, Object dest, int destOfs,
      int len) {
    arraySplice(src, srcOfs, dest, destOfs, len, true);
  }

  public static void arrayInsert(Object src, int srcOfs, Object dest, int destOfs,
      int len) {
  ...
  private static native boolean nativeIdentity(Object first, Object second) /*-{
    return first === second;
  }-*/;
