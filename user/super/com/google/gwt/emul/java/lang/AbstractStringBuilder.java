...
abstract class AbstractStringBuilder {
  ...
  void replace0(int start, int end, String toInsert) {
    ...
    string = string.nativeSubstring(0, start) + toInsert + string.nativeSubstring(end, len);
  }
  ...
  static String valueOf0(CharSequence cs, int start, int end) {
    return String.valueOf(cs).substring(start, end);
  }
