...
public final class Class<T> implements Type {
  ...
  public static native <T> Class<T> getClassLiteralForArray(Class<?> clazz, int dimensions) /*-{
    return clazz.@java.lang.Class::arrayLiterals[dimensions] ||
        (clazz.@java.lang.Class::arrayLiterals[dimensions] =
        clazz.@java.lang.Class::createClassLiteralForArray(I)(dimensions));
  }-*/;
