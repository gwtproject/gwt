...
public final class Class<T> implements Type {
   ...
   *
   * Arrays are not registered in the metadata table and get the class literal explicitely at
   * construction.<p>
   *
   * @skip
   */
  ...
  /**
   ...
   static native JavaScriptObject getPrototypeForClass(Class<?> clazz) /*-{
     var prototype =
         @com.google.gwt.lang.MetadataUtil::prototypeByTypeId[clazz.@java.lang.Class::typeId];
  ...
  /**
   * null implies non-instantiable type, with no entries in {@link MetadataUtil::prototypeByTypeId}.
   */
   ...
   * placeholder array to differenciate the two cases.
   */
  static native void maybeSetClassLiteral(int typeId, Class<?> clazz) /*-{
    ...
    if (!prototype) {
      ...
      @com.google.gwt.lang.MetadataUtil::prototypeByTypeId[typeId] = [clazz];
      return;
    }
