...
class DevirtualizedDouble {
  ...
  public static double longBitsToDouble(long bits) {
    ...
    if (exp == 0x0) {
      ...
      if (ihi == 0 && ilo == 0) {
        return negative ? DevirtualizedDouble.NEGATIVE_INFINITY : DevirtualizedDouble.POSITIVE_INFINITY;
      } else {
        return DevirtualizedDouble.NaN;
      }
    }
  ...
  public static double parseDouble(String s) throws NumberFormatException {
    return Number.__parseAndValidateDouble(s);
  }
  ...
  public static Double valueOf(String s) throws NumberFormatException {
    return $createDouble(s);
  }


  // Double instance methods
  public static byte byteValue(Double instance) {
    return (byte) doubleValue(instance);
  }

  public static int compareTo(Double instance, Double b) {
    return compare(doubleValue(instance), doubleValue(b));
  }

  public static double doubleValue(Double instance) {
    return doubleValue0(checkNotNull(instance));
  }

  private static native double doubleValue0(Double instance) /*-{
    return instance;
  }-*/;

  public static boolean equals(Double instance, Object o) {
    return equals0(doubleValue(instance), o);
  }

  private static native boolean equals0(double instance, Object o) /*-{
    return instance === o;
  }-*/;

  public static float floatValue(Double instance) {
    return (float) doubleValue(instance);
  }
   ...
   */
  public static int hashCode(Double instance) {
    return hashCode(doubleValue(instance));
  }

  public static int intValue(Double instance) {
    return (int) doubleValue(instance);
  }

  public static boolean isInfinite(Double instance) {
    return isInfinite(doubleValue(instance));
  }

  public static boolean isNaN(Double instance) {
    return isNaN(doubleValue(instance));
  }

  public static long longValue(Double instance) {
    return (long) doubleValue(instance);
  }

  public static short shortValue(Double instance) {
    return (short) doubleValue(instance);
  }

  public static String toString(Double instance) {
    return toString(doubleValue(instance));
  }
  ...
  static Double $createDouble(String s) {
    return $createDouble(DevirtualizedDouble.parseDouble(s));
  }
