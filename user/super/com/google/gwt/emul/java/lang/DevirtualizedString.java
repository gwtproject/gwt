...
/**
 * DevirtualizedString contains the implementation for String.java as static methods.
 */
class DevirtualizedString {

  // CHECKSTYLE_OFF: Utility Methods for creating String instances.

  public static native String $createString() /*-{
    return "";
  }-*/;
  ...
  public static String $createString(byte[] bytes, int ofs, int len) {
    return $createString(bytes, ofs, len, EmulatedCharset.UTF_8);
  }

  public static String $createString(byte[] bytes, int ofs, int len, String charsetName)
      throws UnsupportedEncodingException {
    return $createString(bytes, ofs, len, getCharset(charsetName));
  }

  public static String $createString(byte[] bytes, int ofs, int len, Charset charset) {
  ...
  public static String $createString(char value[], int offset, int count) {
    return valueOf(value, offset, count);
  }

  public static String $createString(int[] codePoints, int offset, int count) {
  ...
  public static String $createString(String other) {
    return other;
  }

  public static String $createString(StringBuffer sb) {
    return valueOf(sb);
  }
  ...
  // CHECKSTYLE_ON: end String instance creation methods
  ...
  public static int codePointAt(String s, int index) {
    return Character.codePointAt(s, index, length(s));
  }

  public static int codePointBefore(String s, int index) {
    return Character.codePointBefore(s, index, 0);
  }
