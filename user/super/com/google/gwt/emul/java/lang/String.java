...
public final class String implements Comparable<String>, CharSequence,
  ...
  private native Object createRegExp(String regex, String mode) /*-{
    return RegExp(regex, mode);
  }-*/;

  private native Object execRegExp(Object regex, String value) /*-{
    return regex.exec(value);
  }-*/;

  private native int resetRegExpLastIndex(Object compiledRegEx) /*-{
  ...
  private native int getMatchIndex(Object matchObject) /*-{
    return matchObject.index;
  }-*/;

  private native int getMatchLength(Object matchObject, int index) /*-{
