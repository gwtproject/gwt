...
public class Throwable implements Serializable {
  ...
  private void linkBack(Object error) {
    if (error != null) {
      try {
        ((HasJavaException) error).setJavaException(this);
  ...
  public static Throwable of(Object e) {
    if (e != null) {
      Throwable throwable = ((HasJavaException) e).getJavaException();
      if (throwable != null) {
        return throwable;
      }
    }
  ...
  private interface HasJavaException {
    @JsProperty(name = "__java$exception")
    void setJavaException(Throwable t);
