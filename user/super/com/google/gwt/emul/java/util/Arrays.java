...
public class Arrays {
  ...
  public static int deepHashCode(Object[] a) {
    ...
    for (int i = 0, n = a.length; i < n; ++i) {
      ...
      hashCode = ensureInt(31 * hashCode + hash);
    }
  ...
  public static int hashCode(boolean[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + (Boolean.valueOf(a[i]).hashCode()));
    }
  ...
  public static int hashCode(byte[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + Byte.hashCode(a[i]));
    }
  ...
  public static int hashCode(char[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + Character.hashCode(a[i]));
    }
  ...
  public static int hashCode(double[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + Double.hashCode(a[i]));
    }
  ...
  public static int hashCode(float[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + Float.hashCode(a[i]));
    }
  ...
  public static int hashCode(int[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + Integer.hashCode(a[i]));
    }
  ...
  public static int hashCode(long[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + Long.hashCode(a[i]));
    }
  ...
  public static int hashCode(Object[] a) {
    ...
    int hashCode = 1;
    for (Object e : a) {
      hashCode = ensureInt(31 * hashCode + Objects.hashCode(e));
    }
  ...
  public static int hashCode(short[] a) {
    ...
    int hashCode = 1;
    for (int i = 0, n = a.length; i < n; ++i) {
      hashCode = ensureInt(31 * hashCode + Short.hashCode(a[i]));
    }
