...
import static javaemul.internal.InternalPreconditions.checkArrayBounds;
...
public class Arrays {
  ...
  public static int binarySearch(byte[] sortedArray, int fromIndex, int toIndex, byte key) {
    checkArrayBounds(fromIndex, toIndex, sortedArray.length);
  ...
  public static void fill(boolean[] a, int fromIndex, int toIndex, boolean val) {
    checkArrayBounds(fromIndex, toIndex, a.length);
  ...
  public static void parallelPrefix(double[] array, int fromIndex, int toIndex,
    ...
    checkArrayBounds(fromIndex, toIndex, array.length);
  ...
  public static <T> void sort(T[] x, int fromIndex, int toIndex,
    ...
    checkArrayBounds(fromIndex, toIndex, x.length);
