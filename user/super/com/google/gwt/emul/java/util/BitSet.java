...
public class BitSet {
  ...
  private void setInternal(int fromIndex, int toIndex) {
    maybeGrowArrayTo(array, toIndex);
  ...
  private static native void maybeGrowArrayTo(int[] array, int newLength) /*-{
  ...
  public int cardinality() {
    ...
    for (int i = 0; i < array.length; i++) {
      count += Integer.bitCount(array[i] | 0);
    }
    return count;
  }
  ...
  public boolean get(int bitIndex) {
    ...
    return (((array[index] | 0) >>> bitOffset(bitIndex)) & 1) == 1;
  }
  ...
  public void or(BitSet set) {
    ...
    maybeGrowArrayTo(array, lastSetWordIndex(set.array) + 1);
  ...
  public void set(int bitIndex) {
    ...
    int index = wordIndex(bitIndex);
    maybeGrowArrayTo(array, index);
    array[index] = ((array[index] | 0) | (1 << bitOffset(bitIndex))) & 0x7fffffff;
  }
