...
public class Collections {
  ...
  static class UnmodifiableMap<K, V> implements Map<K, V> {
    ...
    static class UnmodifiableEntrySet<K, V> extends
       ...
       */
      @SuppressWarnings("unchecked")
      private static void wrap(Object[] array, int size) {
  ...
  private static class UnmodifiableNavigableMap<K, V> extends UnmodifiableSortedMap<K, V>
    ...
    public Entry<K, V> ceilingEntry(K key) {
      return (Entry<K, V>) copyOf(navigableMap.ceilingEntry(key));
    }
    ...
    public Entry<K, V> firstEntry() {
      return (Entry<K, V>) copyOf(navigableMap.firstEntry());
    }

    @SuppressWarnings("unchecked")
    @Override
    public Entry<K, V> floorEntry(K key) {
      return (Entry<K, V>) copyOf(navigableMap.floorEntry(key));
    }
    ...
    public Entry<K, V> higherEntry(K key) {
      return (Entry<K, V>) copyOf(navigableMap.higherEntry(key));
    }
    ...
    public Entry<K, V> lastEntry() {
      return (Entry<K, V>) copyOf(navigableMap.lastEntry());
    }

    @SuppressWarnings("unchecked")
    @Override
    public Entry<K, V> lowerEntry(K key) {
      return (Entry<K, V>) copyOf(navigableMap.lowerEntry(key));
    }
