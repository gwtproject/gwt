...
class Comparators {
  ...
  private static final Comparator<Object> NATURAL = (a, b) -> checkNotNull((Comparable<Object>) a).compareTo(checkNotNull(b));

  private static final Comparator<Object> REVERSE_ORDER = (a, b) -> checkNotNull((Comparable<Object>) b).compareTo(checkNotNull(a));
