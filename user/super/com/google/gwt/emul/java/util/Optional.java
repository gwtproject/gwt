...
public final class Optional<T> {
  ...
  private Optional(T ref) {
    this.ref = InternalPreconditions.checkCriticalNotNull(ref);
  }
  ...
  public <U> Optional<U> map(Function<? super T, ? extends U> mapper) {
    InternalPreconditions.checkCriticalNotNull(mapper);
    if (isPresent()) {
  ...
  public <U> Optional<U> flatMap(Function<? super T, Optional<U>> mapper) {
    InternalPreconditions.checkCriticalNotNull(mapper);
    if (isPresent()) {
      return InternalPreconditions.checkCriticalNotNull(mapper.apply(ref));
    }
    return empty();
  }
