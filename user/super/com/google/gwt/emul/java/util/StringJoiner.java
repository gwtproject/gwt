...
public final class StringJoiner {
  ...
  public StringJoiner(CharSequence delimiter, CharSequence prefix, CharSequence suffix) {
    InternalPreconditions.checkNotNull(delimiter, "delimiter");
    InternalPreconditions.checkNotNull(prefix, "prefix");
    InternalPreconditions.checkNotNull(suffix, "suffix");
