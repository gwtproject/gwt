...
public class Logger {
  ...
  private static final boolean LOGGING_WARNING;
  private static final boolean LOGGING_SEVERE;
  private static final boolean LOGGING_FALSE;

  static {
    assertLoggingValues();
    boolean superDevMode = "on".equals(System.getProperty("superdevmode"));
    String loggingEnabled = System.getProperty("gwt.logging.enabled");
    loggingEnabled = loggingEnabled != null ? loggingEnabled : (superDevMode ? "TRUE" : "FALSE");
    com.google.gwt.user.client.Window.alert("Logging.enabled " + loggingEnabled + " sdm:" + superDevMode);
    LOGGING_WARNING = "WARNING".equals(loggingEnabled);
    LOGGING_SEVERE = "SEVERE".equals(loggingEnabled);
    LOGGING_FALSE = "FALSE".equals(loggingEnabled);
  }
