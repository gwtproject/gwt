...
public static final String GLOBAL_LOGGER_NAME = "global";
  ...
  static void assertLoggingValues() {
    String loggingEnabledValue = System.getProperty("gwt.logging.enabled", "FALSE");
    if (loggingEnabledValue.equals("FALSE") || loggingEnabledValue.equals("TRUE")
        || loggingEnabledValue.equals("SEVERE") || loggingEnabledValue.equals("WARNING")) {
      return;
    }

    throw new RuntimeException("Undefined value for gwt.logging.enabled: '" + loggingEnabledValue
