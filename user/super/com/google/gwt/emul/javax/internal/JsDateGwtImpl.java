 ...
 */
public class JsDateGwtImpl extends JavaScriptObject implements JsDate {
  /**
   * Non directly instantiable, use one of the {@link JsDateFactory}.
   */
  protected JsDateGwtImpl() {
  }
