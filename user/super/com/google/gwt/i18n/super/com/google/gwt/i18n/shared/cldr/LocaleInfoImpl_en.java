...
/**
 * Locale information for the "en" locale.
...
public class LocaleInfoImpl_en extends LocaleInfoImpl {
  ...
  protected CurrencyList createCurrencyList() {
    return new com.google.gwt.i18n.client.cldr.CurrencyListImpl_en();
  }
  
  @Override
  protected DateTimeFormatInfo createDateTimeFormatInfo() {
    return new com.google.gwt.i18n.shared.cldr.DateTimeFormatInfoImpl_en();
  }
  
  @Override
  protected ListPatterns createListPatterns() {
    return new com.google.gwt.i18n.shared.cldr.ListPatternsImpl_en();
  }
  
  @Override
  protected LocalizedNames createLocalizedNames() {
    return new com.google.gwt.i18n.client.cldr.LocalizedNamesImpl_en();
  }
  
  @Override
  protected VariantSelector createOrdinalRule() {
    return new com.google.gwt.i18n.shared.cldr.OrdinalRuleImpl_en();
  }
