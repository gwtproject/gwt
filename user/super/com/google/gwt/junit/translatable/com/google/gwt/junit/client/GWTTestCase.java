...
public abstract class GWTTestCase extends TestCase {
  ...
  public void setUncaughtExceptionHandlerForTest(UncaughtExceptionHandler handler) {
    if (GWT.getUncaughtExceptionHandler() instanceof TestCaseUncaughtExceptionHandler) {
      GWT.setUncaughtExceptionHandler(handler); // set it only if its our handler
    }
