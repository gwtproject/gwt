...
public class Java8Test extends GWTTestCase {
  ...
  public void testLambdaNoCapture() {
    assertEquals(30, new AcceptsLambda<Integer>().accept((a, b) -> a + b));
  }

  public void testLambdaCaptureLocal() {
    int x = 10;
    assertEquals(40, new AcceptsLambda<Integer>().accept((a,b) -> x + a + b));
  }

  public void testLambdaCaptureLocalAndField() {
    assertEquals(82, new AcceptsLambda<Integer>().accept((a,b) -> x + local + a + b));
  }
  ...
  public void testStaticReferenceBinding() throws Exception {
    assertEquals(30, new AcceptsLambda<Integer>().accept(Java8Test::foo));
  }

  public void testInstanceReferenceBinding() throws Exception {
    assertEquals(31, new AcceptsLambda<Integer>().accept(this::fooInstance));
  }
