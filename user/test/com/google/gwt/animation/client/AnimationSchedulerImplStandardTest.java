...
/**
 * Tests the {@link AnimationSchedulerImplStandard} class.
 */
public class AnimationSchedulerImplStandardTest extends GWTTestCase {
  ...
  private AnimationSchedulerImplStandard scheduler;
  ...
  public void testCancel() {
    if (!AnimationSchedulerImplStandard.isNativelySupported()) {
      // Only run the test in browsers that support it
      return;
    }
  ...
  protected void gwtSetUp() throws Exception {
    scheduler = new AnimationSchedulerImplStandard();
  }
