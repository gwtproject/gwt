...
public class JsArrayMixedTest extends GWTTestCase {
  ...
  public void testEdgeCases() {
    ...
    // number values
    assertEquals(0.0, weirdArray.getNumber(0), 0.00001);
    assertEquals(0.0, weirdArray.getNumber(1), 0.00001);
    assertEquals(1.0, weirdArray.getNumber(2), 0.00001);
    assertEquals(Double.NaN, weirdArray.getNumber(3));
    assertEquals(0.0, weirdArray.getNumber(4), 0.00001);
    assertEquals(1.0, weirdArray.getNumber(5), 0.00001);
    assertEquals(Double.NaN, weirdArray.getNumber(6));
    assertEquals(Double.POSITIVE_INFINITY, weirdArray.getNumber(7));
    assertEquals(0.0, weirdArray.getNumber(8), 0.00001);
    assertEquals(0.0, weirdArray.getNumber(9), 0.00001);
    assertEquals(1.0, weirdArray.getNumber(10), 0.00001);
