 ...
 */
public class PrivateInternalJsObjectsTest extends GWTTestCase {
  ...
  public void testGetKeys() {
    JsArrayString keys = PrivateInternalJsObjects.getKeys(createSimpleObject());
  ...
  public void testPrototypeProperties() {
    JsArrayString keys = PrivateInternalJsObjects.getKeys(createObjectWithPropertiesOnProto());
  ...
  public void testEnumBug() {
    JsArrayString keys = PrivateInternalJsObjects.getKeys(createObjectWithEnumBug());
