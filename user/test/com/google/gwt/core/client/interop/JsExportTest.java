...
public class JsExportTest extends GWTTestCase {
  ...
  private native Object getNotExportedConstructor() /*-{
    if ($global.goog && $global.goog.provide && $global.woo.MyClassExportsConstructors.name == 'F') {
      // the constructor is NOT exported, instead this is a non-null function that exists
      // because goog.provide('woo.MyClassExportsConstructors') is generated for all types and
      // assigned the function returned by defineClass() which is called 'F'
      return null;
    }
