...
public class JsPropertyTest extends GWTTestCase {
  ...
  private native void patchPrototype(Class<MyNativeJsTypeSubclass> myClass) /*-{
      @java.lang.Class::getPrototypeForClass(Ljava/lang/Class;)(myClass).prototype =
          $wnd.JsPropertyTest_MyNativeJsType;
  }-*/;
  ...
  static class MyNativeJsType {
    ...
    // TODO(rluble): remove once default constructors are created public.
