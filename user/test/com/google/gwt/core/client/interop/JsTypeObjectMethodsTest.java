...
public class JsTypeObjectMethodsTest extends GWTTestCase {
  ...
  static class SomeNativeClassWithHashCode {
    public native int hashCode();
  }

  static class SomeSubclass extends SomeNativeClassWithHashCode {
    private int n;

    public SomeSubclass(int n) {
      this.n = n;
    }
  ...
  static class SomeOtherClass implements SomeNativeObject {
    private int n;
    public SomeOtherClass(int n) {
      this.n = n;
    }
    public int hashCode() {
      return n;
  ...
  public void testHashCode() {
    ...
    assertEquals(8, new SomeSubclass(8).hashCode());
    assertEquals(9, new SomeOtherClass(9).hashCode());
    assertEquals(10, callHashCode(new SomeSubclass(10)));
  }
