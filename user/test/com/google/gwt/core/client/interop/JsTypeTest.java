...
public class JsTypeTest extends GWTTestCase {
  ...
  static class ListImpl extends CollectionBase implements List {
    @Override
    public void add(Object o) {
      x = o + "ListImpl";
    }
  ...
  static class FooImpl extends CollectionBase implements Collection {
    @Override
    public void add(Object o) {
      super.add(o);
   ...
   */
  @JsExport
  public static class StaticInitializerStaticField {
   ...
   */
  @JsExport
  public static class StaticInitializerStaticMethod {
  ...
  @JsExport
  @JsType
  public static class StaticInitializerVirtualMethod {
