...
public class JsTypeTest extends GWTTestCase {
  ...
  static class MyNativeJsType {
    // TODO(rluble): remove once default constructors for native jstypes are upgraded to public.
  ...
  static class MyNativeJsTypeSubclass extends MyNativeJsType {
    ...
    // TODO(rluble): remove default constructor when default native constructors are handled.
