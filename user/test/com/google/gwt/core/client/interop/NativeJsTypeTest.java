...
public class NativeJsTypeTest extends GWTTestCase {
  ...
  public void testClassLiterals() {
    ...
    Object nativeObject = createNatypeObjectWithoutToString();
  ...
  public void testToString() {
    Object nativeObjectWithToString = createNatypeObjectWithToString();
    assertEquals("Native type", nativeObjectWithToString.toString());

    Object nativeObjectWithoutToString = createNatypeObjectWithoutToString();
  ...
  private static native MyNativeJsType createNatypeObjectWithToString() /*-{
    return {toString: function() { return "Native type"; } };
  }-*/;

  private static native MyNativeJsType createNatypeObjectWithoutToString() /*-{
    return {};
  }-*/;
