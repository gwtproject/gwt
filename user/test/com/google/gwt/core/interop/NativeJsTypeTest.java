...
public class NativeJsTypeTest extends GWTTestCase {
  ...
  private static class MainWindow {
    // TODO(rluble): MainWindow.window here should be $wnd.window but is just window because
    // the name of the enclosing class becomes the namespace of the property.
  ...
  public void testMainWindowIsNotIFrameWindow() {
    ...
    // TODO(rluble): uncomment the following two assertions once we have the  correct behaviour for
    // GLOBAL.window.
