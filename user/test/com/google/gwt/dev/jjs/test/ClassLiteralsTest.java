...
public class ClassLiteralsTest extends GWTTestCase {
  ...
  public void testArray() {
    ...
    if (expectClassMetadata()) {
      ...
      assertEquals("[Lcom.google.gwt.dev.jjs.test.ClassLiteralsTest$Foo;",
          o.getClass().getName());
      assertEquals("com.google.gwt.dev.jjs.test.ClassLiteralsTest.Foo[]",
          o.getClass().getCanonicalName());
      assertEquals("class [Lcom.google.gwt.dev.jjs.test.ClassLiteralsTest$Foo;",
          o.getClass().toString());
    }
  ...
  public void testInterface() {
    ...
    if (expectClassMetadata()) {
      ...
      assertEquals(
          "interface com.google.gwt.dev.jjs.test.ClassLiteralsTest$IFoo",
          IFoo.class.toString());
    }
