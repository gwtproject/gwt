...
public class CompilerMiscRegressionTest extends GWTTestCase {
  ...
  public interface SomeNativeInterface {
    @JsProperty
  ...
  public static abstract class AbstractNativeType implements SomeNativeInterface {
  }

  private static native Object createAbstractNativeType(String value) /*-{
  ...
  public void testNativeJsMethodDispatch_unreferencedSupertypeMethod() {
    final AbstractNativeType o = (AbstractNativeType) createAbstractNativeType("Hello");
