...
public class CompilerTest extends GWTTestCase {
   ...
   * assumption only holds if no optimization introduces the a local variable reference in
  ...
  public void testDataflowDuplicateNamesError() {
    final StringBuilder topScope;
    {
      final StringBuilder localScopeDuplicatedVar = new StringBuilder();
...

    {
      ...
      // is run as compiled JavaScript then it will be "different text".
