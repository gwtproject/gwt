...
public class NativeDevirtualizationTest extends GWTTestCase {
  ...
  public void testBooleanDevirtualization() {
    ...
    assertEquals(HashCodes.hashCodeForBoolean((Boolean) o), o.hashCode());
    ...
    assertEquals(HashCodes.hashCodeForBoolean((Boolean) b), b.hashCode());
  }
  ...
  public void testDoubleDevirtualization() {
    ...
    assertEquals(HashCodes.hashCodeForDouble((Double) o), o.hashCode());
    ...
    assertEquals(HashCodes.hashCodeForDouble((Double) b), b.hashCode());
    ...
    assertEquals(HashCodes.hashCodeForDouble((Double) c), c.hashCode());
