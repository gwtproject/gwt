...
/**
 * Class overriding a package private method an exposes it as public (implementing m()
 * from SomeInterface). This class "collapeses" SomeParentParent.m() and SomeInterface.m().
 */
public class ClassExposingM extends SomeParentParent implements SomeInterface {

  /**
   * Method that overrides SomeParentParent.f() and exposes as public. SomeParentParent.f() is
   * package private but never referred to except after made public here. That makes
