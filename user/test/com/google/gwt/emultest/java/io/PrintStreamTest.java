...
public class PrintStreamTest extends GWTTestCase {
  ...
  private static final Charset encodingUTF8Charset = UTF_8;
  ...
  public void testPrintCharArray() {
    ...
    assertTrue(
        ...
        Arrays.equals(new String(charArray).getBytes(encodingUTF8Charset), outBytes));
  }
  ...
  public void testPrintFloat() {
    ps.print(29.0876407623291f);
    ps.close();
    ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
    byte[] outBytes = new byte[16];
    bais.read(outBytes, 0, 16);
    assertEquals("Incorrect float written", "29.0876407623291", new String(outBytes, UTF_8));
  }
  ...
  public void testPrintLong() {
    ...
    assertEquals("Incorrect long written", "919728433988", new String(outBytes, UTF_8));
  }
  ...
  public void testPrintObject() {
    ps.print(new java.util.Vector<String>());
    ps.close();
    ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
  ...
  public void testPrintlnNullCharArray() {
    try {
  ...
  public void testPrintlnObject() {
    ps.println(new java.util.Vector<String>());
    ps.close();
    ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
    byte[] outBytes = new byte[2];
    bais.read(outBytes, 0, 2);
