...
public class WriterTest extends GWTTestCase {
  ...
  private static class TestWriter extends Writer {
    ...
    private static List<Character> outputChars = new ArrayList<>(1024);
  ...
  public void testAppendChar() throws IOException {
    ...
    assertTrue(Arrays.equals(new char[] { 'a' }, TestWriter.toCharArray()));

    w = writer.append('b');
    assertEquals(writer, w);
    assertTrue(Arrays.equals(new char[] { 'a', 'b' }, TestWriter.toCharArray()));

    w = writer.append('c');
    assertEquals(writer, w);
    assertTrue(Arrays.equals(new char[] { 'a', 'b', 'c' }, TestWriter.toCharArray()));
  }

  public void testAppendNullCharSequence() throws IOException {
    final Writer w = writer.append(null);
    assertEquals(writer, w);
    assertTrue(Arrays.equals("null".toCharArray(), TestWriter.toCharArray()));
  }
  ...
  public void testAppendEmptyCharSequence() throws IOException {
    ...
    assertEquals(writer, w);
    assertNotNull(TestWriter.toCharArray());
  }
  ...
  public void testAppendNonEmptyCharSequence() throws IOException {
    ...
    final Writer w = writer.append(csq);
    assertEquals(writer, w);
    assertTrue(Arrays.equals("hola".toCharArray(), TestWriter.toCharArray()));
  }
  ...
  public void testAppendNullSubCharSequence() throws IOException {
    ...
    assertEquals(writer, w);
    assertTrue(Arrays.equals("ul".toCharArray(), TestWriter.toCharArray()));
  }
  ...
  public void testAppendNonEmptySubCharSequence() throws IOException {
    ...
    assertEquals(writer, w);
    assertTrue(Arrays.equals("ol".toCharArray(), TestWriter.toCharArray()));
  }
  ...
  public void testWriteNonEmptyCharArray() throws IOException {
    ...
    writer.write(charArray);
    assertTrue(Arrays.equals(charArray, TestWriter.toCharArray()));
  }
  ...
  public void testWriteNonEmptyString() throws IOException {
    ...
    writer.write(str);
    assertTrue(Arrays.equals(str.toCharArray(), TestWriter.toCharArray()));
  }
