...
public class MathTest extends GWTTestCase {
  ...
  public void testAsin() {
    ...
    assertNegativeZero(Math.asin(makeNegativeZero()));
  ...
  public void testAtan() {
    ...
    assertNegativeZero(Math.atan(makeNegativeZero()));
  ...
  public void testAtan2() {
    ...
    assertNegativeZero(Math.atan2(makeNegativeZero(), 1.0));
    ...
    assertEquals(-Math.PI, Math.atan2(makeNegativeZero(), -1.0), 1e-7);
    assertEquals(-Math.PI, Math.atan2(-1.0, Double.NEGATIVE_INFINITY), 1e-7);
    assertEquals(Math.PI / 2, Math.atan2(1.0, 0.0), 1e-7);
    assertEquals(Math.PI / 2, Math.atan2(1.0, makeNegativeZero()), 1e-7);
  ...
  public void testCbrt() {
    ...
    assertNegativeZero(Math.cbrt(makeNegativeZero()));
  ...
  public void testCeil() {
    ...
    assertNegativeZero(Math.ceil(makeNegativeZero()));
  ...
  public void testCopySign() {
    ...
    assertEquals(2.0, Math.copySign(-2.0, 0.0));
    assertEquals(-2.0, Math.copySign(2.0, makeNegativeZero()));
    assertEquals(-2.0, Math.copySign(-2.0, makeNegativeZero()));
    ...
    assertPositiveZero(Math.copySign(makeNegativeZero(), 4.0));
    assertNegativeZero(Math.copySign(0.0, -4.0));
    assertNegativeZero(Math.copySign(makeNegativeZero(), -4.0));

    assertPositiveZero(Math.copySign(0.0, 0.0));
    assertPositiveZero(Math.copySign(makeNegativeZero(), 0.0));
    assertNegativeZero(Math.copySign(0.0, makeNegativeZero()));
    assertNegativeZero(Math.copySign(makeNegativeZero(), makeNegativeZero()));
  ...
  public void testExpm1() {
    assertNegativeZero(Math.expm1(makeNegativeZero()));
  ...
  public void testFloor() {
    ...
    assertNegativeZero(Math.floor(makeNegativeZero()));
  ...
  public void testLog() {
    ...
    assertEquals(Double.NEGATIVE_INFINITY, Math.log(makeNegativeZero()));
  ...
  public void testLog10() {
    ...
    assertEquals(Double.NEGATIVE_INFINITY, Math.log10(makeNegativeZero()));
  ...
  public void testLog1p() {
    ...
    assertNegativeZero(Math.log1p(makeNegativeZero()));
  ...
  public void testPow() {
    ...
    assertEquals(1, Math.pow(2, makeNegativeZero()));
    ...
    assertEquals(1, Math.pow(Double.NaN, makeNegativeZero()));
    ...
    assertPositiveZero(Math.pow(makeNegativeZero(), 2));
    assertPositiveZero(Math.pow(Double.NEGATIVE_INFINITY, -2));
    assertNegativeZero(Math.pow(makeNegativeZero(), 1));
    assertNegativeZero(Math.pow(Double.NEGATIVE_INFINITY, -1));
    assertEquals(Double.POSITIVE_INFINITY, Math.pow(makeNegativeZero(), -2));
    assertEquals(Double.POSITIVE_INFINITY, Math.pow(Double.NEGATIVE_INFINITY, 2));
    assertEquals(Double.NEGATIVE_INFINITY, Math.pow(makeNegativeZero(), -1));
  ...
  public void testSignum() {
    ...
    assertNegativeZero(Math.signum(makeNegativeZero()));
  ...
  public void testSqrt() {
    ...
    assertNegativeZero(Math.sqrt(makeNegativeZero()));
  ...
  public void testScalb() {
    for (int scaleFactor = -32; scaleFactor <= 32; scaleFactor++) {
      ...
      assertNegativeZero(Math.scalb(makeNegativeZero(), scaleFactor));
    }
