...
public final class ArrayTest extends GWTTestCase {
  ...
  public void testGetBoolean() {
    ...
    try {
      Array.getBoolean(new boolean[] {true}, -1);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testGetDouble() {
    ...
    try {
      Array.getDouble(new double[] {1d}, -1);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testGetShort() {
    ...
    try {
      Array.getShort(new short[] {(short) 1}, -1);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSet() {
    ...
    try {
      Array.set(new Object[1], -1, true);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.set(new Object[1], 2, true);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetBoolean() {
    ...
    try {
      Array.setBoolean(new boolean[1], -1, true);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setBoolean(new boolean[1], 2, true);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetByte() {
    ...
    try {
      Array.setByte(new byte[1], -1, (byte) 0);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setByte(new byte[1], 2, (byte) 0);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetChar() {
    ...
    try {
      Array.setChar(new char[1], -1, 'a');
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setChar(new char[1], 2, 'a');
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetDouble() {
    ...
    try {
      Array.setDouble(new double[1], -1, 0);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setDouble(new double[1], 2, 0);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetFloat() {
    ...
    try {
      Array.setFloat(new float[1], -1, 0);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setFloat(new float[1], 2, 0);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetInt() {
    ...
    try {
      Array.setInt(new int[1], -1, 0);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setInt(new int[1], 2, 0);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetLong() {
    ...
    try {
      Array.setLong(new long[1], -1, 0L);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setLong(new long[1], 2, 0L);
      fail();
    } catch (RuntimeException expected) {
    }
  ...
  public void testSetShort() {
    ...
    try {
      Array.setShort(new short[1], -1, (short) 1);
      fail();
    } catch (RuntimeException expected) {
    }

    try {
      Array.setShort(new short[1], 2, (short) 1);
      fail();
    } catch (RuntimeException expected) {
    }
