...
public class ArraysTest extends EmulTestBase {
  ...
  public void testSort() {
    Object e1 = new Integer(1);
    Object e21 = new Integer(2);
    Object e22 = new Integer(2);
    Object e3 = new Integer(3);
    Object[] original = {e3, e21, e22, e1};
    Object[] expected = {e1, e21, e22, e3};
    Object[] expectedReversed = {e3, e21, e22, e1};
    // e21 and e22 must be two equal objects.
    // They are used to check that Arrays.sort is stable.
    assertNotSame(e21, e22);
    assertEquals(e21, e22);

    Object[] array = Arrays.copyOf(original, original.length);
    Arrays.sort(array);
    ...
    assertEquals(expectedReversed, array);
