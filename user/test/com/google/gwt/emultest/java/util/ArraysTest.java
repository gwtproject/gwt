...
public class ArraysTest extends EmulTestBase {
  ...
  public void testCopyOfBoolean() {
    ...
    assertEquals(
        new boolean[] {true, true, false, true, true, true, false, false, true},
        ret);
  ...
  public void testCopyOfByte() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new byte[] {9, 8, 7, 5, 1, 2, 3, 4, 0}, ret);
  ...
  public void testCopyOfChar() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new char[] {9, 8, 7, 5, 1, 2, 3, 4, 0}, ret);
  ...
  public void testCopyOfDouble() {
    double[] a1 = {0.99, 1.8, -7.333, 0., 3.335, 101, 0.12, 33.65};
    double[] ret = Arrays.copyOf(a1, a1.length);
    assertNotSame(a1, ret);
    assertEquals(new double[] {0.99, 1.8, -7.333, 0., 3.335, 101, 0.12, 33.65},
        ret);

    ret = Arrays.copyOf(a1, 2);
    assertEquals(new double[] {0.99, 1.8}, ret);
  ...
  public void testCopyOfFloat() {
    float[] a1 = {0.99f, 1.8f, -7.333f, 0f, 3.335f, 101f, 0.12f, 33.65f};
    float[] ret = Arrays.copyOf(a1, a1.length);
    assertNotSame(a1, ret);
    assertEquals(
        new float[] {0.99f, 1.8f, -7.333f, 0f, 3.335f, 101f, 0.12f, 33.65f},
        ret);

    ret = Arrays.copyOf(a1, 2);
    assertEquals(new float[] {0.99f, 1.8f}, ret);
  ...
  public void testCopyOfInt() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new int[] {9, 8, 7, 5, 1, 2, -1037, 3, 4, 0}, ret);
  ...
  public void testCopyOfLong() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new long[] {9, 8, 7, 5, 1, 2, -1037, 3, 4, 0}, ret);
  ...
  public void testCopyOfShort() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new short[] {9, 8, 7, 5, 1, 2, -1037, 3, 4, 0}, ret);
  ...
  public void testCopyOfObject() {
    Object[] a1 = {null, "one", "two", null, "three"};
    Object[] ret = Arrays.copyOf(a1, a1.length);
    assertNotSame(a1, ret);
    assertEquals(new Object[] {null, "one", "two", null, "three"}, ret);

    ret = Arrays.copyOf(a1, 2);
    assertEquals(new Object[] {null, "one"}, ret);
  ...
  public void testCopyOfRangeBoolean() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new boolean[] {true, true, false, true, true}, ret);
  ...
  public void testCopyOfRangeByte() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new byte[] {9, 8, 7, 5, 1}, ret);
  ...
  public void testCopyOfRangeChar() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new char[] {9, 8, 7, 5, 1}, ret);
  ...
  public void testCopyOfRangeDouble() {
    double[] a1 = {0.99, 1.8, -7.333, 0., 3.335};
    double[] ret = Arrays.copyOfRange(a1, 0, a1.length);
    assertNotSame(a1, ret);
    assertEquals(new double[] {0.99, 1.8, -7.333, 0., 3.335}, ret);

    ret = Arrays.copyOfRange(a1, 0, 2);
    assertEquals(new double[] {0.99, 1.8}, ret);

    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new double[] {-7.333, 0.}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new double[] {0., 3.335, 0.}, ret);
  ...
  public void testCopyOfRangeFloat() {
    float[] a1 = {0.99f, 1.8f, -7.333f, 0f, 3.335f};
    float[] ret = Arrays.copyOfRange(a1, 0, a1.length);
    assertNotSame(a1, ret);
    assertEquals(new float[] {0.99f, 1.8f, -7.333f, 0f, 3.335f}, ret);

    ret = Arrays.copyOfRange(a1, 0, 2);
    assertEquals(new float[] {0.99f, 1.8f}, ret);

    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new float[] {-7.333f, 0f}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new float[] {0f, 3.335f, 0f}, ret);
  ...
  public void testCopyOfRangeInt() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new int[] {9, 8, 7, 5, 1}, ret);
  ...
  public void testCopyOfRangeLong() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new long[] {9, 8, 7, 5, 1}, ret);
  ...
  public void testCopyOfRangeShort() {
    ...
    assertNotSame(a1, ret);
    assertEquals(new short[] {9, 8, 7, 5, 1}, ret);
  ...
  public void testCopyOfRangeObject() {
    ...
    ret = Arrays.copyOfRange(a1, 2, 4);
    assertEquals(new Object[] {"two", null}, ret);

    ret = Arrays.copyOfRange(a1, 3, 6);
    assertEquals(new Object[] {null, "three", null}, ret);
