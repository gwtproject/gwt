...
public class LookupMethodCreatorTest {
  ...
  public void testCreateMethodForJMethodForSingleEntry() {
    ...
    /*
     * old version expected.println("if(arg0.equals(\"singleEntry\")) {"); expected.indent();
     * expected.println("return singleEntry();"); expected.outdent(); expected.println("}");
     */
  ...
  @Test
  @Ignore
  public void testCreateMethodForJMethodForSingleEntryWith2PartitionsSize() {
    // TODO unnecessary getString1 is created because the no lookup for current method is created.
    initLookupMethodCreator(SINGLE_ENTRY_MESSAGES, 2);
    underTest.createMethodFor(method);

    assertFalse("No partition lookup should be created.", sw.toString().contains(
  ...
  public void testCreateMethodForJMethodForMultiMessageEntryCreateTwoPartitions() {
    ...
    expected.outdent();
    expected.println("}");
    expected.println("tmp = getString1(arg0);");
    expected.println("if (tmp != null) {");
    expected.indent();
    expected.println("return tmp;");
    expected.outdent();
    ...
    expected.println("throw new java.util.MissingResourceException("
        + "\"Cannot find constant '\" +arg0 + \"'; expecting a method name\", \"foo.FourEntryMessage\", arg0);");
    ...
    expected.println("private java.lang.String getString0(java.lang.String arg0) {");
    expected.indent();
    expected.println("if(arg0.equals(\"first\")) {");
    expected.indent();
    expected.println("return first();");
    expected.outdent();
    expected.println("}");
    expected.println("if(arg0.equals(\"second\")) {");
    expected.indent();
    expected.println("return second();");
    expected.outdent();
    expected.println("}");
    expected.println("if(arg0.equals(\"third\")) {");
    expected.indent();
    expected.println("return third();");
    expected.outdent();
    expected.println("}");
    expected.println("return null;");
    expected.outdent();
    ...
    expected.println("}");
    expected.println();
    expected.println("private java.lang.String getString1(java.lang.String arg0) {");
    expected.indent();
    expected.println("if(arg0.equals(\"fourth\")) {");
    expected.indent();
    expected.println("return fourth();");
    expected.outdent();
    expected.println("}");
    expected.println("return null;");
    expected.outdent();
