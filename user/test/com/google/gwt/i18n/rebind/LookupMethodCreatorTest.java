...
public class LookupMethodCreatorTest extends TestCase {
  ...
  public void testPartitionIsCallesWithArg0() throws TypeOracleException {
    initLookupMethodCreator(FOUR_ENTRY_MESSAGES);
    sw.println("//Start");
    sw.indent();
    sw.println("public java.lang.String getString(java.lang.String arg0) {");
    sw.indent();
    stringCreator.createMethodFor(stringMethod);
    sw.outdent();
    sw.println("}");

    String actual = sw.toString();
    assertTrue("Wrong partition call", actual.contains("return getStringFromPartition0(arg0);"));
  }

  public void testCodeForIntIsGeneratedSameAsWithoutPartitions() throws TypeOracleException {
    initLookupMethodCreator(SINGLE_ENTRY_MESSAGES);
    intCreator.createMethodFor(intMethod);
  ...
  public void testCreateMethodForJMethodForMultiMessageEntryCreateOneAdditionalPartition()
  ...
  public void testCreateMethodForJMethodForSingleIntEntry() {
    intCreator.createMethodFor(intMethod);
  ...
  public void testCreateMethodForPartitionSizeEntriesNoPartitionNeeded()
      throws TypeOracleException {
    initLookupMethodCreator(PARTITION_SIZE_ENTRY_MESSAGES);
    stringCreator.createMethodFor(stringMethod);
  ...
  public void testCreatePartitionMethodName() {
    String partitionMethodName = stringCreator.createPartitionMethodName(stringMethod, 1);
  ...
  public void testFindMethodsToCreate() throws TypeOracleException {
    ...
    List<JMethod> intMethods = intCreator.findMethodsToCreate(intMethod, intType);
  ...
  public void testFindMethodsToCreateWithDifferentTargetMethod() throws TypeOracleException {
    ...
    JType intType = oracle.parse(int.class.getName());
    List<JMethod> foundMethods = stringCreator.findMethodsToCreate(stringMethod, intType);
  ...
  private void initLookupMethodCreator(MockJavaResource resource, int partitionsSize)
    ...
    try {
      ...
      stringCreator = new LookupMethodCreator(mockCreator, stringType, partitionsSize);
      intCreator = new LookupMethodCreator(mockCreator, intType, partitionsSize) {
        @Override
