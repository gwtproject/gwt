...
public class StackTracePrintStreamTest extends GWTTestCase {
  ...
  public void testPrintStackTrace() throws Exception {
    ...
    createTestException().printStackTrace(new StackTracePrintStream(stackTraceBuilder));
    ...
    expectedStackTraceBuilder.append("Caused by: custom msg cause\n");
    expectedStackTraceBuilder.append("\tat c3.m3(f3:3)\n");
    expectedStackTraceBuilder.append("\tat c4.m4(f4:4)\n");

    assertEquals(expectedStackTraceBuilder.toString(), stackTraceBuilder.toString());
  }
