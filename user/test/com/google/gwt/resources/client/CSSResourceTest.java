...
public class CSSResourceTest extends GWTTestCase {
  ...
  public void testCss() {
    ...
    // TODO(dankurka): This is a very hacky way to determine wheterh GSS is turned on or not.
    // We should rely on System.getProperty("CssResource.enableGss") once its working.
    boolean gss = !text.contains("offset:16px 16px;");

    if (gss) {
      testCssWithGssEnabled(css, text);
      return;
    }
