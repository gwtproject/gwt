...
public class UriUtilsTest extends TestCase {
  ...
  // a telephone URI
  private static final UriTestCaseSpec TEL_URI = new UriTestCaseSpec("tel:+16502530000", "tel");
  ...
  public static void testSanitizeUri() {
    ...
    assertEquals(TEL_URI.getUri(), UriUtils.sanitizeUri(TEL_URI.getUri(),
        Collections.singleton(TEL_URI.getScheme())));
  }
}
