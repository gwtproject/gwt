...
public class UiBinderTest extends GWTTestCase {
  ...
  public void testProvidedWidgetWithCustomInitializer() {
    ...
    assertEquals("Provided header text",
        widgetUi.myProvidedDisclosurePanel.getHeaderTextAccessor().getText());
    assertNotNull(widgetUi.myProvidedDisclosurePanelItem);
    assertSame(widgetUi.myProvidedDisclosurePanelItem,
        widgetUi.myProvidedDisclosurePanel.getContent());
    // UiConstructor
