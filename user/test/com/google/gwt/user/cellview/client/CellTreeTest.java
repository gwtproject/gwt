...
public class CellTreeTest extends AbstractCellTreeTestBase {
  ...
  public void testKeyboardNavigationForUpAndDownKeys() {
    ...
    List<String> keyboardNavigationPath = Arrays.asList("a",
    ...
    int steps = keyboardNavigationPath.size() - 1;
    assertEquals(keyboardNavigationPath, repeatKeyInTree(cellTree, KeyCodes.KEY_DOWN, steps));

    Collections.reverse(keyboardNavigationPath);
    assertEquals(keyboardNavigationPath, repeatKeyInTree(cellTree, KeyCodes.KEY_UP, steps));
  }
