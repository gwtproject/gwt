...
/**
 * Test Serializing final fields in RPC when property rpc.serializeFinalFields is audit.
 *
 * We should fail the compile, but first list the found fields.
 */
public class FinalFieldsAuditTest extends RpcTestBase {
  ...
  public String getModuleName() {
    return "com.google.gwt.user.RPCFinalFieldsAuditTest";
  }
