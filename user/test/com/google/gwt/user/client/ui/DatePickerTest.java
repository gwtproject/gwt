...
public class DatePickerTest extends GWTTestCase {
  ...
  public void testMonthNavigation() {
    ...
    Date dateAfterOneMonth = new Date(actualDate.getYear(), actualDate.getMonth() + 1, actualDate.getDate());
  ...
  public void testYearNavigation() {
    DatePickerWithView dp = new DatePickerWithView(new MockCalendarView());
    dp.setYearNavigationEnabled(true);
    RootPanel.get().add(dp);
  ...
  public void testYearNavigationIsDisabled() {
    DatePickerWithView dp = new DatePickerWithView(new MockCalendarView());
    RootPanel.get().add(dp);

    assertTrue(dp.getDefaultMonthSelector().getYearForwardButtonElement().getParentElement() == null);
    assertTrue(dp.getDefaultMonthSelector().getYearBackwardButtonElement().getParentElement() == null);
  }

  public void testYearNavigationIsEnabled() {
    DatePickerWithView dp = new DatePickerWithView(new MockCalendarView());
    dp.setYearNavigationEnabled(true);
    RootPanel.get().add(dp);
  ...
  private void clickOnNavigationElement(Element e) {
    e.dispatchEvent(Document.get().createMouseOverEvent(1, 0, 0, 0, 0, false, false, false, false, NativeEvent.BUTTON_LEFT, null));
    e.dispatchEvent(Document.get().createMouseDownEvent(1, 0, 0, 0, 0, false, false, false, false, NativeEvent.BUTTON_LEFT));
    e.dispatchEvent(Document.get().createMouseUpEvent(1, 0, 0, 0, 0, false, false, false, false, NativeEvent.BUTTON_LEFT));
  }
}
