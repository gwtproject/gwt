...
public class DatePickerTest extends GWTTestCase {
  ...
  public void testOddVisibleYearCount() {
    DatePickerWithView dp = new DatePickerWithView(new MockCalendarView());
    dp.setYearAndMonthDropdownVisible(true);
    dp.setVisibleYearCount(11);
    RootPanel.get().add(dp);

    int actualYear = dp.getCalendarModel().getCurrentMonth().getYear() + 1900;

    ListBox yearSelect = dp.getDefaultMonthSelector().getYearSelectListBox();

    assertEquals(11, yearSelect.getItemCount());
    assertEquals(""+(actualYear - 5), yearSelect.getItemText(0));
    assertEquals(""+(actualYear + 5), yearSelect.getItemText(10));
  }

  public void testEvenVisibleYearCount() {
    DatePickerWithView dp = new DatePickerWithView(new MockCalendarView());
    dp.setYearAndMonthDropdownVisible(true);
    ...
    assertEquals(""+(actualYear - 4), yearSelect.getItemText(0));
    assertEquals(""+(actualYear + 5), yearSelect.getItemText(9 ));
  }
  ...
  public void testYearNavigationIsDisabled() {
    ...
    assertTrue(dp.getDefaultMonthSelector().getYearForwardButtonElement().getParentElement() ==
        null);
    assertTrue(dp.getDefaultMonthSelector().getYearBackwardButtonElement().getParentElement() ==
        null);
  }
