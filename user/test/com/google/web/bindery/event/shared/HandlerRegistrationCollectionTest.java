...
/**
 * Unit test for {@link HandlerRegistrationCollection}.
 */
public class HandlerRegistrationCollectionTest extends TestCase {
  ...
  public void testHandlerRegistrationCollectionRemove() {
    ...
    HandlerRegistration hrc = HandlerRegistrationCollection.create(hr1, hr2);
    hrc.removeHandler();
