 ...
 * @see http://code.google.com/p/google-web-toolkit/issues/detail?id=7509
 */
public class ProxyForInterfacesTest extends GWTTestCase {
  ...
  static interface Context extends RequestContext {
    Request<I1> getC0();
  ...
  @ProxyFor(I1.class)
  static interface I1 extends ValueProxy {
    String getName();
  }

  @ProxyFor(I2.class)
  static interface I2 extends I1, ValueProxy {
  }
